...
export class game1596108130561 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(205, 'renju', null, 'renju')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(206, 'gomoku', null, 'renju')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(207, 'pente', null, 'pente')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(208, 'ninuki-renju', null, 'pente')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(209, 'gomoku-knights', null, 'gomoku-knights')`);
        ...
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(212, 'ming-mang-9x9', null, 'ming-mang-9x9')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(213, 'ming-mang-17x17', null, 'ming-mang-17x17')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(214, 'kono', null, 'kono')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(215, 'nam-dinh', null, 'nam-dinh')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(216, 'cinc-camins', null, 'cinc-camins')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(217, 'amazons', null, 'amazons')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(218, 'kharbaga', null, 'kharbaga')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(219, 'walhall', 1, 'walhall-1')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(220, 'walhall', 2, 'walhall-2')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(221, 'walhall', 3, 'walhall-3')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(222, 'walhall', 4, 'walhall-4')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(223, 'tablut', null, 'tablut')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(224, 'ard-ri', null, 'ard-ri')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(225, 'brandubh', null, 'brandubh')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(226, 'fidchell', null, 'fidchell')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(227, 'gwyddbwyll', null, 'gwyddbwyll')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(228, 'alice-chess', null, 'chess-1')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(229, 'platform-chess', 1, 'platform-chess-1')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(230, 'platform-chess', 2, 'platform-chess-2')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(231, 'annan-shogi', null, 'annan-shogi')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(232, 'annan-shogi-kanji', null, 'annan-shogi-kanji')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(233, 'halma-10', null, 'halma-10')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(234, 'halma-8', null, 'halma-8')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(235, 'suff', null, 'suff')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(236, 'bushi', null, 'bushi')`);
        await queryRunner.query(`insert into game_previews(id, filename, selector_value, preview) values(237, 'rithmomachia', 1, 'rithm-1')`);
