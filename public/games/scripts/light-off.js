(function(){Dagaz.Controller.persistense = "none";
...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("light-off-extension", "wazir",  1);
    design.checkVersion("light-off-extension", "fers",   2);
    design.checkVersion("light-off-extension", "king",   3);
    design.checkVersion("light-off-extension", "knight", 4);
    design.checkVersion("light-off-extension", "rook",   5);
    design.checkVersion("light-off-extension", "bishop", 6);
    design.checkVersion("light-off-extension", "queen",  7);
