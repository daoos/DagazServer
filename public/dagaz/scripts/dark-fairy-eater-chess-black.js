...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("dark-fairy-eater-view", "2");
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 537, 537, 65, 65);
    view.defPosition("b9", 472, 537, 65, 65);
    view.defPosition("c9", 407, 537, 65, 65);
    view.defPosition("d9", 342, 537, 65, 65);
    view.defPosition("e9", 277, 537, 65, 65);
    view.defPosition("f9", 212, 537, 65, 65);
    view.defPosition("g9", 147, 537, 65, 65);
    view.defPosition("h9", 82, 537, 65, 65);
    view.defPosition("i9", 17, 537, 65, 65);
    view.defPosition("a8", 537, 472, 65, 65);
    view.defPosition("b8", 472, 472, 65, 65);
    view.defPosition("c8", 407, 472, 65, 65);
    view.defPosition("d8", 342, 472, 65, 65);
    view.defPosition("e8", 277, 472, 65, 65);
    view.defPosition("f8", 212, 472, 65, 65);
    view.defPosition("g8", 147, 472, 65, 65);
    view.defPosition("h8", 82, 472, 65, 65);
    view.defPosition("i8", 17, 472, 65, 65);
    view.defPosition("a7", 537, 407, 65, 65);
    view.defPosition("b7", 472, 407, 65, 65);
    view.defPosition("c7", 407, 407, 65, 65);
    view.defPosition("d7", 342, 407, 65, 65);
    view.defPosition("e7", 277, 407, 65, 65);
    view.defPosition("f7", 212, 407, 65, 65);
    view.defPosition("g7", 147, 407, 65, 65);
    view.defPosition("h7", 82, 407, 65, 65);
    view.defPosition("i7", 17, 407, 65, 65);
    view.defPosition("a6", 537, 342, 65, 65);
    view.defPosition("b6", 472, 342, 65, 65);
    view.defPosition("c6", 407, 342, 65, 65);
    view.defPosition("d6", 342, 342, 65, 65);
    view.defPosition("e6", 277, 342, 65, 65);
    view.defPosition("f6", 212, 342, 65, 65);
    view.defPosition("g6", 147, 342, 65, 65);
    view.defPosition("h6", 82, 342, 65, 65);
    view.defPosition("i6", 17, 342, 65, 65);
    view.defPosition("a5", 537, 277, 65, 65);
    view.defPosition("b5", 472, 277, 65, 65);
    view.defPosition("c5", 407, 277, 65, 65);
    view.defPosition("d5", 342, 277, 65, 65);
    view.defPosition("e5", 277, 277, 65, 65);
    view.defPosition("f5", 212, 277, 65, 65);
    view.defPosition("g5", 147, 277, 65, 65);
    view.defPosition("h5", 82, 277, 65, 65);
    view.defPosition("i5", 17, 277, 65, 65);
    view.defPosition("a4", 537, 212, 65, 65);
    view.defPosition("b4", 472, 212, 65, 65);
    view.defPosition("c4", 407, 212, 65, 65);
    view.defPosition("d4", 342, 212, 65, 65);
    view.defPosition("e4", 277, 212, 65, 65);
    view.defPosition("f4", 212, 212, 65, 65);
    view.defPosition("g4", 147, 212, 65, 65);
    view.defPosition("h4", 82, 212, 65, 65);
    view.defPosition("i4", 17, 212, 65, 65);
    view.defPosition("a3", 537, 147, 65, 65);
    view.defPosition("b3", 472, 147, 65, 65);
    view.defPosition("c3", 407, 147, 65, 65);
    view.defPosition("d3", 342, 147, 65, 65);
    view.defPosition("e3", 277, 147, 65, 65);
    view.defPosition("f3", 212, 147, 65, 65);
    view.defPosition("g3", 147, 147, 65, 65);
    view.defPosition("h3", 82, 147, 65, 65);
    view.defPosition("i3", 17, 147, 65, 65);
    view.defPosition("a2", 537, 82, 65, 65);
    view.defPosition("b2", 472, 82, 65, 65);
    view.defPosition("c2", 407, 82, 65, 65);
    view.defPosition("d2", 342, 82, 65, 65);
    view.defPosition("e2", 277, 82, 65, 65);
    view.defPosition("f2", 212, 82, 65, 65);
    view.defPosition("g2", 147, 82, 65, 65);
    view.defPosition("h2", 82, 82, 65, 65);
    view.defPosition("i2", 17, 82, 65, 65);
    view.defPosition("a1", 537, 17, 65, 65);
    view.defPosition("b1", 472, 17, 65, 65);
    view.defPosition("c1", 407, 17, 65, 65);
    view.defPosition("d1", 342, 17, 65, 65);
    view.defPosition("e1", 277, 17, 65, 65);
    view.defPosition("f1", 212, 17, 65, 65);
    view.defPosition("g1", 147, 17, 65, 65);
    view.defPosition("h1", 82, 17, 65, 65);
    view.defPosition("i1", 17, 17, 65, 65);

    view.defPopup("Promote", 124, 130);
