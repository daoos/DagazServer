...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 546, 546, 68, 68);
    view.defPosition("b9", 478, 546, 68, 68);
    view.defPosition("c9", 410, 546, 68, 68);
    view.defPosition("d9", 342, 546, 68, 68);
    view.defPosition("e9", 274, 546, 68, 68);
    view.defPosition("f9", 206, 546, 68, 68);
    view.defPosition("g9", 138, 546, 68, 68);
    view.defPosition("h9", 70, 546, 68, 68);
    view.defPosition("i9", 2, 546, 68, 68);
    view.defPosition("a8", 546, 478, 68, 68);
    view.defPosition("b8", 478, 478, 68, 68);
    view.defPosition("c8", 410, 478, 68, 68);
    view.defPosition("d8", 342, 478, 68, 68);
    view.defPosition("e8", 274, 478, 68, 68);
    view.defPosition("f8", 206, 478, 68, 68);
    view.defPosition("g8", 138, 478, 68, 68);
    view.defPosition("h8", 70, 478, 68, 68);
    view.defPosition("i8", 2, 478, 68, 68);
    view.defPosition("a7", 546, 410, 68, 68);
    view.defPosition("b7", 478, 410, 68, 68);
    view.defPosition("c7", 410, 410, 68, 68);
    view.defPosition("d7", 342, 410, 68, 68);
    view.defPosition("e7", 274, 410, 68, 68);
    view.defPosition("f7", 206, 410, 68, 68);
    view.defPosition("g7", 138, 410, 68, 68);
    view.defPosition("h7", 70, 410, 68, 68);
    view.defPosition("i7", 2, 410, 68, 68);
    view.defPosition("a6", 546, 342, 68, 68);
    view.defPosition("b6", 478, 342, 68, 68);
    view.defPosition("c6", 410, 342, 68, 68);
    view.defPosition("d6", 342, 342, 68, 68);
    view.defPosition("e6", 274, 342, 68, 68);
    view.defPosition("f6", 206, 342, 68, 68);
    view.defPosition("g6", 138, 342, 68, 68);
    view.defPosition("h6", 70, 342, 68, 68);
    view.defPosition("i6", 2, 342, 68, 68);
    view.defPosition("a5", 546, 274, 68, 68);
    view.defPosition("b5", 478, 274, 68, 68);
    view.defPosition("c5", 410, 274, 68, 68);
    view.defPosition("d5", 342, 274, 68, 68);
    view.defPosition("e5", 274, 274, 68, 68);
    view.defPosition("f5", 206, 274, 68, 68);
    view.defPosition("g5", 138, 274, 68, 68);
    view.defPosition("h5", 70, 274, 68, 68);
    view.defPosition("i5", 2, 274, 68, 68);
    view.defPosition("a4", 546, 206, 68, 68);
    view.defPosition("b4", 478, 206, 68, 68);
    view.defPosition("c4", 410, 206, 68, 68);
    view.defPosition("d4", 342, 206, 68, 68);
    view.defPosition("e4", 274, 206, 68, 68);
    view.defPosition("f4", 206, 206, 68, 68);
    view.defPosition("g4", 138, 206, 68, 68);
    view.defPosition("h4", 70, 206, 68, 68);
    view.defPosition("i4", 2, 206, 68, 68);
    view.defPosition("a3", 546, 138, 68, 68);
    view.defPosition("b3", 478, 138, 68, 68);
    view.defPosition("c3", 410, 138, 68, 68);
    view.defPosition("d3", 342, 138, 68, 68);
    view.defPosition("e3", 274, 138, 68, 68);
    view.defPosition("f3", 206, 138, 68, 68);
    view.defPosition("g3", 138, 138, 68, 68);
    view.defPosition("h3", 70, 138, 68, 68);
    view.defPosition("i3", 2, 138, 68, 68);
    view.defPosition("a2", 546, 70, 68, 68);
    view.defPosition("b2", 478, 70, 68, 68);
    view.defPosition("c2", 410, 70, 68, 68);
    view.defPosition("d2", 342, 70, 68, 68);
    view.defPosition("e2", 274, 70, 68, 68);
    view.defPosition("f2", 206, 70, 68, 68);
    view.defPosition("g2", 138, 70, 68, 68);
    view.defPosition("h2", 70, 70, 68, 68);
    view.defPosition("i2", 2, 70, 68, 68);
    view.defPosition("a1", 546, 2, 68, 68);
    view.defPosition("b1", 478, 2, 68, 68);
    view.defPosition("c1", 410, 2, 68, 68);
    view.defPosition("d1", 342, 2, 68, 68);
    view.defPosition("e1", 274, 2, 68, 68);
    view.defPosition("f1", 206, 2, 68, 68);
    view.defPosition("g1", 138, 2, 68, 68);
    view.defPosition("h1", 70, 2, 68, 68);
    view.defPosition("i1", 2, 2, 68, 68);
