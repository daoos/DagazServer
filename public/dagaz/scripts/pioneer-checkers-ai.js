...
Dagaz.AI.materialTable = [100, 1000];
        ...
        if (Dagaz.AI.g_board[pos] & me) {
            ...
            if (ix > 0) {
                Dagaz.AI.iterateStack(ix, function(x) {
                     ...
                     if (!(x & me)) result += Dagaz.AI.materialTable[pieceType];
                });
            }
            to = pos + (inc - 1);
...
function CheckGoal() {
  ...
  if (Dagaz.AI.g_board[pos] == 0) return false;
  return !(Dagaz.AI.g_board[pos] & me);
}
