...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 410, 410, 68, 68);
    view.defPosition("b7", 342, 410, 68, 68);
    view.defPosition("c7", 274, 410, 68, 68);
    view.defPosition("d7", 206, 410, 68, 68);
    view.defPosition("e7", 138, 410, 68, 68);
    view.defPosition("f7", 70, 410, 68, 68);
    view.defPosition("g7", 2, 410, 68, 68);
    view.defPosition("a6", 410, 342, 68, 68);
    view.defPosition("b6", 342, 342, 68, 68);
    view.defPosition("c6", 274, 342, 68, 68);
    view.defPosition("d6", 206, 342, 68, 68);
    view.defPosition("e6", 138, 342, 68, 68);
    view.defPosition("f6", 70, 342, 68, 68);
    view.defPosition("g6", 2, 342, 68, 68);
    view.defPosition("a5", 410, 274, 68, 68);
    view.defPosition("b5", 342, 274, 68, 68);
    view.defPosition("c5", 274, 274, 68, 68);
    view.defPosition("d5", 206, 274, 68, 68);
    view.defPosition("e5", 138, 274, 68, 68);
    view.defPosition("f5", 70, 274, 68, 68);
    view.defPosition("g5", 2, 274, 68, 68);
    view.defPosition("a4", 410, 206, 68, 68);
    view.defPosition("b4", 342, 206, 68, 68);
    view.defPosition("c4", 274, 206, 68, 68);
    view.defPosition("d4", 206, 206, 68, 68);
    view.defPosition("e4", 138, 206, 68, 68);
    view.defPosition("f4", 70, 206, 68, 68);
    view.defPosition("g4", 2, 206, 68, 68);
    view.defPosition("a3", 410, 138, 68, 68);
    view.defPosition("b3", 342, 138, 68, 68);
    view.defPosition("c3", 274, 138, 68, 68);
    view.defPosition("d3", 206, 138, 68, 68);
    view.defPosition("e3", 138, 138, 68, 68);
    view.defPosition("f3", 70, 138, 68, 68);
    view.defPosition("g3", 2, 138, 68, 68);
    view.defPosition("a2", 410, 70, 68, 68);
    view.defPosition("b2", 342, 70, 68, 68);
    view.defPosition("c2", 274, 70, 68, 68);
    view.defPosition("d2", 206, 70, 68, 68);
    view.defPosition("e2", 138, 70, 68, 68);
    view.defPosition("f2", 70, 70, 68, 68);
    view.defPosition("g2", 2, 70, 68, 68);
    view.defPosition("a1", 410, 2, 68, 68);
    view.defPosition("b1", 342, 2, 68, 68);
    view.defPosition("c1", 274, 2, 68, 68);
    view.defPosition("d1", 206, 2, 68, 68);
    view.defPosition("e1", 138, 2, 68, 68);
    view.defPosition("f1", 70, 2, 68, 68);
    view.defPosition("g1", 2, 2, 68, 68);
}
