...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 410, 452, 68, 68);
    view.defPosition("b7", 342, 452, 68, 68);
    view.defPosition("c7", 274, 452, 68, 68);
    view.defPosition("d7", 206, 452, 68, 68);
    view.defPosition("e7", 138, 452, 68, 68);
    view.defPosition("f7", 70, 452, 68, 68);
    view.defPosition("g7", 2, 452, 68, 68);
    view.defPosition("a6", 410, 384, 68, 68);
    view.defPosition("b6", 342, 384, 68, 68);
    view.defPosition("c6", 274, 384, 68, 68);
    view.defPosition("d6", 206, 384, 68, 68);
    view.defPosition("e6", 138, 384, 68, 68);
    view.defPosition("f6", 70, 384, 68, 68);
    view.defPosition("g6", 2, 384, 68, 68);
    view.defPosition("a5", 410, 316, 68, 68);
    view.defPosition("b5", 342, 316, 68, 68);
    view.defPosition("c5", 274, 316, 68, 68);
    view.defPosition("d5", 206, 316, 68, 68);
    view.defPosition("e5", 138, 316, 68, 68);
    view.defPosition("f5", 70, 316, 68, 68);
    view.defPosition("g5", 2, 316, 68, 68);
    view.defPosition("a4", 410, 248, 68, 68);
    view.defPosition("b4", 342, 248, 68, 68);
    view.defPosition("c4", 274, 248, 68, 68);
    view.defPosition("d4", 206, 248, 68, 68);
    view.defPosition("e4", 138, 248, 68, 68);
    view.defPosition("f4", 70, 248, 68, 68);
    view.defPosition("g4", 2, 248, 68, 68);
    view.defPosition("a3", 410, 180, 68, 68);
    view.defPosition("b3", 342, 180, 68, 68);
    view.defPosition("c3", 274, 180, 68, 68);
    view.defPosition("d3", 206, 180, 68, 68);
    view.defPosition("e3", 138, 180, 68, 68);
    view.defPosition("f3", 70, 180, 68, 68);
    view.defPosition("g3", 2, 180, 68, 68);
    view.defPosition("a2", 410, 112, 68, 68);
    view.defPosition("b2", 342, 112, 68, 68);
    view.defPosition("c2", 274, 112, 68, 68);
    view.defPosition("d2", 206, 112, 68, 68);
    view.defPosition("e2", 138, 112, 68, 68);
    view.defPosition("f2", 70, 112, 68, 68);
    view.defPosition("g2", 2, 112, 68, 68);
    view.defPosition("a1", 410, 44, 68, 68);
    view.defPosition("b1", 342, 44, 68, 68);
    view.defPosition("c1", 274, 44, 68, 68);
    view.defPosition("d1", 206, 44, 68, 68);
    view.defPosition("e1", 138, 44, 68, 68);
    view.defPosition("f1", 70, 44, 68, 68);
    view.defPosition("g1", 2, 44, 68, 68);
}
