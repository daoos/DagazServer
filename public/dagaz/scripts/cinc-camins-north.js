...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a5", 246, 246, 61, 61);
    view.defPosition("b5", 185, 246, 61, 61);
    view.defPosition("c5", 124, 246, 61, 61);
    view.defPosition("d5", 63, 246, 61, 61);
    view.defPosition("e5", 2, 246, 61, 61);
    view.defPosition("a4", 246, 185, 61, 61);
    view.defPosition("b4", 185, 185, 61, 61);
    view.defPosition("c4", 124, 185, 61, 61);
    view.defPosition("d4", 63, 185, 61, 61);
    view.defPosition("e4", 2, 185, 61, 61);
    view.defPosition("a3", 246, 124, 61, 61);
    view.defPosition("b3", 185, 124, 61, 61);
    view.defPosition("c3", 124, 124, 61, 61);
    view.defPosition("d3", 63, 124, 61, 61);
    view.defPosition("e3", 2, 124, 61, 61);
    view.defPosition("a2", 246, 63, 61, 61);
    view.defPosition("b2", 185, 63, 61, 61);
    view.defPosition("c2", 124, 63, 61, 61);
    view.defPosition("d2", 63, 63, 61, 61);
    view.defPosition("e2", 2, 63, 61, 61);
    view.defPosition("a1", 246, 2, 61, 61);
    view.defPosition("b1", 185, 2, 61, 61);
    view.defPosition("c1", 124, 2, 61, 61);
    view.defPosition("d1", 63, 2, 61, 61);
    view.defPosition("e1", 2, 2, 61, 61);
}
