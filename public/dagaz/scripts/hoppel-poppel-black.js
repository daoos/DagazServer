...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(11, ZRF.FUNCTION,	20);	// verify
    design.addCommand(11, ZRF.LITERAL,	1);	// Rook
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("WhiteKnibis", "White Knibis");
    view.defPiece("BlackKnibis", "Black Knibis");
    view.defPiece("WhiteBiskni", "White Biskni");
    view.defPiece("BlackBiskni", "Black Biskni");
