...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("m1b", 9, 276, 34, 32);
    view.defPosition("m1c", 9, 244, 34, 32);
    view.defPosition("l1a", 43, 308, 34, 32);
    view.defPosition("l1b", 43, 276, 34, 32);
    view.defPosition("l1c", 43, 244, 34, 32);
    view.defPosition("k1a", 77, 308, 34, 32);
    view.defPosition("k1b", 77, 276, 34, 32);
    view.defPosition("k1c", 77, 244, 34, 32);
    view.defPosition("j1a", 111, 308, 34, 32);
    view.defPosition("j1b", 111, 276, 34, 32);
    view.defPosition("j1c", 111, 244, 34, 32);
    view.defPosition("h1a", 145, 308, 34, 32);
    view.defPosition("h1b", 145, 276, 34, 32);
    view.defPosition("h1c", 145, 244, 34, 32);
    view.defPosition("g1a", 179, 308, 34, 32);
    view.defPosition("g1b", 179, 276, 34, 32);
    view.defPosition("g1c", 179, 244, 34, 32);
    view.defPosition("f1a", 237, 308, 34, 32);
    view.defPosition("f1b", 237, 276, 34, 32);
    view.defPosition("f1c", 237, 244, 34, 32);
    view.defPosition("e1a", 271, 308, 34, 32);
    view.defPosition("e1b", 271, 276, 34, 32);
    view.defPosition("e1c", 271, 244, 34, 32);
    view.defPosition("d1a", 305, 308, 34, 32);
    view.defPosition("d1b", 305, 276, 34, 32);
    view.defPosition("d1c", 305, 244, 34, 32);
    view.defPosition("c1a", 339, 308, 34, 32);
    view.defPosition("c1b", 339, 276, 34, 32);
    view.defPosition("c1c", 339, 244, 34, 32);
    view.defPosition("b1a", 373, 308, 34, 32);
    view.defPosition("b1b", 373, 276, 34, 32);
    view.defPosition("b1c", 373, 244, 34, 32);
    view.defPosition("a1a", 407, 308, 34, 32);
    view.defPosition("a1b", 407, 276, 34, 32);
    view.defPosition("a1c", 407, 244, 34, 32);
    view.defPosition("m2a", 9, 10, 34, 32);
    view.defPosition("m2b", 9, 42, 34, 32);
    view.defPosition("m2c", 9, 74, 34, 32);
    view.defPosition("l2a", 43, 10, 34, 32);
    view.defPosition("l2b", 43, 42, 34, 32);
    view.defPosition("l2c", 43, 74, 34, 32);
    view.defPosition("k2a", 77, 10, 34, 32);
    view.defPosition("k2b", 77, 42, 34, 32);
    view.defPosition("k2c", 77, 74, 34, 32);
    view.defPosition("j2a", 111, 10, 34, 32);
    view.defPosition("j2b", 111, 42, 34, 32);
    view.defPosition("j2c", 111, 74, 34, 32);
    view.defPosition("h2a", 145, 10, 34, 32);
    view.defPosition("h2b", 145, 42, 34, 32);
    view.defPosition("h2c", 145, 74, 34, 32);
    view.defPosition("g2a", 179, 10, 34, 32);
    view.defPosition("g2b", 179, 42, 34, 32);
    view.defPosition("g2c", 179, 74, 34, 32);
    view.defPosition("f2a", 237, 10, 34, 32);
    view.defPosition("f2b", 237, 42, 34, 32);
    view.defPosition("f2c", 237, 74, 34, 32);
    view.defPosition("e2a", 271, 10, 34, 32);
    view.defPosition("e2b", 271, 42, 34, 32);
    view.defPosition("e2c", 271, 74, 34, 32);
    view.defPosition("d2a", 305, 10, 34, 32);
    view.defPosition("d2b", 305, 42, 34, 32);
    view.defPosition("d2c", 305, 74, 34, 32);
    view.defPosition("c2a", 339, 10, 34, 32);
    view.defPosition("c2b", 339, 42, 34, 32);
    view.defPosition("c2c", 339, 74, 34, 32);
    view.defPosition("b2a", 373, 10, 34, 32);
    view.defPosition("b2b", 373, 42, 34, 32);
    view.defPosition("b2c", 373, 74, 34, 32);
    view.defPosition("a2a", 407, 10, 34, 32);
    view.defPosition("a2b", 407, 42, 34, 32);
    view.defPosition("a2c", 407, 74, 34, 32);
    view.defPosition("H2a", 456, 308, 40, 32);
    view.defPosition("H2b", 456, 276, 40, 32);
    view.defPosition("H2c", 456, 244, 40, 32);
    view.defPosition("H1a", 456, 10, 40, 32);
    view.defPosition("H1b", 456, 42, 40, 32);
    view.defPosition("H1c", 456, 74, 40, 32);
