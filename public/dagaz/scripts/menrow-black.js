...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a10", 351, 452, 50, 50);
    view.defPosition("b10", 301, 452, 50, 50);
    view.defPosition("c10", 251, 452, 50, 50);
    view.defPosition("d10", 201, 452, 50, 50);
    view.defPosition("e10", 151, 452, 50, 50);
    view.defPosition("f10", 101, 452, 50, 50);
    view.defPosition("g10", 51, 452, 50, 50);
    view.defPosition("h10", 1, 452, 50, 50);
    view.defPosition("a9", 351, 402, 50, 50);
    view.defPosition("b9", 301, 402, 50, 50);
    view.defPosition("c9", 251, 402, 50, 50);
    view.defPosition("d9", 201, 402, 50, 50);
    view.defPosition("e9", 151, 402, 50, 50);
    view.defPosition("f9", 101, 402, 50, 50);
    view.defPosition("g9", 51, 402, 50, 50);
    view.defPosition("h9", 1, 402, 50, 50);
    view.defPosition("a8", 351, 352, 50, 50);
    view.defPosition("b8", 301, 352, 50, 50);
    view.defPosition("c8", 251, 352, 50, 50);
    view.defPosition("d8", 201, 352, 50, 50);
    view.defPosition("e8", 151, 352, 50, 50);
    view.defPosition("f8", 101, 352, 50, 50);
    view.defPosition("g8", 51, 352, 50, 50);
    view.defPosition("h8", 1, 352, 50, 50);
    view.defPosition("a7", 351, 302, 50, 50);
    view.defPosition("b7", 301, 302, 50, 50);
    view.defPosition("c7", 251, 302, 50, 50);
    view.defPosition("d7", 201, 302, 50, 50);
    view.defPosition("e7", 151, 302, 50, 50);
    view.defPosition("f7", 101, 302, 50, 50);
    view.defPosition("g7", 51, 302, 50, 50);
    view.defPosition("h7", 1, 302, 50, 50);
    view.defPosition("a6", 351, 252, 50, 50);
    view.defPosition("b6", 301, 252, 50, 50);
    view.defPosition("c6", 251, 252, 50, 50);
    view.defPosition("d6", 201, 252, 50, 50);
    view.defPosition("e6", 151, 252, 50, 50);
    view.defPosition("f6", 101, 252, 50, 50);
    view.defPosition("g6", 51, 252, 50, 50);
    view.defPosition("h6", 1, 252, 50, 50);
    view.defPosition("a5", 351, 202, 50, 50);
    view.defPosition("b5", 301, 202, 50, 50);
    view.defPosition("c5", 251, 202, 50, 50);
    view.defPosition("d5", 201, 202, 50, 50);
    view.defPosition("e5", 151, 202, 50, 50);
    view.defPosition("f5", 101, 202, 50, 50);
    view.defPosition("g5", 51, 202, 50, 50);
    view.defPosition("h5", 1, 202, 50, 50);
    view.defPosition("a4", 351, 152, 50, 50);
    view.defPosition("b4", 301, 152, 50, 50);
    view.defPosition("c4", 251, 152, 50, 50);
    view.defPosition("d4", 201, 152, 50, 50);
    view.defPosition("e4", 151, 152, 50, 50);
    view.defPosition("f4", 101, 152, 50, 50);
    view.defPosition("g4", 51, 152, 50, 50);
    view.defPosition("h4", 1, 152, 50, 50);
    view.defPosition("a3", 351, 102, 50, 50);
    view.defPosition("b3", 301, 102, 50, 50);
    view.defPosition("c3", 251, 102, 50, 50);
    view.defPosition("d3", 201, 102, 50, 50);
    view.defPosition("e3", 151, 102, 50, 50);
    view.defPosition("f3", 101, 102, 50, 50);
    view.defPosition("g3", 51, 102, 50, 50);
    view.defPosition("h3", 1, 102, 50, 50);
    view.defPosition("a2", 351, 52, 50, 50);
    view.defPosition("b2", 301, 52, 50, 50);
    view.defPosition("c2", 251, 52, 50, 50);
    view.defPosition("d2", 201, 52, 50, 50);
    view.defPosition("e2", 151, 52, 50, 50);
    view.defPosition("f2", 101, 52, 50, 50);
    view.defPosition("g2", 51, 52, 50, 50);
    view.defPosition("h2", 1, 52, 50, 50);
    view.defPosition("a1", 351, 2, 50, 50);
    view.defPosition("b1", 301, 2, 50, 50);
    view.defPosition("c1", 251, 2, 50, 50);
    view.defPosition("d1", 201, 2, 50, 50);
    view.defPosition("e1", 151, 2, 50, 50);
    view.defPosition("f1", 101, 2, 50, 50);
    view.defPosition("g1", 51, 2, 50, 50);
    view.defPosition("h1", 1, 2, 50, 50);
