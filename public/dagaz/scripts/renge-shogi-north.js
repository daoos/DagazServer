...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X7", 501, 291, 41, 46);
    view.defPosition("Y7", 460, 291, 41, 46);
    view.defPosition("I7", 419, 291, 41, 46);
    view.defPosition("a7", 378, 291, 41, 46);
    view.defPosition("b7", 337, 291, 41, 46);
    view.defPosition("c7", 296, 291, 41, 46);
    view.defPosition("d7", 255, 291, 41, 46);
    view.defPosition("e7", 214, 291, 41, 46);
    view.defPosition("f7", 173, 291, 41, 46);
    view.defPosition("g7", 132, 291, 41, 46);
    view.defPosition("J7", 91, 291, 41, 46);
    view.defPosition("Z7", 50, 291, 41, 46);
    view.defPosition("T7", 9, 291, 41, 46);
    view.defPosition("X6", 501, 245, 41, 46);
    view.defPosition("Y6", 460, 245, 41, 46);
    view.defPosition("I6", 419, 245, 41, 46);
    view.defPosition("a6", 378, 245, 41, 46);
    view.defPosition("b6", 337, 245, 41, 46);
    view.defPosition("c6", 296, 245, 41, 46);
    view.defPosition("d6", 255, 245, 41, 46);
    view.defPosition("e6", 214, 245, 41, 46);
    view.defPosition("f6", 173, 245, 41, 46);
    view.defPosition("g6", 132, 245, 41, 46);
    view.defPosition("J6", 91, 245, 41, 46);
    view.defPosition("Z6", 50, 245, 41, 46);
    view.defPosition("T6", 9, 245, 41, 46);
    view.defPosition("X5", 501, 199, 41, 46);
    view.defPosition("Y5", 460, 199, 41, 46);
    view.defPosition("I5", 419, 199, 41, 46);
    view.defPosition("a5", 378, 199, 41, 46);
    view.defPosition("b5", 337, 199, 41, 46);
    view.defPosition("c5", 296, 199, 41, 46);
    view.defPosition("d5", 255, 199, 41, 46);
    view.defPosition("e5", 214, 199, 41, 46);
    view.defPosition("f5", 173, 199, 41, 46);
    view.defPosition("g5", 132, 199, 41, 46);
    view.defPosition("J5", 91, 199, 41, 46);
    view.defPosition("Z5", 50, 199, 41, 46);
    view.defPosition("T5", 9, 199, 41, 46);
    view.defPosition("X4", 501, 153, 41, 46);
    view.defPosition("Y4", 460, 153, 41, 46);
    view.defPosition("I4", 419, 153, 41, 46);
    view.defPosition("a4", 378, 153, 41, 46);
    view.defPosition("b4", 337, 153, 41, 46);
    view.defPosition("c4", 296, 153, 41, 46);
    view.defPosition("d4", 255, 153, 41, 46);
    view.defPosition("e4", 214, 153, 41, 46);
    view.defPosition("f4", 173, 153, 41, 46);
    view.defPosition("g4", 132, 153, 41, 46);
    view.defPosition("J4", 91, 153, 41, 46);
    view.defPosition("Z4", 50, 153, 41, 46);
    view.defPosition("T4", 9, 153, 41, 46);
    view.defPosition("X3", 501, 107, 41, 46);
    view.defPosition("Y3", 460, 107, 41, 46);
    view.defPosition("I3", 419, 107, 41, 46);
    view.defPosition("a3", 378, 107, 41, 46);
    view.defPosition("b3", 337, 107, 41, 46);
    view.defPosition("c3", 296, 107, 41, 46);
    view.defPosition("d3", 255, 107, 41, 46);
    view.defPosition("e3", 214, 107, 41, 46);
    view.defPosition("f3", 173, 107, 41, 46);
    view.defPosition("g3", 132, 107, 41, 46);
    view.defPosition("J3", 91, 107, 41, 46);
    view.defPosition("Z3", 50, 107, 41, 46);
    view.defPosition("T3", 9, 107, 41, 46);
    view.defPosition("X2", 501, 61, 41, 46);
    view.defPosition("Y2", 460, 61, 41, 46);
    view.defPosition("I2", 419, 61, 41, 46);
    view.defPosition("a2", 378, 61, 41, 46);
    view.defPosition("b2", 337, 61, 41, 46);
    view.defPosition("c2", 296, 61, 41, 46);
    view.defPosition("d2", 255, 61, 41, 46);
    view.defPosition("e2", 214, 61, 41, 46);
    view.defPosition("f2", 173, 61, 41, 46);
    view.defPosition("g2", 132, 61, 41, 46);
    view.defPosition("J2", 91, 61, 41, 46);
    view.defPosition("Z2", 50, 61, 41, 46);
    view.defPosition("T2", 9, 61, 41, 46);
    view.defPosition("X1", 501, 15, 41, 46);
    view.defPosition("Y1", 460, 15, 41, 46);
    view.defPosition("I1", 419, 15, 41, 46);
    view.defPosition("a1", 378, 15, 41, 46);
    view.defPosition("b1", 337, 15, 41, 46);
    view.defPosition("c1", 296, 15, 41, 46);
    view.defPosition("d1", 255, 15, 41, 46);
    view.defPosition("e1", 214, 15, 41, 46);
    view.defPosition("f1", 173, 15, 41, 46);
    view.defPosition("g1", 132, 15, 41, 46);
