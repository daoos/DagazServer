...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 804, 346, 42, 42);
    view.defPosition("b9", 662, 346, 42, 42);
    view.defPosition("c9", 520, 346, 42, 42);
    view.defPosition("d9", 378, 346, 42, 42);
    view.defPosition("e9", 236, 346, 42, 42);
    view.defPosition("a8", 733, 306, 42, 42);
    view.defPosition("b8", 591, 306, 42, 42);
    view.defPosition("c8", 449, 306, 42, 42);
    view.defPosition("d8", 307, 306, 42, 42);
    view.defPosition("e8", 165, 306, 42, 42);
    view.defPosition("a7", 662, 266, 42, 42);
    view.defPosition("b7", 520, 266, 42, 42);
    view.defPosition("c7", 378, 266, 42, 42);
    view.defPosition("d7", 236, 266, 42, 42);
    view.defPosition("e7", 94, 266, 42, 42);
    view.defPosition("a6", 591, 226, 42, 42);
    view.defPosition("b6", 449, 226, 42, 42);
    view.defPosition("c6", 307, 226, 42, 42);
    view.defPosition("d6", 165, 226, 42, 42);
    view.defPosition("e6", 23, 226, 42, 42);
    view.defPosition("a5", 520, 186, 42, 42);
    view.defPosition("b5", 378, 186, 42, 42);
    view.defPosition("c5", 236, 186, 42, 42);
    view.defPosition("d5", 94, 186, 42, 42);
    view.defPosition("e5", -48, 186, 42, 42);
    view.defPosition("a4", 449, 146, 42, 42);
    view.defPosition("b4", 307, 146, 42, 42);
    view.defPosition("c4", 165, 146, 42, 42);
    view.defPosition("d4", 23, 146, 42, 42);
    view.defPosition("e4", -119, 146, 42, 42);
    view.defPosition("a3", 378, 106, 42, 42);
    view.defPosition("b3", 236, 106, 42, 42);
    view.defPosition("c3", 94, 106, 42, 42);
    view.defPosition("d3", -48, 106, 42, 42);
    view.defPosition("e3", -190, 106, 42, 42);
    view.defPosition("a2", 307, 66, 42, 42);
    view.defPosition("b2", 165, 66, 42, 42);
    view.defPosition("c2", 23, 66, 42, 42);
    view.defPosition("d2", -119, 66, 42, 42);
    view.defPosition("e2", -261, 66, 42, 42);
    view.defPosition("a1", 236, 26, 42, 42);
    view.defPosition("b1", 94, 26, 42, 42);
    view.defPosition("c1", -48, 26, 42, 42);
    view.defPosition("d1", -190, 26, 42, 42);
    view.defPosition("e1", -332, 26, 42, 42);
}
