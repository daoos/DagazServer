...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Black", "Man", 104, 1);
    design.setup("Black", "Man", 91, 1);
    design.setup("Black", "Man", 78, 1);
    design.setup("Black", "Man", 65, 1);
    design.setup("Black", "Man", 52, 1);
    design.setup("Black", "Man", 92, 1);
    design.setup("Black", "Man", 66, 1);
    design.setup("Black", "Man", 80, 1);
    design.setup("Black", "Man", 160, 1);
    design.setup("Black", "Man", 4, 1);
    design.setup("Black", "Man", 161, 1);
    design.setup("Black", "Man", 148, 1);
    design.setup("Black", "Man", 18, 1);
    design.setup("Black", "Man", 5, 1);
    design.setup("Black", "Man", 162, 1);
    design.setup("Black", "Man", 136, 1);
    design.setup("Black", "Man", 32, 1);
    design.setup("Black", "Man", 6, 1);
    design.setup("Black", "Man", 163, 1);
    design.setup("Black", "Man", 150, 1);
    design.setup("Black", "Man", 20, 1);
    design.setup("Black", "Man", 7, 1);
    design.setup("Black", "Man", 164, 1);
    design.setup("Black", "Man", 8, 1);
    design.setup("Black", "Man", 88, 1);
    design.setup("Black", "Man", 102, 1);
    design.setup("Black", "Man", 76, 1);
    design.setup("Black", "Man", 116, 1);
    design.setup("Black", "Man", 103, 1);
    design.setup("Black", "Man", 90, 1);
    design.setup("Black", "Man", 77, 1);
    design.setup("Black", "Man", 64, 1);
    design.setup("White", "King", 84, 1);
    design.setup("White", "Man", 81, 1);
    design.setup("White", "Man", 108, 1);
    design.setup("White", "Man", 56, 1);
    design.setup("White", "Man", 96, 1);
    design.setup("White", "Man", 83, 1);
    design.setup("White", "Man", 70, 1);
    design.setup("White", "Man", 123, 1);
    design.setup("White", "Man", 97, 1);
    design.setup("White", "Man", 71, 1);
    design.setup("White", "Man", 45, 1);
    design.setup("White", "Man", 98, 1);
    design.setup("White", "Man", 85, 1);
    design.setup("White", "Man", 72, 1);
    design.setup("White", "Man", 112, 1);
    design.setup("White", "Man", 60, 1);
    design.setup("White", "Man", 87, 1);

    design.setup("Black", "Man", 104, 2);
    design.setup("Black", "Man", 91, 2);
    design.setup("Black", "Man", 78, 2);
    design.setup("Black", "Man", 65, 2);
    design.setup("Black", "Man", 52, 2);
    design.setup("Black", "Man", 79, 2);
    design.setup("Black", "Man", 160, 2);
    design.setup("Black", "Man", 4, 2);
    design.setup("Black", "Man", 161, 2);
    design.setup("Black", "Man", 5, 2);
    design.setup("Black", "Man", 162, 2);
    design.setup("Black", "Man", 149, 2);
    design.setup("Black", "Man", 19, 2);
    design.setup("Black", "Man", 6, 2);
    design.setup("Black", "Man", 163, 2);
    design.setup("Black", "Man", 7, 2);
    design.setup("Black", "Man", 164, 2);
    design.setup("Black", "Man", 8, 2);
    design.setup("Black", "Man", 89, 2);
    design.setup("Black", "Man", 116, 2);
    design.setup("Black", "Man", 103, 2);
    design.setup("Black", "Man", 90, 2);
    design.setup("Black", "Man", 77, 2);
    design.setup("Black", "Man", 64, 2);
    design.setup("White", "King", 84, 2);
    design.setup("White", "Man", 82, 2);
    design.setup("White", "Man", 96, 2);
    design.setup("White", "Man", 83, 2);
    design.setup("White", "Man", 70, 2);
    design.setup("White", "Man", 110, 2);
    design.setup("White", "Man", 97, 2);
    design.setup("White", "Man", 71, 2);
    design.setup("White", "Man", 58, 2);
    design.setup("White", "Man", 98, 2);
    design.setup("White", "Man", 85, 2);
    design.setup("White", "Man", 72, 2);
    design.setup("White", "Man", 86, 2);

    design.setup("Black", "Man", 104, 3);
    design.setup("Black", "Man", 91, 3);
    design.setup("Black", "Man", 78, 3);
    design.setup("Black", "Man", 65, 3);
    design.setup("Black", "Man", 52, 3);
    design.setup("Black", "Man", 79, 3);
    design.setup("Black", "Man", 160, 3);
    design.setup("Black", "Man", 4, 3);
    design.setup("Black", "Man", 161, 3);
    design.setup("Black", "Man", 5, 3);
    design.setup("Black", "Man", 162, 3);
    design.setup("Black", "Man", 149, 3);
    design.setup("Black", "Man", 19, 3);
    design.setup("Black", "Man", 6, 3);
    design.setup("Black", "Man", 163, 3);
    design.setup("Black", "Man", 7, 3);
    design.setup("Black", "Man", 164, 3);
    design.setup("Black", "Man", 8, 3);
    design.setup("Black", "Man", 89, 3);
    design.setup("Black", "Man", 116, 3);
    design.setup("Black", "Man", 103, 3);
    design.setup("Black", "Man", 90, 3);
    design.setup("Black", "Man", 77, 3);
    design.setup("Black", "Man", 64, 3);
    design.setup("White", "King", 84, 3);
    design.setup("White", "Man", 81, 3);
    design.setup("White", "Man", 82, 3);
    design.setup("White", "Man", 83, 3);
    design.setup("White", "Man", 123, 3);
    design.setup("White", "Man", 110, 3);
    design.setup("White", "Man", 97, 3);
    design.setup("White", "Man", 71, 3);
    design.setup("White", "Man", 58, 3);
    design.setup("White", "Man", 45, 3);
    design.setup("White", "Man", 85, 3);
    design.setup("White", "Man", 86, 3);
    design.setup("White", "Man", 87, 3);
