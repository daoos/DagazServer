...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 274, 373, 50, 50);
    view.defPosition("b7", 224, 373, 50, 50);
    view.defPosition("c7", 174, 373, 50, 50);
    view.defPosition("d7", 124, 373, 50, 50);
    view.defPosition("e7", 74, 373, 50, 50);
    view.defPosition("f7", 24, 373, 50, 50);
    view.defPosition("a6", 274, 323, 50, 50);
    view.defPosition("b6", 224, 323, 50, 50);
    view.defPosition("c6", 174, 323, 50, 50);
    view.defPosition("d6", 124, 323, 50, 50);
    view.defPosition("e6", 74, 323, 50, 50);
    view.defPosition("f6", 24, 323, 50, 50);
    view.defPosition("a5", 274, 273, 50, 50);
    view.defPosition("b5", 224, 273, 50, 50);
    view.defPosition("c5", 174, 273, 50, 50);
    view.defPosition("d5", 124, 273, 50, 50);
    view.defPosition("e5", 74, 273, 50, 50);
    view.defPosition("f5", 24, 273, 50, 50);
    view.defPosition("a4", 274, 223, 50, 50);
    view.defPosition("b4", 224, 223, 50, 50);
    view.defPosition("c4", 174, 223, 50, 50);
    view.defPosition("d4", 124, 223, 50, 50);
    view.defPosition("e4", 74, 223, 50, 50);
    view.defPosition("f4", 24, 223, 50, 50);
    view.defPosition("a3", 274, 173, 50, 50);
    view.defPosition("b3", 224, 173, 50, 50);
    view.defPosition("c3", 174, 173, 50, 50);
    view.defPosition("d3", 124, 173, 50, 50);
    view.defPosition("e3", 74, 173, 50, 50);
    view.defPosition("f3", 24, 173, 50, 50);
    view.defPosition("a2", 274, 123, 50, 50);
    view.defPosition("b2", 224, 123, 50, 50);
    view.defPosition("c2", 174, 123, 50, 50);
    view.defPosition("d2", 124, 123, 50, 50);
    view.defPosition("e2", 74, 123, 50, 50);
    view.defPosition("f2", 24, 123, 50, 50);
    view.defPosition("a1", 274, 73, 50, 50);
    view.defPosition("b1", 224, 73, 50, 50);
    view.defPosition("c1", 174, 73, 50, 50);
    view.defPosition("d1", 124, 73, 50, 50);
    view.defPosition("e1", 74, 73, 50, 50);
    view.defPosition("f1", 24, 73, 50, 50);
    view.defPosition("a0", 274, 23, 50, 50);
    view.defPosition("b0", 224, 23, 50, 50);
    view.defPosition("c0", 174, 23, 50, 50);
    view.defPosition("d0", 124, 23, 50, 50);
    view.defPosition("e0", 74, 23, 50, 50);
    view.defPosition("f0", 24, 23, 50, 50);
}
