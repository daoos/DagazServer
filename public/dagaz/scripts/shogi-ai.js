...
var piecePawnP            = 0x04;
var pieceKnightP          = 0x05;
var pieceSilverP          = 0x06;
var pieceLanceP           = 0x07;
var pieceGold             = 0x08;
var pieceLance            = 0x09;
var pieceBishop           = 0x0A;
var pieceRook             = 0x0B;
var pieceBishopP          = 0x0C;
var pieceRookP            = 0x0D;
var pieceKing             = 0x0E;
var pieceNo               = 0x80;
   ...
   for (var slot = 0; slot < RESERVE_SIZE; slot++) {
       ...
       for (var to = 0; to < 256; to++) {
           ...
           if (((piece & Dagaz.AI.TYPE_MASK) == piecePawn) || ((piece & Dagaz.AI.TYPE_MASK) == pieceLance)) {
               ...
               if ((pawnPos != 0) && ((piece & Dagaz.AI.TYPE_MASK) == pieceLance)) {
