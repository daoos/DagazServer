...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a1", 270, 85, 31, 31);
    view.defPosition("a2", 270, 125, 31, 31);
    view.defPosition("a3", 270, 165, 31, 31);
    view.defPosition("a4", 270, 205, 31, 31);
    view.defPosition("a5", 270, 245, 31, 31);
    view.defPosition("b1", 237, 65, 31, 31);
    view.defPosition("b2", 237, 105, 31, 31);
    view.defPosition("b3", 237, 145, 31, 31);
    view.defPosition("b4", 237, 185, 31, 31);
    view.defPosition("b5", 237, 225, 31, 31);
    view.defPosition("b6", 237, 265, 31, 31);
    view.defPosition("c1", 204, 45, 31, 31);
    view.defPosition("c2", 204, 85, 31, 31);
    view.defPosition("c3", 204, 125, 31, 31);
    view.defPosition("c4", 204, 165, 31, 31);
    view.defPosition("c5", 204, 205, 31, 31);
    view.defPosition("c6", 204, 245, 31, 31);
    view.defPosition("c7", 204, 285, 31, 31);
    view.defPosition("d1", 171, 25, 31, 31);
    view.defPosition("d2", 171, 65, 31, 31);
    view.defPosition("d3", 171, 105, 31, 31);
    view.defPosition("d4", 171, 145, 31, 31);
    view.defPosition("d5", 171, 185, 31, 31);
    view.defPosition("d6", 171, 225, 31, 31);
    view.defPosition("d7", 171, 265, 31, 31);
    view.defPosition("d8", 171, 305, 31, 31);
    view.defPosition("e1", 138, 5, 31, 31);
    view.defPosition("e2", 138, 45, 31, 31);
    view.defPosition("e3", 138, 85, 31, 31);
    view.defPosition("e4", 138, 125, 31, 31);
    view.defPosition("e5", 138, 165, 31, 31);
    view.defPosition("e6", 138, 205, 31, 31);
    view.defPosition("e7", 138, 245, 31, 31);
    view.defPosition("e8", 138, 285, 31, 31);
    view.defPosition("e9", 138, 325, 31, 31);
    view.defPosition("f1", 105, 25, 31, 31);
    view.defPosition("f2", 105, 65, 31, 31);
    view.defPosition("f3", 105, 105, 31, 31);
    view.defPosition("f4", 105, 145, 31, 31);
    view.defPosition("f5", 105, 185, 31, 31);
    view.defPosition("f6", 105, 225, 31, 31);
    view.defPosition("f7", 105, 265, 31, 31);
    view.defPosition("f8", 105, 305, 31, 31);
    view.defPosition("g1", 72, 45, 31, 31);
    view.defPosition("g2", 72, 85, 31, 31);
    view.defPosition("g3", 72, 125, 31, 31);
    view.defPosition("g4", 72, 165, 31, 31);
    view.defPosition("g5", 72, 205, 31, 31);
    view.defPosition("g6", 72, 245, 31, 31);
    view.defPosition("g7", 72, 285, 31, 31);
    view.defPosition("h1", 39, 65, 31, 31);
    view.defPosition("h2", 39, 105, 31, 31);
    view.defPosition("h3", 39, 145, 31, 31);
    view.defPosition("h4", 39, 185, 31, 31);
    view.defPosition("h5", 39, 225, 31, 31);
    view.defPosition("h6", 39, 265, 31, 31);
    view.defPosition("i1", 6, 85, 31, 31);
    view.defPosition("i2", 6, 125, 31, 31);
    view.defPosition("i3", 6, 165, 31, 31);
    view.defPosition("i4", 6, 205, 31, 31);
    view.defPosition("i5", 6, 245, 31, 31);
