...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Man", 44, 1);
    design.setup("White", "Man", 53, 1);
    design.setup("White", "Man", 62, 1);
    design.setup("White", "Man", 46, 1);
    design.setup("White", "Man", 55, 1);
    design.setup("White", "Pawn", 48, 1);
    design.setup("White", "Pawn", 41, 1);
    design.setup("White", "Pawn", 50, 1);
    design.setup("White", "Pawn", 43, 1);
    design.setup("White", "Pawn", 52, 1);
    design.setup("White", "Pawn", 45, 1);
    design.setup("White", "Pawn", 54, 1);
    design.setup("White", "Pawn", 47, 1);
    ...
    design.setup("Black", "Man", 17, 1);
    design.setup("Black", "Man", 1, 1);
    design.setup("Black", "Man", 10, 1);
    design.setup("Black", "Man", 19, 1);
    ...
    design.setup("White", "Man", 41, 2);
    design.setup("White", "Man", 43, 2);
    design.setup("White", "Man", 45, 2);
    design.setup("White", "Man", 47, 2);
    design.setup("White", "Pawn", 40, 2);
    design.setup("White", "Pawn", 42, 2);
    design.setup("White", "Pawn", 44, 2);
    design.setup("White", "Pawn", 46, 2);
    design.setup("White", "Rook", 56, 2);
    design.setup("White", "Rook", 62, 2);
    design.setup("White", "Knight", 49, 2);
    design.setup("White", "Knight", 55, 2);
    design.setup("White", "Bishop", 51, 2);
    design.setup("White", "Bishop", 53, 2);
    design.setup("White", "Queen", 58, 2);
    design.setup("White", "King", 60, 2);
    ...
    design.setup("Black", "Man", 20, 2);
    design.setup("Black", "Man", 22, 2);
    design.setup("Black", "Pawn", 17, 2);
    design.setup("Black", "Pawn", 19, 2);
    design.setup("Black", "Pawn", 21, 2);
    design.setup("Black", "Pawn", 23, 2);
    design.setup("Black", "Rook", 1, 2);
    design.setup("Black", "Rook", 7, 2);
    design.setup("Black", "Knight", 8, 2);
    design.setup("Black", "Knight", 14, 2);
    design.setup("Black", "Bishop", 10, 2);
    design.setup("Black", "Bishop", 12, 2);
    design.setup("Black", "Queen", 5, 2);
    design.setup("Black", "King", 3, 2);

    design.setup("White", "Man", 48, 3);
    design.setup("White", "Man", 49, 3);
    design.setup("White", "Man", 50, 3);
    design.setup("White", "Man", 51, 3);
    design.setup("White", "Man", 52, 3);
    design.setup("White", "Man", 53, 3);
    design.setup("White", "Man", 54, 3);
    design.setup("White", "Man", 55, 3);
    design.setup("White", "Man", 40, 3);
    design.setup("White", "Man", 41, 3);
    design.setup("White", "Man", 42, 3);
    design.setup("White", "Man", 43, 3);
    design.setup("White", "Man", 44, 3);
    design.setup("White", "Man", 45, 3);
    design.setup("White", "Man", 46, 3);
    design.setup("White", "Man", 47, 3);
    design.setup("White", "Rook", 56, 3);
    design.setup("White", "Rook", 63, 3);
    design.setup("White", "Knight", 57, 3);
    design.setup("White", "Knight", 62, 3);
    design.setup("White", "Bishop", 58, 3);
    design.setup("White", "Bishop", 61, 3);
    design.setup("White", "Queen", 59, 3);
    design.setup("White", "King", 60, 3);
    design.setup("Black", "Man", 8, 3);
    design.setup("Black", "Man", 9, 3);
    design.setup("Black", "Man", 10, 3);
    design.setup("Black", "Man", 11, 3);
    design.setup("Black", "Man", 12, 3);
    design.setup("Black", "Man", 13, 3);
    design.setup("Black", "Man", 14, 3);
    design.setup("Black", "Man", 15, 3);
    design.setup("Black", "Man", 16, 3);
    design.setup("Black", "Man", 17, 3);
    design.setup("Black", "Man", 18, 3);
    design.setup("Black", "Man", 19, 3);
    design.setup("Black", "Man", 20, 3);
    design.setup("Black", "Man", 21, 3);
    design.setup("Black", "Man", 22, 3);
    design.setup("Black", "Man", 23, 3);
    design.setup("Black", "Rook", 0, 3);
    design.setup("Black", "Rook", 7, 3);
    design.setup("Black", "Knight", 1, 3);
    design.setup("Black", "Knight", 6, 3);
    design.setup("Black", "Bishop", 2, 3);
    design.setup("Black", "Bishop", 5, 3);
