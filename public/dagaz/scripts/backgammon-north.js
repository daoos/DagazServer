...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("m1a", 9, 308, 34, 32);
    view.defPosition("m1b", 9, 300, 34, 32);
    view.defPosition("m1c", 9, 292, 34, 32);
    view.defPosition("m1d", 9, 284, 34, 32);
    view.defPosition("m1e", 9, 276, 34, 32);
    view.defPosition("m1f", 9, 268, 34, 32);
    view.defPosition("m1g", 9, 260, 34, 32);
    view.defPosition("m1h", 9, 252, 34, 32);
    view.defPosition("m1i", 9, 244, 34, 32);
    view.defPosition("m1j", 9, 236, 34, 32);
    view.defPosition("m1k", 9, 228, 34, 32);
    view.defPosition("m1l", 9, 220, 34, 32);
    view.defPosition("m1m", 9, 212, 34, 32);
    view.defPosition("m1n", 9, 204, 34, 32);
    view.defPosition("m1o", 9, 196, 34, 32);
    view.defPosition("m1p", 9, 188, 34, 32);
    view.defPosition("m1q", 9, 180, 34, 32);
    view.defPosition("l1a", 43, 308, 34, 32);
    view.defPosition("l1b", 43, 300, 34, 32);
    view.defPosition("l1c", 43, 292, 34, 32);
    view.defPosition("l1d", 43, 284, 34, 32);
    view.defPosition("l1e", 43, 276, 34, 32);
    view.defPosition("l1f", 43, 268, 34, 32);
    view.defPosition("l1g", 43, 260, 34, 32);
    view.defPosition("l1h", 43, 252, 34, 32);
    view.defPosition("l1i", 43, 244, 34, 32);
    view.defPosition("l1j", 43, 236, 34, 32);
    view.defPosition("l1k", 43, 228, 34, 32);
    view.defPosition("l1l", 43, 220, 34, 32);
    view.defPosition("l1m", 43, 212, 34, 32);
    view.defPosition("l1n", 43, 204, 34, 32);
    view.defPosition("l1o", 43, 196, 34, 32);
    view.defPosition("l1p", 43, 188, 34, 32);
    view.defPosition("l1q", 43, 180, 34, 32);
    view.defPosition("k1a", 77, 308, 34, 32);
    view.defPosition("k1b", 77, 300, 34, 32);
    view.defPosition("k1c", 77, 292, 34, 32);
    view.defPosition("k1d", 77, 284, 34, 32);
    view.defPosition("k1e", 77, 276, 34, 32);
    view.defPosition("k1f", 77, 268, 34, 32);
    view.defPosition("k1g", 77, 260, 34, 32);
    view.defPosition("k1h", 77, 252, 34, 32);
    view.defPosition("k1i", 77, 244, 34, 32);
    view.defPosition("k1j", 77, 236, 34, 32);
    view.defPosition("k1k", 77, 228, 34, 32);
    view.defPosition("k1l", 77, 220, 34, 32);
    view.defPosition("k1m", 77, 212, 34, 32);
    view.defPosition("k1n", 77, 204, 34, 32);
    view.defPosition("k1o", 77, 196, 34, 32);
    view.defPosition("k1p", 77, 188, 34, 32);
    view.defPosition("k1q", 77, 180, 34, 32);
    view.defPosition("j1a", 111, 308, 34, 32);
    view.defPosition("j1b", 111, 300, 34, 32);
    view.defPosition("j1c", 111, 292, 34, 32);
    view.defPosition("j1d", 111, 284, 34, 32);
    view.defPosition("j1e", 111, 276, 34, 32);
    view.defPosition("j1f", 111, 268, 34, 32);
    view.defPosition("j1g", 111, 260, 34, 32);
    view.defPosition("j1h", 111, 252, 34, 32);
    view.defPosition("j1i", 111, 244, 34, 32);
    view.defPosition("j1j", 111, 236, 34, 32);
    view.defPosition("j1k", 111, 228, 34, 32);
    view.defPosition("j1l", 111, 220, 34, 32);
    view.defPosition("j1m", 111, 212, 34, 32);
    view.defPosition("j1n", 111, 204, 34, 32);
    view.defPosition("j1o", 111, 196, 34, 32);
    view.defPosition("j1p", 111, 188, 34, 32);
    view.defPosition("j1q", 111, 180, 34, 32);
    view.defPosition("h1a", 145, 308, 34, 32);
    view.defPosition("h1b", 145, 300, 34, 32);
    view.defPosition("h1c", 145, 292, 34, 32);
    view.defPosition("h1d", 145, 284, 34, 32);
    view.defPosition("h1e", 145, 276, 34, 32);
    view.defPosition("h1f", 145, 268, 34, 32);
    view.defPosition("h1g", 145, 260, 34, 32);
    view.defPosition("h1h", 145, 252, 34, 32);
    view.defPosition("h1i", 145, 244, 34, 32);
    view.defPosition("h1j", 145, 236, 34, 32);
    view.defPosition("h1k", 145, 228, 34, 32);
    view.defPosition("h1l", 145, 220, 34, 32);
    view.defPosition("h1m", 145, 212, 34, 32);
    view.defPosition("h1n", 145, 204, 34, 32);
    view.defPosition("h1o", 145, 196, 34, 32);
    view.defPosition("h1p", 145, 188, 34, 32);
    view.defPosition("h1q", 145, 180, 34, 32);
    view.defPosition("g1a", 179, 308, 34, 32);
    view.defPosition("g1b", 179, 300, 34, 32);
    view.defPosition("g1c", 179, 292, 34, 32);
    view.defPosition("g1d", 179, 284, 34, 32);
    view.defPosition("g1e", 179, 276, 34, 32);
    view.defPosition("g1f", 179, 268, 34, 32);
    view.defPosition("g1g", 179, 260, 34, 32);
    view.defPosition("g1h", 179, 252, 34, 32);
    view.defPosition("g1i", 179, 244, 34, 32);
    view.defPosition("g1j", 179, 236, 34, 32);
    view.defPosition("g1k", 179, 228, 34, 32);
    view.defPosition("g1l", 179, 220, 34, 32);
    view.defPosition("g1m", 179, 212, 34, 32);
    view.defPosition("g1n", 179, 204, 34, 32);
    view.defPosition("g1o", 179, 196, 34, 32);
    view.defPosition("g1p", 179, 188, 34, 32);
    view.defPosition("g1q", 179, 180, 34, 32);
    view.defPosition("f1a", 237, 308, 34, 32);
    view.defPosition("f1b", 237, 300, 34, 32);
    view.defPosition("f1c", 237, 292, 34, 32);
    view.defPosition("f1d", 237, 284, 34, 32);
    view.defPosition("f1e", 237, 276, 34, 32);
    view.defPosition("f1f", 237, 268, 34, 32);
    view.defPosition("f1g", 237, 260, 34, 32);
    view.defPosition("f1h", 237, 252, 34, 32);
    view.defPosition("f1i", 237, 244, 34, 32);
    view.defPosition("f1j", 237, 236, 34, 32);
    view.defPosition("f1k", 237, 228, 34, 32);
    view.defPosition("f1l", 237, 220, 34, 32);
    view.defPosition("f1m", 237, 212, 34, 32);
    view.defPosition("f1n", 237, 204, 34, 32);
    view.defPosition("f1o", 237, 196, 34, 32);
    view.defPosition("f1p", 237, 188, 34, 32);
    view.defPosition("f1q", 237, 180, 34, 32);
    view.defPosition("e1a", 271, 308, 34, 32);
    view.defPosition("e1b", 271, 300, 34, 32);
    view.defPosition("e1c", 271, 292, 34, 32);
    view.defPosition("e1d", 271, 284, 34, 32);
    view.defPosition("e1e", 271, 276, 34, 32);
    view.defPosition("e1f", 271, 268, 34, 32);
    view.defPosition("e1g", 271, 260, 34, 32);
    view.defPosition("e1h", 271, 252, 34, 32);
    view.defPosition("e1i", 271, 244, 34, 32);
    view.defPosition("e1j", 271, 236, 34, 32);
    view.defPosition("e1k", 271, 228, 34, 32);
    view.defPosition("e1l", 271, 220, 34, 32);
    view.defPosition("e1m", 271, 212, 34, 32);
    view.defPosition("e1n", 271, 204, 34, 32);
    view.defPosition("e1o", 271, 196, 34, 32);
    view.defPosition("e1p", 271, 188, 34, 32);
    view.defPosition("e1q", 271, 180, 34, 32);
    view.defPosition("d1a", 305, 308, 34, 32);
    view.defPosition("d1b", 305, 300, 34, 32);
    view.defPosition("d1c", 305, 292, 34, 32);
    view.defPosition("d1d", 305, 284, 34, 32);
    view.defPosition("d1e", 305, 276, 34, 32);
    view.defPosition("d1f", 305, 268, 34, 32);
    view.defPosition("d1g", 305, 260, 34, 32);
    view.defPosition("d1h", 305, 252, 34, 32);
    view.defPosition("d1i", 305, 244, 34, 32);
    view.defPosition("d1j", 305, 236, 34, 32);
    view.defPosition("d1k", 305, 228, 34, 32);
    view.defPosition("d1l", 305, 220, 34, 32);
    view.defPosition("d1m", 305, 212, 34, 32);
    view.defPosition("d1n", 305, 204, 34, 32);
    view.defPosition("d1o", 305, 196, 34, 32);
    view.defPosition("d1p", 305, 188, 34, 32);
    view.defPosition("d1q", 305, 180, 34, 32);
    view.defPosition("c1a", 339, 308, 34, 32);
    view.defPosition("c1b", 339, 300, 34, 32);
    view.defPosition("c1c", 339, 292, 34, 32);
    view.defPosition("c1d", 339, 284, 34, 32);
    view.defPosition("c1e", 339, 276, 34, 32);
    view.defPosition("c1f", 339, 268, 34, 32);
    view.defPosition("c1g", 339, 260, 34, 32);
    view.defPosition("c1h", 339, 252, 34, 32);
    view.defPosition("c1i", 339, 244, 34, 32);
    view.defPosition("c1j", 339, 236, 34, 32);
    view.defPosition("c1k", 339, 228, 34, 32);
    view.defPosition("c1l", 339, 220, 34, 32);
    view.defPosition("c1m", 339, 212, 34, 32);
    view.defPosition("c1n", 339, 204, 34, 32);
    view.defPosition("c1o", 339, 196, 34, 32);
    view.defPosition("c1p", 339, 188, 34, 32);
    view.defPosition("c1q", 339, 180, 34, 32);
    view.defPosition("b1a", 373, 308, 34, 32);
    view.defPosition("b1b", 373, 300, 34, 32);
    view.defPosition("b1c", 373, 292, 34, 32);
    view.defPosition("b1d", 373, 284, 34, 32);
    view.defPosition("b1e", 373, 276, 34, 32);
    view.defPosition("b1f", 373, 268, 34, 32);
    view.defPosition("b1g", 373, 260, 34, 32);
    view.defPosition("b1h", 373, 252, 34, 32);
    view.defPosition("b1i", 373, 244, 34, 32);
    view.defPosition("b1j", 373, 236, 34, 32);
    view.defPosition("b1k", 373, 228, 34, 32);
    view.defPosition("b1l", 373, 220, 34, 32);
    view.defPosition("b1m", 373, 212, 34, 32);
    view.defPosition("b1n", 373, 204, 34, 32);
    view.defPosition("b1o", 373, 196, 34, 32);
    view.defPosition("b1p", 373, 188, 34, 32);
    view.defPosition("b1q", 373, 180, 34, 32);
    view.defPosition("a1a", 407, 308, 34, 32);
    view.defPosition("a1b", 407, 300, 34, 32);
    view.defPosition("a1c", 407, 292, 34, 32);
    view.defPosition("a1d", 407, 284, 34, 32);
    view.defPosition("a1e", 407, 276, 34, 32);
    view.defPosition("a1f", 407, 268, 34, 32);
    view.defPosition("a1g", 407, 260, 34, 32);
    view.defPosition("a1h", 407, 252, 34, 32);
    view.defPosition("a1i", 407, 244, 34, 32);
    view.defPosition("a1j", 407, 236, 34, 32);
    view.defPosition("a1k", 407, 228, 34, 32);
    view.defPosition("a1l", 407, 220, 34, 32);
    view.defPosition("a1m", 407, 212, 34, 32);
    view.defPosition("a1n", 407, 204, 34, 32);
    view.defPosition("a1o", 407, 196, 34, 32);
    view.defPosition("a1p", 407, 188, 34, 32);
    view.defPosition("a1q", 407, 180, 34, 32);
    view.defPosition("m2a", 9, 10, 34, 32);
    view.defPosition("m2b", 9, 18, 34, 32);
    view.defPosition("m2c", 9, 26, 34, 32);
    view.defPosition("m2d", 9, 34, 34, 32);
    view.defPosition("m2e", 9, 42, 34, 32);
    view.defPosition("m2f", 9, 50, 34, 32);
    view.defPosition("m2g", 9, 58, 34, 32);
    view.defPosition("m2h", 9, 66, 34, 32);
    view.defPosition("m2i", 9, 74, 34, 32);
    view.defPosition("m2j", 9, 82, 34, 32);
    view.defPosition("m2k", 9, 90, 34, 32);
    view.defPosition("m2l", 9, 98, 34, 32);
    view.defPosition("m2m", 9, 106, 34, 32);
    view.defPosition("m2n", 9, 114, 34, 32);
    view.defPosition("m2o", 9, 122, 34, 32);
    view.defPosition("m2p", 9, 130, 34, 32);
    view.defPosition("m2q", 9, 138, 34, 32);
    view.defPosition("l2a", 43, 10, 34, 32);
    view.defPosition("l2b", 43, 18, 34, 32);
    view.defPosition("l2c", 43, 26, 34, 32);
    view.defPosition("l2d", 43, 34, 34, 32);
    view.defPosition("l2e", 43, 42, 34, 32);
    view.defPosition("l2f", 43, 50, 34, 32);
    view.defPosition("l2g", 43, 58, 34, 32);
    view.defPosition("l2h", 43, 66, 34, 32);
    view.defPosition("l2i", 43, 74, 34, 32);
    view.defPosition("l2j", 43, 82, 34, 32);
    view.defPosition("l2k", 43, 90, 34, 32);
    view.defPosition("l2l", 43, 98, 34, 32);
    view.defPosition("l2m", 43, 106, 34, 32);
    view.defPosition("l2n", 43, 114, 34, 32);
    view.defPosition("l2o", 43, 122, 34, 32);
    view.defPosition("l2p", 43, 130, 34, 32);
    view.defPosition("l2q", 43, 138, 34, 32);
    view.defPosition("k2a", 77, 10, 34, 32);
    view.defPosition("k2b", 77, 18, 34, 32);
    view.defPosition("k2c", 77, 26, 34, 32);
    view.defPosition("k2d", 77, 34, 34, 32);
    view.defPosition("k2e", 77, 42, 34, 32);
    view.defPosition("k2f", 77, 50, 34, 32);
    view.defPosition("k2g", 77, 58, 34, 32);
    view.defPosition("k2h", 77, 66, 34, 32);
    view.defPosition("k2i", 77, 74, 34, 32);
    view.defPosition("k2j", 77, 82, 34, 32);
    view.defPosition("k2k", 77, 90, 34, 32);
    view.defPosition("k2l", 77, 98, 34, 32);
    view.defPosition("k2m", 77, 106, 34, 32);
    view.defPosition("k2n", 77, 114, 34, 32);
    view.defPosition("k2o", 77, 122, 34, 32);
    view.defPosition("k2p", 77, 130, 34, 32);
    view.defPosition("k2q", 77, 138, 34, 32);
    view.defPosition("j2a", 111, 10, 34, 32);
    view.defPosition("j2b", 111, 18, 34, 32);
    view.defPosition("j2c", 111, 26, 34, 32);
    view.defPosition("j2d", 111, 34, 34, 32);
    view.defPosition("j2e", 111, 42, 34, 32);
    view.defPosition("j2f", 111, 50, 34, 32);
    view.defPosition("j2g", 111, 58, 34, 32);
    view.defPosition("j2h", 111, 66, 34, 32);
    view.defPosition("j2i", 111, 74, 34, 32);
    view.defPosition("j2j", 111, 82, 34, 32);
    view.defPosition("j2k", 111, 90, 34, 32);
    view.defPosition("j2l", 111, 98, 34, 32);
    view.defPosition("j2m", 111, 106, 34, 32);
    view.defPosition("j2n", 111, 114, 34, 32);
    view.defPosition("j2o", 111, 122, 34, 32);
    view.defPosition("j2p", 111, 130, 34, 32);
    view.defPosition("j2q", 111, 138, 34, 32);
    view.defPosition("h2a", 145, 10, 34, 32);
    view.defPosition("h2b", 145, 18, 34, 32);
    view.defPosition("h2c", 145, 26, 34, 32);
    view.defPosition("h2d", 145, 34, 34, 32);
    view.defPosition("h2e", 145, 42, 34, 32);
    view.defPosition("h2f", 145, 50, 34, 32);
    view.defPosition("h2g", 145, 58, 34, 32);
    view.defPosition("h2h", 145, 66, 34, 32);
    view.defPosition("h2i", 145, 74, 34, 32);
    view.defPosition("h2j", 145, 82, 34, 32);
    view.defPosition("h2k", 145, 90, 34, 32);
    view.defPosition("h2l", 145, 98, 34, 32);
    view.defPosition("h2m", 145, 106, 34, 32);
    view.defPosition("h2n", 145, 114, 34, 32);
    view.defPosition("h2o", 145, 122, 34, 32);
    view.defPosition("h2p", 145, 130, 34, 32);
    view.defPosition("h2q", 145, 138, 34, 32);
    view.defPosition("g2a", 179, 10, 34, 32);
    view.defPosition("g2b", 179, 18, 34, 32);
    view.defPosition("g2c", 179, 26, 34, 32);
    view.defPosition("g2d", 179, 34, 34, 32);
    view.defPosition("g2e", 179, 42, 34, 32);
    view.defPosition("g2f", 179, 50, 34, 32);
    view.defPosition("g2g", 179, 58, 34, 32);
    view.defPosition("g2h", 179, 66, 34, 32);
    view.defPosition("g2i", 179, 74, 34, 32);
    view.defPosition("g2j", 179, 82, 34, 32);
    view.defPosition("g2k", 179, 90, 34, 32);
    view.defPosition("g2l", 179, 98, 34, 32);
    view.defPosition("g2m", 179, 106, 34, 32);
    view.defPosition("g2n", 179, 114, 34, 32);
    view.defPosition("g2o", 179, 122, 34, 32);
    view.defPosition("g2p", 179, 130, 34, 32);
    view.defPosition("g2q", 179, 138, 34, 32);
    view.defPosition("f2a", 237, 10, 34, 32);
    view.defPosition("f2b", 237, 18, 34, 32);
    view.defPosition("f2c", 237, 26, 34, 32);
    view.defPosition("f2d", 237, 34, 34, 32);
    view.defPosition("f2e", 237, 42, 34, 32);
    view.defPosition("f2f", 237, 50, 34, 32);
    view.defPosition("f2g", 237, 58, 34, 32);
    view.defPosition("f2h", 237, 66, 34, 32);
    view.defPosition("f2i", 237, 74, 34, 32);
    view.defPosition("f2j", 237, 82, 34, 32);
    view.defPosition("f2k", 237, 90, 34, 32);
    view.defPosition("f2l", 237, 98, 34, 32);
    view.defPosition("f2m", 237, 106, 34, 32);
    view.defPosition("f2n", 237, 114, 34, 32);
    view.defPosition("f2o", 237, 122, 34, 32);
    view.defPosition("f2p", 237, 130, 34, 32);
    view.defPosition("f2q", 237, 138, 34, 32);
    view.defPosition("e2a", 271, 10, 34, 32);
    view.defPosition("e2b", 271, 18, 34, 32);
    view.defPosition("e2c", 271, 26, 34, 32);
    view.defPosition("e2d", 271, 34, 34, 32);
    view.defPosition("e2e", 271, 42, 34, 32);
    view.defPosition("e2f", 271, 50, 34, 32);
    view.defPosition("e2g", 271, 58, 34, 32);
    view.defPosition("e2h", 271, 66, 34, 32);
    view.defPosition("e2i", 271, 74, 34, 32);
    view.defPosition("e2j", 271, 82, 34, 32);
    view.defPosition("e2k", 271, 90, 34, 32);
    view.defPosition("e2l", 271, 98, 34, 32);
    view.defPosition("e2m", 271, 106, 34, 32);
    view.defPosition("e2n", 271, 114, 34, 32);
    view.defPosition("e2o", 271, 122, 34, 32);
    view.defPosition("e2p", 271, 130, 34, 32);
    view.defPosition("e2q", 271, 138, 34, 32);
    view.defPosition("d2a", 305, 10, 34, 32);
    view.defPosition("d2b", 305, 18, 34, 32);
    view.defPosition("d2c", 305, 26, 34, 32);
    view.defPosition("d2d", 305, 34, 34, 32);
    view.defPosition("d2e", 305, 42, 34, 32);
    view.defPosition("d2f", 305, 50, 34, 32);
    view.defPosition("d2g", 305, 58, 34, 32);
    view.defPosition("d2h", 305, 66, 34, 32);
    view.defPosition("d2i", 305, 74, 34, 32);
    view.defPosition("d2j", 305, 82, 34, 32);
    view.defPosition("d2k", 305, 90, 34, 32);
    view.defPosition("d2l", 305, 98, 34, 32);
    view.defPosition("d2m", 305, 106, 34, 32);
    view.defPosition("d2n", 305, 114, 34, 32);
    view.defPosition("d2o", 305, 122, 34, 32);
    view.defPosition("d2p", 305, 130, 34, 32);
    view.defPosition("d2q", 305, 138, 34, 32);
    view.defPosition("c2a", 339, 10, 34, 32);
    view.defPosition("c2b", 339, 18, 34, 32);
    view.defPosition("c2c", 339, 26, 34, 32);
    view.defPosition("c2d", 339, 34, 34, 32);
    view.defPosition("c2e", 339, 42, 34, 32);
    view.defPosition("c2f", 339, 50, 34, 32);
    view.defPosition("c2g", 339, 58, 34, 32);
    view.defPosition("c2h", 339, 66, 34, 32);
    view.defPosition("c2i", 339, 74, 34, 32);
    view.defPosition("c2j", 339, 82, 34, 32);
    view.defPosition("c2k", 339, 90, 34, 32);
    view.defPosition("c2l", 339, 98, 34, 32);
    view.defPosition("c2m", 339, 106, 34, 32);
    view.defPosition("c2n", 339, 114, 34, 32);
    view.defPosition("c2o", 339, 122, 34, 32);
    view.defPosition("c2p", 339, 130, 34, 32);
    view.defPosition("c2q", 339, 138, 34, 32);
    view.defPosition("b2a", 373, 10, 34, 32);
    view.defPosition("b2b", 373, 18, 34, 32);
    view.defPosition("b2c", 373, 26, 34, 32);
    view.defPosition("b2d", 373, 34, 34, 32);
    view.defPosition("b2e", 373, 42, 34, 32);
    view.defPosition("b2f", 373, 50, 34, 32);
    view.defPosition("b2g", 373, 58, 34, 32);
    view.defPosition("b2h", 373, 66, 34, 32);
    view.defPosition("b2i", 373, 74, 34, 32);
    view.defPosition("b2j", 373, 82, 34, 32);
    view.defPosition("b2k", 373, 90, 34, 32);
    view.defPosition("b2l", 373, 98, 34, 32);
    view.defPosition("b2m", 373, 106, 34, 32);
    view.defPosition("b2n", 373, 114, 34, 32);
    view.defPosition("b2o", 373, 122, 34, 32);
    view.defPosition("b2p", 373, 130, 34, 32);
    view.defPosition("b2q", 373, 138, 34, 32);
    view.defPosition("a2a", 407, 10, 34, 32);
    view.defPosition("a2b", 407, 18, 34, 32);
    view.defPosition("a2c", 407, 26, 34, 32);
    view.defPosition("a2d", 407, 34, 34, 32);
    view.defPosition("a2e", 407, 42, 34, 32);
    view.defPosition("a2f", 407, 50, 34, 32);
    view.defPosition("a2g", 407, 58, 34, 32);
    view.defPosition("a2h", 407, 66, 34, 32);
    view.defPosition("a2i", 407, 74, 34, 32);
    view.defPosition("a2j", 407, 82, 34, 32);
    view.defPosition("a2k", 407, 90, 34, 32);
    view.defPosition("a2l", 407, 98, 34, 32);
    view.defPosition("a2m", 407, 106, 34, 32);
    view.defPosition("a2n", 407, 114, 34, 32);
    view.defPosition("a2o", 407, 122, 34, 32);
    view.defPosition("a2p", 407, 130, 34, 32);
    view.defPosition("a2q", 407, 138, 34, 32);
    view.defPosition("H2a", 456, 308, 40, 32);
    view.defPosition("H2b", 456, 300, 40, 32);
    view.defPosition("H2c", 456, 292, 40, 32);
    view.defPosition("H2d", 456, 284, 40, 32);
    view.defPosition("H2e", 456, 276, 40, 32);
    view.defPosition("H2f", 456, 268, 40, 32);
    view.defPosition("H2g", 456, 260, 40, 32);
    view.defPosition("H2h", 456, 252, 40, 32);
    view.defPosition("H2i", 456, 244, 40, 32);
    view.defPosition("H2j", 456, 236, 40, 32);
    view.defPosition("H2k", 456, 228, 40, 32);
    view.defPosition("H2l", 456, 220, 40, 32);
    view.defPosition("H2m", 456, 212, 40, 32);
    view.defPosition("H2n", 456, 204, 40, 32);
    view.defPosition("H2o", 456, 196, 40, 32);
    view.defPosition("H2p", 456, 188, 40, 32);
    view.defPosition("H2q", 456, 180, 40, 32);
    view.defPosition("H1a", 456, 10, 40, 32);
    view.defPosition("H1b", 456, 18, 40, 32);
    view.defPosition("H1c", 456, 26, 40, 32);
    view.defPosition("H1d", 456, 34, 40, 32);
    view.defPosition("H1e", 456, 42, 40, 32);
    view.defPosition("H1f", 456, 50, 40, 32);
    view.defPosition("H1g", 456, 58, 40, 32);
    view.defPosition("H1h", 456, 66, 40, 32);
    view.defPosition("H1i", 456, 74, 40, 32);
    view.defPosition("H1j", 456, 82, 40, 32);
    view.defPosition("H1k", 456, 90, 40, 32);
    view.defPosition("H1l", 456, 98, 40, 32);
    view.defPosition("H1m", 456, 106, 40, 32);
    view.defPosition("H1n", 456, 114, 40, 32);
    view.defPosition("H1o", 456, 122, 40, 32);
    view.defPosition("H1p", 456, 130, 40, 32);
    view.defPosition("H1q", 456, 138, 40, 32);
    ...
    view.defPosition("D1", 339, 160, 34, 29);
    view.defPosition("D2", 305, 160, 34, 29);
    view.defPosition("D3", 111, 160, 34, 29);
    view.defPosition("D4", 77, 160, 34, 29);
}
