...
//  design.checkVersion("pass-turn", "forced");
    ...
    design.reserve("Red", "Soldier", 0);
    design.reserve("Red", "Horse", 2);
    design.reserve("Red", "Elephant", 2);
    design.reserve("Red", "Chariot", 0);
    design.reserve("Red", "Mandarin", 0);
    design.reserve("Red", "Cannon", 0);
    design.reserve("Red", "General", 0);
    ...
    design.reserve("Black", "Soldier", 0);
    design.reserve("Black", "Horse", 2);
    design.reserve("Black", "Elephant", 2);
    design.reserve("Black", "Chariot", 0);
    design.reserve("Black", "Mandarin", 0);
    design.reserve("Black", "Cannon", 0);
    design.reserve("Black", "General", 0);
