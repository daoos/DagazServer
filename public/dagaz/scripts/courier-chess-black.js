...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Pawn", 79, 1);
    design.setup("White", "Pawn", 80, 1);
    design.setup("White", "Pawn", 81, 1);
    design.setup("White", "Pawn", 82, 1);
    design.setup("White", "Pawn", 83, 1);
    design.setup("White", "Rook", 84, 1);
    design.setup("White", "Rook", 95, 1);
    design.setup("White", "Knight", 85, 1);
    design.setup("White", "Knight", 94, 1);
    design.setup("White", "Bishop", 86, 1);
    design.setup("White", "Bishop", 93, 1);
    design.setup("White", "Courier", 87, 1);
    design.setup("White", "Courier", 92, 1);
    design.setup("White", "Man", 88, 1);
    design.setup("White", "Fool", 91, 1);
    design.setup("White", "King", 89, 1);
    design.setup("White", "Queen", 90, 1);
    ...
    design.setup("Black", "Rook", 11, 1);
    design.setup("Black", "Knight", 1, 1);
    design.setup("Black", "Knight", 10, 1);
    design.setup("Black", "Bishop", 2, 1);
    design.setup("Black", "Bishop", 9, 1);
    design.setup("Black", "Courier", 3, 1);
    design.setup("Black", "Courier", 8, 1);
    design.setup("Black", "Man", 4, 1);
    design.setup("Black", "Fool", 7, 1);
    design.setup("Black", "King", 5, 1);
    design.setup("Black", "Queen", 6, 1);

    design.setup("White", "Pawn", 48, 2);
    design.setup("White", "Pawn", 73, 2);
    design.setup("White", "Pawn", 74, 2);
    design.setup("White", "Pawn", 75, 2);
    design.setup("White", "Pawn", 76, 2);
    design.setup("White", "Pawn", 77, 2);
    design.setup("White", "Pawn", 54, 2);
    design.setup("White", "Pawn", 79, 2);
    design.setup("White", "Pawn", 80, 2);
    design.setup("White", "Pawn", 81, 2);
    design.setup("White", "Pawn", 82, 2);
    design.setup("White", "Pawn", 59, 2);
    design.setup("White", "Rook", 84, 2);
    design.setup("White", "Rook", 95, 2);
    design.setup("White", "Knight", 85, 2);
    design.setup("White", "Knight", 94, 2);
    design.setup("White", "Bishop", 86, 2);
    design.setup("White", "Bishop", 93, 2);
    design.setup("White", "Courier", 87, 2);
    design.setup("White", "Courier", 92, 2);
    design.setup("White", "Man", 88, 2);
    design.setup("White", "Fool", 91, 2);
    design.setup("White", "King", 89, 2);
    design.setup("White", "Queen", 66, 2);
    design.setup("Black", "Pawn", 36, 2);
    ...
    design.setup("Black", "Pawn", 42, 2);
    design.setup("Black", "Pawn", 19, 2);
    design.setup("Black", "Pawn", 20, 2);
    design.setup("Black", "Pawn", 21, 2);
    design.setup("Black", "Pawn", 22, 2);
    design.setup("Black", "Pawn", 47, 2);
    design.setup("Black", "Rook", 0, 2);
    design.setup("Black", "Rook", 11, 2);
    design.setup("Black", "Knight", 1, 2);
    design.setup("Black", "Knight", 10, 2);
    design.setup("Black", "Bishop", 2, 2);
    design.setup("Black", "Bishop", 9, 2);
    design.setup("Black", "Courier", 3, 2);
    design.setup("Black", "Courier", 8, 2);
    design.setup("Black", "Man", 4, 2);
    design.setup("Black", "Fool", 7, 2);
    design.setup("Black", "King", 5, 2);
    design.setup("Black", "Queen", 30, 2);
}
