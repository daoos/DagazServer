...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 561, 1097, 59, 59);
    view.defPosition("b9", 427, 1097, 59, 59);
    view.defPosition("c9", 293, 1097, 59, 59);
    view.defPosition("d9", 159, 1097, 59, 59);
    view.defPosition("e9", 25, 1097, 59, 59);
    view.defPosition("a8", 561, 963, 59, 59);
    view.defPosition("b8", 427, 963, 59, 59);
    view.defPosition("c8", 293, 963, 59, 59);
    view.defPosition("d8", 159, 963, 59, 59);
    view.defPosition("e8", 25, 963, 59, 59);
    view.defPosition("a7", 561, 829, 59, 59);
    view.defPosition("b7", 427, 829, 59, 59);
    view.defPosition("c7", 293, 829, 59, 59);
    view.defPosition("d7", 159, 829, 59, 59);
    view.defPosition("e7", 25, 829, 59, 59);
    view.defPosition("a6", 561, 695, 59, 59);
    view.defPosition("b6", 427, 695, 59, 59);
    view.defPosition("c6", 293, 695, 59, 59);
    view.defPosition("d6", 159, 695, 59, 59);
    view.defPosition("e6", 25, 695, 59, 59);
    view.defPosition("a5", 561, 561, 59, 59);
    view.defPosition("b5", 427, 561, 59, 59);
    view.defPosition("c5", 293, 561, 59, 59);
    view.defPosition("d5", 159, 561, 59, 59);
    view.defPosition("e5", 25, 561, 59, 59);
    view.defPosition("a4", 561, 427, 59, 59);
    view.defPosition("b4", 427, 427, 59, 59);
    view.defPosition("c4", 293, 427, 59, 59);
    view.defPosition("d4", 159, 427, 59, 59);
    view.defPosition("e4", 25, 427, 59, 59);
    view.defPosition("a3", 561, 293, 59, 59);
    view.defPosition("b3", 427, 293, 59, 59);
    view.defPosition("c3", 293, 293, 59, 59);
    view.defPosition("d3", 159, 293, 59, 59);
    view.defPosition("e3", 25, 293, 59, 59);
    view.defPosition("a2", 561, 159, 59, 59);
    view.defPosition("b2", 427, 159, 59, 59);
    view.defPosition("c2", 293, 159, 59, 59);
    view.defPosition("d2", 159, 159, 59, 59);
    view.defPosition("e2", 25, 159, 59, 59);
    view.defPosition("a1", 561, 25, 59, 59);
    view.defPosition("b1", 427, 25, 59, 59);
    view.defPosition("c1", 293, 25, 59, 59);
    view.defPosition("d1", 159, 25, 59, 59);
    view.defPosition("e1", 25, 25, 59, 59);
}
