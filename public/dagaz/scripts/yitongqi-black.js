...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(4, ZRF.IN_ZONE,	2);	// enemy
    design.addCommand(4, ZRF.FUNCTION,	20);	// verify
    ...
    design.addCommand(5, ZRF.FUNCTION,	20);	// verify
    design.addCommand(5, ZRF.IN_ZONE,	1);	// home
    design.addCommand(5, ZRF.FUNCTION,	20);	// verify
    ...
    design.addCommand(7, ZRF.IN_ZONE,	0);	// fortress
    design.addCommand(7, ZRF.FUNCTION,	20);	// verify
    design.addCommand(7, ZRF.FUNCTION,	25);	// to
    design.addCommand(7, ZRF.FUNCTION,	28);	// end

    design.addPiece("Manchu", 0, 20);
    design.addMove(0, 0, [7, 7], 0);
    design.addMove(0, 0, [1, 1], 0);
    design.addMove(0, 0, [4, 4], 0);
    design.addMove(0, 0, [3, 3], 0);
    design.addMove(0, 1, [7, 6], 0);
    design.addMove(0, 1, [7, 5], 0);
    design.addMove(0, 1, [1, 2], 0);
    design.addMove(0, 1, [1, 0], 0);
    design.addMove(0, 1, [4, 6], 0);
    design.addMove(0, 1, [3, 5], 0);
    design.addMove(0, 1, [4, 2], 0);
    design.addMove(0, 1, [3, 0], 0);
    ...
    design.addMove(2, 1, [7, 6], 0);
    design.addMove(2, 1, [7, 5], 0);
    design.addMove(2, 1, [1, 2], 0);
    design.addMove(2, 1, [1, 0], 0);
    design.addMove(2, 1, [4, 6], 0);
    design.addMove(2, 1, [3, 5], 0);
    design.addMove(2, 1, [4, 2], 0);
    design.addMove(2, 1, [3, 0], 0);
...
Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("RedManchu", "Red Manchu");
    view.defPiece("BlackManchu", "Black Manchu");
    ...
    view.defPosition("a10", 364, 410, 42, 42);
    view.defPosition("b10", 319, 410, 42, 42);
    view.defPosition("c10", 274, 410, 42, 42);
    view.defPosition("d10", 229, 410, 42, 42);
    view.defPosition("e10", 184, 410, 42, 42);
    view.defPosition("f10", 139, 410, 42, 42);
    view.defPosition("g10", 94, 410, 42, 42);
    view.defPosition("h10", 49, 410, 42, 42);
    view.defPosition("i10", 4, 410, 42, 42);
    view.defPosition("a9", 364, 365, 42, 42);
    view.defPosition("b9", 319, 365, 42, 42);
    view.defPosition("c9", 274, 365, 42, 42);
    view.defPosition("d9", 229, 365, 42, 42);
    view.defPosition("e9", 184, 365, 42, 42);
    view.defPosition("f9", 139, 365, 42, 42);
    view.defPosition("g9", 94, 365, 42, 42);
    view.defPosition("h9", 49, 365, 42, 42);
    view.defPosition("i9", 4, 365, 42, 42);
    view.defPosition("a8", 364, 320, 42, 42);
    view.defPosition("b8", 319, 320, 42, 42);
    view.defPosition("c8", 274, 320, 42, 42);
    view.defPosition("d8", 229, 320, 42, 42);
    view.defPosition("e8", 184, 320, 42, 42);
    view.defPosition("f8", 139, 320, 42, 42);
    view.defPosition("g8", 94, 320, 42, 42);
    view.defPosition("h8", 49, 320, 42, 42);
    view.defPosition("i8", 4, 320, 42, 42);
    view.defPosition("a7", 364, 275, 42, 42);
    view.defPosition("b7", 319, 275, 42, 42);
    view.defPosition("c7", 274, 275, 42, 42);
    view.defPosition("d7", 229, 275, 42, 42);
    view.defPosition("e7", 184, 275, 42, 42);
    view.defPosition("f7", 139, 275, 42, 42);
    view.defPosition("g7", 94, 275, 42, 42);
    view.defPosition("h7", 49, 275, 42, 42);
    view.defPosition("i7", 4, 275, 42, 42);
    view.defPosition("a6", 364, 230, 42, 42);
    view.defPosition("b6", 319, 230, 42, 42);
    view.defPosition("c6", 274, 230, 42, 42);
    view.defPosition("d6", 229, 230, 42, 42);
    view.defPosition("e6", 184, 230, 42, 42);
    view.defPosition("f6", 139, 230, 42, 42);
    view.defPosition("g6", 94, 230, 42, 42);
    view.defPosition("h6", 49, 230, 42, 42);
    view.defPosition("i6", 4, 230, 42, 42);
    view.defPosition("a5", 364, 185, 42, 42);
    view.defPosition("b5", 319, 185, 42, 42);
    view.defPosition("c5", 274, 185, 42, 42);
    view.defPosition("d5", 229, 185, 42, 42);
    view.defPosition("e5", 184, 185, 42, 42);
    view.defPosition("f5", 139, 185, 42, 42);
    view.defPosition("g5", 94, 185, 42, 42);
    view.defPosition("h5", 49, 185, 42, 42);
    view.defPosition("i5", 4, 185, 42, 42);
    view.defPosition("a4", 364, 140, 42, 42);
    view.defPosition("b4", 319, 140, 42, 42);
    view.defPosition("c4", 274, 140, 42, 42);
    view.defPosition("d4", 229, 140, 42, 42);
    view.defPosition("e4", 184, 140, 42, 42);
    view.defPosition("f4", 139, 140, 42, 42);
    view.defPosition("g4", 94, 140, 42, 42);
    view.defPosition("h4", 49, 140, 42, 42);
    view.defPosition("i4", 4, 140, 42, 42);
    view.defPosition("a3", 364, 95, 42, 42);
    view.defPosition("b3", 319, 95, 42, 42);
    view.defPosition("c3", 274, 95, 42, 42);
    view.defPosition("d3", 229, 95, 42, 42);
    view.defPosition("e3", 184, 95, 42, 42);
    view.defPosition("f3", 139, 95, 42, 42);
    view.defPosition("g3", 94, 95, 42, 42);
    view.defPosition("h3", 49, 95, 42, 42);
    view.defPosition("i3", 4, 95, 42, 42);
    view.defPosition("a2", 364, 50, 42, 42);
    view.defPosition("b2", 319, 50, 42, 42);
    view.defPosition("c2", 274, 50, 42, 42);
    view.defPosition("d2", 229, 50, 42, 42);
    view.defPosition("e2", 184, 50, 42, 42);
    view.defPosition("f2", 139, 50, 42, 42);
    view.defPosition("g2", 94, 50, 42, 42);
    view.defPosition("h2", 49, 50, 42, 42);
    view.defPosition("i2", 4, 50, 42, 42);
    view.defPosition("a1", 364, 5, 42, 42);
    view.defPosition("b1", 319, 5, 42, 42);
    view.defPosition("c1", 274, 5, 42, 42);
    view.defPosition("d1", 229, 5, 42, 42);
    view.defPosition("e1", 184, 5, 42, 42);
    view.defPosition("f1", 139, 5, 42, 42);
    view.defPosition("g1", 94, 5, 42, 42);
    view.defPosition("h1", 49, 5, 42, 42);
    view.defPosition("i1", 4, 5, 42, 42);
}
