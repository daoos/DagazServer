...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Pawn", 15, 1);
    design.setup("White", "Pawn", 16, 1);
    design.setup("White", "Pawn", 17, 1);
    design.setup("White", "Pawn", 18, 1);
    design.setup("White", "Pawn", 19, 1);
    design.setup("White", "Rook", 20, 1);
    design.setup("White", "Knight", 21, 1);
    design.setup("White", "Bishop", 22, 1);
    design.setup("White", "Queen", 23, 1);
    design.setup("White", "King", 24, 1);
    ...
    design.setup("White", "Pawn", 15, 2);
    design.setup("White", "Pawn", 16, 2);
    design.setup("White", "Pawn", 17, 2);
    design.setup("White", "Pawn", 18, 2);
    design.setup("White", "Pawn", 19, 2);
    design.setup("White", "Rook", 20, 2);
    design.setup("White", "Knight", 21, 2);
    design.setup("White", "Bishop", 22, 2);
    design.setup("White", "Queen", 23, 2);
    design.setup("White", "King", 24, 2);
    ...
    design.setup("Black", "Rook", 4, 2);
    design.setup("Black", "Knight", 3, 2);
    design.setup("Black", "Bishop", 2, 2);
    design.setup("Black", "Queen", 1, 2);
    design.setup("Black", "King", 0, 2);

    design.setup("White", "Pawn", 15, 3);
    design.setup("White", "Pawn", 16, 3);
    design.setup("White", "Pawn", 17, 3);
    design.setup("White", "Pawn", 18, 3);
    design.setup("White", "Pawn", 19, 3);
    design.setup("White", "Rook", 22, 3);
    design.setup("White", "Knight", 23, 3);
    design.setup("White", "Bishop", 24, 3);
    design.setup("White", "Queen", 21, 3);
    design.setup("White", "King", 20, 3);
    ...
    design.setup("Black", "Rook", 2, 3);
    design.setup("Black", "Knight", 1, 3);
    design.setup("Black", "Bishop", 0, 3);
    design.setup("Black", "Queen", 3, 3);
    design.setup("Black", "King", 4, 3);

    design.setup("White", "Pawn", 15, 4);
    design.setup("White", "Pawn", 16, 4);
    design.setup("White", "Pawn", 17, 4);
    design.setup("White", "Pawn", 18, 4);
    design.setup("White", "Pawn", 19, 4);
    design.setup("White", "Rook", 20, 4);
    design.setup("White", "Knight", 21, 4);
    design.setup("White", "Knight", 24, 4);
    design.setup("White", "Queen", 23, 4);
    design.setup("White", "King", 22, 4);
    ...
    design.setup("Black", "Rook", 0, 4);
    design.setup("Black", "Bishop", 1, 4);
    design.setup("Black", "Bishop", 4, 4);
    design.setup("Black", "Queen", 3, 4);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a5", 274, 274, 68, 68);
    view.defPosition("b5", 206, 274, 68, 68);
    view.defPosition("c5", 138, 274, 68, 68);
    view.defPosition("d5", 70, 274, 68, 68);
    view.defPosition("e5", 2, 274, 68, 68);
    view.defPosition("a4", 274, 206, 68, 68);
    view.defPosition("b4", 206, 206, 68, 68);
    view.defPosition("c4", 138, 206, 68, 68);
    view.defPosition("d4", 70, 206, 68, 68);
    view.defPosition("e4", 2, 206, 68, 68);
    view.defPosition("a3", 274, 138, 68, 68);
    view.defPosition("b3", 206, 138, 68, 68);
    view.defPosition("c3", 138, 138, 68, 68);
    view.defPosition("d3", 70, 138, 68, 68);
    view.defPosition("e3", 2, 138, 68, 68);
    view.defPosition("a2", 274, 70, 68, 68);
    view.defPosition("b2", 206, 70, 68, 68);
    view.defPosition("c2", 138, 70, 68, 68);
    view.defPosition("d2", 70, 70, 68, 68);
    view.defPosition("e2", 2, 70, 68, 68);
    view.defPosition("a1", 274, 2, 68, 68);
    view.defPosition("b1", 206, 2, 68, 68);
    view.defPosition("c1", 138, 2, 68, 68);
    view.defPosition("d1", 70, 2, 68, 68);
    view.defPosition("e1", 2, 2, 68, 68);
