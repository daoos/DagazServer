...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a13", 533, 533, 59, 59);
    view.defPosition("b13", 445, 533, 59, 59);
    view.defPosition("c13", 357, 533, 59, 59);
    view.defPosition("d13", 269, 533, 59, 59);
    view.defPosition("e13", 181, 533, 59, 59);
    view.defPosition("f13", 93, 533, 59, 59);
    view.defPosition("g13", 5, 533, 59, 59);
    view.defPosition("a11", 533, 445, 59, 59);
    view.defPosition("b11", 445, 445, 59, 59);
    view.defPosition("c11", 357, 445, 59, 59);
    view.defPosition("d11", 269, 445, 59, 59);
    view.defPosition("e11", 181, 445, 59, 59);
    view.defPosition("f11", 93, 445, 59, 59);
    view.defPosition("g11", 5, 445, 59, 59);
    view.defPosition("a9", 533, 357, 59, 59);
    view.defPosition("b9", 445, 357, 59, 59);
    view.defPosition("c9", 357, 357, 59, 59);
    view.defPosition("d9", 269, 357, 59, 59);
    view.defPosition("e9", 181, 357, 59, 59);
    view.defPosition("f9", 93, 357, 59, 59);
    view.defPosition("g9", 5, 357, 59, 59);
    view.defPosition("a7", 533, 269, 59, 59);
    view.defPosition("b7", 445, 269, 59, 59);
    view.defPosition("c7", 357, 269, 59, 59);
    view.defPosition("d7", 269, 269, 59, 59);
    view.defPosition("e7", 181, 269, 59, 59);
    view.defPosition("f7", 93, 269, 59, 59);
    view.defPosition("g7", 5, 269, 59, 59);
    view.defPosition("a5", 533, 181, 59, 59);
    view.defPosition("b5", 445, 181, 59, 59);
    view.defPosition("c5", 357, 181, 59, 59);
    view.defPosition("d5", 269, 181, 59, 59);
    view.defPosition("e5", 181, 181, 59, 59);
    view.defPosition("f5", 93, 181, 59, 59);
    view.defPosition("g5", 5, 181, 59, 59);
    view.defPosition("a3", 533, 93, 59, 59);
    view.defPosition("b3", 445, 93, 59, 59);
    view.defPosition("c3", 357, 93, 59, 59);
    view.defPosition("d3", 269, 93, 59, 59);
    view.defPosition("e3", 181, 93, 59, 59);
    view.defPosition("f3", 93, 93, 59, 59);
    view.defPosition("g3", 5, 93, 59, 59);
    view.defPosition("a1", 533, 5, 59, 59);
    view.defPosition("b1", 445, 5, 59, 59);
    view.defPosition("c1", 357, 5, 59, 59);
    view.defPosition("d1", 269, 5, 59, 59);
    view.defPosition("e1", 181, 5, 59, 59);
    view.defPosition("f1", 93, 5, 59, 59);
    view.defPosition("g1", 5, 5, 59, 59);
    view.defPosition("a12", 488, 488, 59, 59);
    view.defPosition("b12", 400, 488, 59, 59);
    view.defPosition("c12", 312, 488, 59, 59);
    view.defPosition("d12", 224, 488, 59, 59);
    view.defPosition("e12", 136, 488, 59, 59);
    view.defPosition("f12", 48, 488, 59, 59);
    view.defPosition("a10", 488, 400, 59, 59);
    view.defPosition("b10", 400, 400, 59, 59);
    view.defPosition("c10", 312, 400, 59, 59);
    view.defPosition("d10", 224, 400, 59, 59);
    view.defPosition("e10", 136, 400, 59, 59);
    view.defPosition("f10", 48, 400, 59, 59);
    view.defPosition("a8", 488, 312, 59, 59);
    view.defPosition("b8", 400, 312, 59, 59);
    view.defPosition("c8", 312, 312, 59, 59);
    view.defPosition("d8", 224, 312, 59, 59);
    view.defPosition("e8", 136, 312, 59, 59);
    view.defPosition("f8", 48, 312, 59, 59);
    view.defPosition("a6", 488, 224, 59, 59);
    view.defPosition("b6", 400, 224, 59, 59);
    view.defPosition("c6", 312, 224, 59, 59);
    view.defPosition("d6", 224, 224, 59, 59);
    view.defPosition("e6", 136, 224, 59, 59);
    view.defPosition("f6", 48, 224, 59, 59);
    view.defPosition("a4", 488, 136, 59, 59);
    view.defPosition("b4", 400, 136, 59, 59);
    view.defPosition("c4", 312, 136, 59, 59);
    view.defPosition("d4", 224, 136, 59, 59);
    view.defPosition("e4", 136, 136, 59, 59);
    view.defPosition("f4", 48, 136, 59, 59);
    view.defPosition("a2", 488, 48, 59, 59);
    view.defPosition("b2", 400, 48, 59, 59);
    view.defPosition("c2", 312, 48, 59, 59);
    view.defPosition("d2", 224, 48, 59, 59);
    view.defPosition("e2", 136, 48, 59, 59);
    view.defPosition("f2", 48, 48, 59, 59);
}
