...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(2, 3, [4, 4], 0, 12);
    design.addMove(2, 3, [2, 2], 0, 12);
    design.addMove(2, 3, [0, 0], 0, 12);
    design.addMove(2, 3, [1, 1], 0, 12);

    design.addPiece("Knight", 3, 330);
    design.addMove(3, 4, [4, 7], 0, 13);
    design.addMove(3, 4, [4, 3], 0, 13);
    design.addMove(3, 4, [2, 6], 0, 13);
    design.addMove(3, 4, [2, 5], 0, 13);
    design.addMove(3, 4, [0, 7], 0, 13);
    design.addMove(3, 4, [0, 6], 0, 13);
    design.addMove(3, 4, [1, 3], 0, 13);
    design.addMove(3, 4, [1, 5], 0, 13);

    design.addPiece("Bishop", 4);
    design.addMove(4, 3, [7, 7], 0, 14);
    design.addMove(4, 3, [6, 6], 0, 14);
    design.addMove(4, 3, [3, 3], 0, 14);
    design.addMove(4, 3, [5, 5], 0, 14);

    design.addPiece("Queen", 5, 900);
    design.addMove(5, 3, [4, 4], 0, 15);
    design.addMove(5, 3, [2, 2], 0, 15);
    design.addMove(5, 3, [0, 0], 0, 15);
    design.addMove(5, 3, [1, 1], 0, 15);
    design.addMove(5, 3, [7, 7], 0, 15);
    design.addMove(5, 3, [6, 6], 0, 15);
    design.addMove(5, 3, [3, 3], 0, 15);
    design.addMove(5, 3, [5, 5], 0, 15);
