...
Dagaz.View.configure = function(view) {
    view.defBoard("SBoard", 0, 0, undefined, [1, 2, 3, 4]);
    view.defBoard("NBoard", 0, 0, undefined, [0, 5, 6, 7, 8]);
    ...
    view.defPosition("a40", 67, 330, 29, 29);
    view.defPosition("b40", 134, 330, 29, 29);
    view.defPosition("c40", 201, 330, 29, 29);
    view.defPosition("d40", 268, 330, 29, 29);
    view.defPosition("e40", 335, 330, 29, 29);
    view.defPosition("f40", 402, 330, 29, 29);
    view.defPosition("g40", 469, 330, 29, 29);
    view.defPosition("a30", 67, 255, 29, 29);
    view.defPosition("b30", 134, 255, 29, 29);
    view.defPosition("b31", 131, 252, 29, 29);
    view.defPosition("b32", 128, 249, 29, 29);
    view.defPosition("b33", 125, 246, 29, 29);
    view.defPosition("c30", 200, 255, 29, 29);
    view.defPosition("d30", 268, 255, 29, 29);
    view.defPosition("d31", 265, 252, 29, 29);
    view.defPosition("d32", 262, 249, 29, 29);
    view.defPosition("d33", 259, 246, 29, 29);
    view.defPosition("g30", 470, 255, 29, 29);
    view.defPosition("h30", 536, 255, 29, 29);
    ...
    view.defPosition("a10", 67, 115, 29, 29);
    view.defPosition("b10", 135, 115, 29, 29);
    view.defPosition("b11", 132, 112, 29, 29);
    view.defPosition("b12", 129, 109, 29, 29);
    view.defPosition("b13", 126, 106, 29, 29);
    view.defPosition("c10", 201, 115, 29, 29);
    view.defPosition("d10", 269, 115, 29, 29);
    view.defPosition("d11", 266, 112, 29, 29);
    view.defPosition("d12", 263, 109, 29, 29);
    view.defPosition("d13", 260, 106, 29, 29);
    view.defPosition("g10", 470, 115, 29, 29);
    view.defPosition("h10", 536, 115, 29, 29);
    view.defPosition("a00", 67, 38, 29, 29);
    view.defPosition("b00", 134, 38, 29, 29);
    view.defPosition("c00", 201, 38, 29, 29);
    view.defPosition("d00", 268, 38, 29, 29);
    view.defPosition("e00", 335, 38, 29, 29);
    view.defPosition("f00", 402, 38, 29, 29);
    view.defPosition("g00", 469, 38, 29, 29);
    view.defPosition("a3h", 67, 253, 29, 29);
    view.defPosition("b3h", 134, 253, 29, 29);
    view.defPosition("c3h", 201, 253, 29, 29);
    view.defPosition("d3h", 268, 253, 29, 29);
    view.defPosition("g3h", 469, 254, 29, 29);
    view.defPosition("h3h", 536, 254, 29, 29);
    ...
    view.defPosition("a1h", 67, 115, 29, 29);
    view.defPosition("b1h", 134, 115, 29, 29);
    view.defPosition("c1h", 201, 115, 29, 29);
    view.defPosition("d1h", 268, 115, 29, 29);
    view.defPosition("g1h", 469, 115, 29, 29);
    view.defPosition("h1h", 536, 115, 29, 29);
}
