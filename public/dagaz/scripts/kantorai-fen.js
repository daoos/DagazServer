...
var createPiece = function(design, c) {
  ...
  if (c == 'R') return Dagaz.Model.createPiece(design.getPieceType("Raven"), 1);
  if (c == 'r') return Dagaz.Model.createPiece(design.getPieceType("Raven"), 2);
  if (c == 'C') return Dagaz.Model.createPiece(design.getPieceType("Rook"), 1);
  if (c == 'c') return Dagaz.Model.createPiece(design.getPieceType("Rook"), 2);
  if (c == 'S') return Dagaz.Model.createPiece(design.getPieceType("Squire"), 1);
  if (c == 's') return Dagaz.Model.createPiece(design.getPieceType("Squire"), 2);
  ...
  if (c == 'E') return Dagaz.Model.createPiece(design.getPieceType("Priest"), 1);
  if (c == 'e') return Dagaz.Model.createPiece(design.getPieceType("Priest"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Raven"))  r = 'R';
  if (piece.type == design.getPieceType("Rook"))   r = 'C';
  if (piece.type == design.getPieceType("Squire")) r = 'S';
  if (piece.type == design.getPieceType("Knight")) r = 'N';
  if (piece.type == design.getPieceType("Priest")) r = 'E';
