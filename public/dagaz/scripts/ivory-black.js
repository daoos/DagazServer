...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(7, ZRF.LITERAL,	4);	// Clodhopper
    ...
    design.addMove(2, 2, [8, 7], 0, 0, 1);
    design.addMove(2, 2, [9, 3], 0, 0, 1);
    design.addMove(2, 2, [10, 4], 0, 0, 1);
    design.addMove(2, 2, [11, 1], 0, 0, 1);
    design.addMove(2, 2, [12, 6], 0, 0, 1);
    design.addMove(2, 2, [13, 5], 0, 0, 1);
    design.addMove(2, 2, [14, 2], 0, 0, 1);
    design.addMove(2, 2, [15, 0], 0, 0, 1);
    design.addMove(2, 3, [8], 0, 0, 1);
    design.addMove(2, 3, [9], 0, 0, 1);
    design.addMove(2, 3, [10], 0, 0, 1);
    design.addMove(2, 3, [11], 0, 0, 1);
    design.addMove(2, 3, [12], 0, 0, 1);
    design.addMove(2, 3, [13], 0, 0, 1);
    design.addMove(2, 3, [14], 0, 0, 1);
    design.addMove(2, 3, [15], 0, 0, 1);
    design.addMove(2, 6, [8, 6, 6], 0, 0, 2);
    design.addMove(2, 6, [8, 5, 5], 0, 0, 2);
    design.addMove(2, 6, [11, 2, 2], 0, 0, 2);
    design.addMove(2, 6, [11, 0, 0], 0, 0, 2);
    design.addMove(2, 6, [10, 6, 6], 0, 0, 2);
    design.addMove(2, 6, [9, 5, 5], 0, 0, 2);
    design.addMove(2, 6, [10, 2, 2], 0, 0, 2);
    design.addMove(2, 6, [9, 0, 0], 0, 0, 2);
    design.addMove(2, 6, [12, 7, 7], 0, 0, 2);
    design.addMove(2, 6, [12, 4, 4], 0, 0, 2);
    design.addMove(2, 6, [13, 7, 7], 0, 0, 2);
    design.addMove(2, 6, [13, 3, 3], 0, 0, 2);
    design.addMove(2, 6, [14, 1, 1], 0, 0, 2);
    design.addMove(2, 6, [14, 4, 4], 0, 0, 2);
    design.addMove(2, 6, [15, 1, 1], 0, 0, 2);
    design.addMove(2, 6, [15, 3, 3], 0, 0, 2);
    ...
    design.addMove(4, 5, [8, 7, 7, 7], 0, 0, 1);
    design.addMove(4, 5, [9, 3, 3, 3], 0, 0, 1);
    design.addMove(4, 5, [10, 4, 4, 4], 0, 0, 1);
    design.addMove(4, 5, [11, 1, 1, 1], 0, 0, 1);
    design.addMove(4, 5, [12, 6, 6, 6], 0, 0, 1);
    design.addMove(4, 5, [13, 5, 5, 5], 0, 0, 1);
    design.addMove(4, 5, [14, 2, 2, 2], 0, 0, 1);
    design.addMove(4, 5, [15, 0, 0, 0], 0, 0, 1);
    design.addMove(4, 7, [8, 7, 7, 7], 0, 0, 2);
    design.addMove(4, 7, [9, 3, 3, 3], 0, 0, 2);
    design.addMove(4, 7, [10, 4, 4, 4], 0, 0, 2);
    design.addMove(4, 7, [11, 1, 1, 1], 0, 0, 2);
    design.addMove(4, 7, [12, 6, 6, 6], 0, 0, 2);
    design.addMove(4, 7, [13, 5, 5, 5], 0, 0, 2);
    design.addMove(4, 7, [14, 2, 2, 2], 0, 0, 2);
    design.addMove(4, 7, [15, 0, 0, 0], 0, 0, 2);
    ...
    design.setup("Red", "Brain", 85, 1);
    design.setup("Red", "Brain", 76, 2);
    ...
    design.setup("Blue", "Brain", 4, 1);
    design.setup("Blue", "Brain", 13, 2);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a10", 482, 542, 59, 59);
    view.defPosition("b10", 422, 542, 59, 59);
    view.defPosition("c10", 362, 542, 59, 59);
    view.defPosition("d10", 302, 542, 59, 59);
    view.defPosition("e10", 242, 542, 59, 59);
    view.defPosition("f10", 182, 542, 59, 59);
    view.defPosition("g10", 122, 542, 59, 59);
    view.defPosition("h10", 62, 542, 59, 59);
    view.defPosition("i10", 2, 542, 59, 59);
    view.defPosition("a9", 482, 482, 59, 59);
    view.defPosition("b9", 422, 482, 59, 59);
    view.defPosition("c9", 362, 482, 59, 59);
    view.defPosition("d9", 302, 482, 59, 59);
    view.defPosition("e9", 242, 482, 59, 59);
    view.defPosition("f9", 182, 482, 59, 59);
    view.defPosition("g9", 122, 482, 59, 59);
    view.defPosition("h9", 62, 482, 59, 59);
    view.defPosition("i9", 2, 482, 59, 59);
    view.defPosition("a8", 482, 422, 59, 59);
    view.defPosition("b8", 422, 422, 59, 59);
    view.defPosition("c8", 362, 422, 59, 59);
    view.defPosition("d8", 302, 422, 59, 59);
    view.defPosition("e8", 242, 422, 59, 59);
    view.defPosition("f8", 182, 422, 59, 59);
    view.defPosition("g8", 122, 422, 59, 59);
    view.defPosition("h8", 62, 422, 59, 59);
    view.defPosition("i8", 2, 422, 59, 59);
    view.defPosition("a7", 482, 362, 59, 59);
    view.defPosition("b7", 422, 362, 59, 59);
    view.defPosition("c7", 362, 362, 59, 59);
    view.defPosition("d7", 302, 362, 59, 59);
    view.defPosition("e7", 242, 362, 59, 59);
    view.defPosition("f7", 182, 362, 59, 59);
    view.defPosition("g7", 122, 362, 59, 59);
    view.defPosition("h7", 62, 362, 59, 59);
    view.defPosition("i7", 2, 362, 59, 59);
    view.defPosition("a6", 482, 302, 59, 59);
    view.defPosition("b6", 422, 302, 59, 59);
    view.defPosition("c6", 362, 302, 59, 59);
    view.defPosition("d6", 302, 302, 59, 59);
    view.defPosition("e6", 242, 302, 59, 59);
    view.defPosition("f6", 182, 302, 59, 59);
    view.defPosition("g6", 122, 302, 59, 59);
    view.defPosition("h6", 62, 302, 59, 59);
    view.defPosition("i6", 2, 302, 59, 59);
    view.defPosition("a5", 482, 242, 59, 59);
    view.defPosition("b5", 422, 242, 59, 59);
    view.defPosition("c5", 362, 242, 59, 59);
    view.defPosition("d5", 302, 242, 59, 59);
    view.defPosition("e5", 242, 242, 59, 59);
    view.defPosition("f5", 182, 242, 59, 59);
    view.defPosition("g5", 122, 242, 59, 59);
    view.defPosition("h5", 62, 242, 59, 59);
    view.defPosition("i5", 2, 242, 59, 59);
    view.defPosition("a4", 482, 182, 59, 59);
    view.defPosition("b4", 422, 182, 59, 59);
    view.defPosition("c4", 362, 182, 59, 59);
    view.defPosition("d4", 302, 182, 59, 59);
    view.defPosition("e4", 242, 182, 59, 59);
    view.defPosition("f4", 182, 182, 59, 59);
    view.defPosition("g4", 122, 182, 59, 59);
    view.defPosition("h4", 62, 182, 59, 59);
    view.defPosition("i4", 2, 182, 59, 59);
    view.defPosition("a3", 482, 122, 59, 59);
    view.defPosition("b3", 422, 122, 59, 59);
    view.defPosition("c3", 362, 122, 59, 59);
    view.defPosition("d3", 302, 122, 59, 59);
    view.defPosition("e3", 242, 122, 59, 59);
    view.defPosition("f3", 182, 122, 59, 59);
    view.defPosition("g3", 122, 122, 59, 59);
    view.defPosition("h3", 62, 122, 59, 59);
    view.defPosition("i3", 2, 122, 59, 59);
    view.defPosition("a2", 482, 62, 59, 59);
    view.defPosition("b2", 422, 62, 59, 59);
    view.defPosition("c2", 362, 62, 59, 59);
    view.defPosition("d2", 302, 62, 59, 59);
    view.defPosition("e2", 242, 62, 59, 59);
    view.defPosition("f2", 182, 62, 59, 59);
    view.defPosition("g2", 122, 62, 59, 59);
    view.defPosition("h2", 62, 62, 59, 59);
    view.defPosition("i2", 2, 62, 59, 59);
    view.defPosition("a1", 482, 2, 59, 59);
    view.defPosition("b1", 422, 2, 59, 59);
    view.defPosition("c1", 362, 2, 59, 59);
    view.defPosition("d1", 302, 2, 59, 59);
    view.defPosition("e1", 242, 2, 59, 59);
    view.defPosition("f1", 182, 2, 59, 59);
    view.defPosition("g1", 122, 2, 59, 59);
    view.defPosition("h1", 62, 2, 59, 59);
    view.defPosition("i1", 2, 2, 59, 59);
}
