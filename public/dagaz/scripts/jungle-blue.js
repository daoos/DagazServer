...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 400, 531, 66, 66);
    view.defPosition("b9", 334, 531, 66, 66);
    view.defPosition("c9", 268, 531, 66, 66);
    view.defPosition("d9", 202, 531, 66, 66);
    view.defPosition("e9", 136, 531, 66, 66);
    view.defPosition("f9", 70, 531, 66, 66);
    view.defPosition("g9", 4, 531, 66, 66);
    view.defPosition("a8", 400, 465, 66, 66);
    view.defPosition("b8", 334, 465, 66, 66);
    view.defPosition("c8", 268, 465, 66, 66);
    view.defPosition("d8", 202, 465, 66, 66);
    view.defPosition("e8", 136, 465, 66, 66);
    view.defPosition("f8", 70, 465, 66, 66);
    view.defPosition("g8", 4, 465, 66, 66);
    view.defPosition("a7", 400, 399, 66, 66);
    view.defPosition("b7", 334, 399, 66, 66);
    view.defPosition("c7", 268, 399, 66, 66);
    view.defPosition("d7", 202, 399, 66, 66);
    view.defPosition("e7", 136, 399, 66, 66);
    view.defPosition("f7", 70, 399, 66, 66);
    view.defPosition("g7", 4, 399, 66, 66);
    view.defPosition("a6", 400, 333, 66, 66);
    view.defPosition("b6", 334, 333, 66, 66);
    view.defPosition("c6", 268, 333, 66, 66);
    view.defPosition("d6", 202, 333, 66, 66);
    view.defPosition("e6", 136, 333, 66, 66);
    view.defPosition("f6", 70, 333, 66, 66);
    view.defPosition("g6", 4, 333, 66, 66);
    view.defPosition("a5", 400, 267, 66, 66);
    view.defPosition("b5", 334, 267, 66, 66);
    view.defPosition("c5", 268, 267, 66, 66);
    view.defPosition("d5", 202, 267, 66, 66);
    view.defPosition("e5", 136, 267, 66, 66);
    view.defPosition("f5", 70, 267, 66, 66);
    view.defPosition("g5", 4, 267, 66, 66);
    view.defPosition("a4", 400, 201, 66, 66);
    view.defPosition("b4", 334, 201, 66, 66);
    view.defPosition("c4", 268, 201, 66, 66);
    view.defPosition("d4", 202, 201, 66, 66);
    view.defPosition("e4", 136, 201, 66, 66);
    view.defPosition("f4", 70, 201, 66, 66);
    view.defPosition("g4", 4, 201, 66, 66);
    view.defPosition("a3", 400, 135, 66, 66);
    view.defPosition("b3", 334, 135, 66, 66);
    view.defPosition("c3", 268, 135, 66, 66);
    view.defPosition("d3", 202, 135, 66, 66);
    view.defPosition("e3", 136, 135, 66, 66);
    view.defPosition("f3", 70, 135, 66, 66);
    view.defPosition("g3", 4, 135, 66, 66);
    view.defPosition("a2", 400, 69, 66, 66);
    view.defPosition("b2", 334, 69, 66, 66);
    view.defPosition("c2", 268, 69, 66, 66);
    view.defPosition("d2", 202, 69, 66, 66);
    view.defPosition("e2", 136, 69, 66, 66);
    view.defPosition("f2", 70, 69, 66, 66);
    view.defPosition("g2", 4, 69, 66, 66);
    view.defPosition("a1", 400, 3, 66, 66);
    view.defPosition("b1", 334, 3, 66, 66);
    view.defPosition("c1", 268, 3, 66, 66);
    view.defPosition("d1", 202, 3, 66, 66);
    view.defPosition("e1", 136, 3, 66, 66);
    view.defPosition("f1", 70, 3, 66, 66);
    view.defPosition("g1", 4, 3, 66, 66);
}
