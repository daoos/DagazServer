...
var materialTable = [0, 100, 200, 300, 350, 400, 450, 500, 1000, 1500, 1400, 2000, 600000];

var g_seeValues = [0, 1, 2, 3, 3, 3, 3, 3, 5, 6, 6, 7, 900, 0, 0, 0,
                   0, 1, 2, 3, 3, 3, 3, 3, 5, 6, 6, 7, 900, 0, 0, 0];
...
var pieceSquareAdj = new Array(12);
...
Dagaz.AI.isNoZugzwang = function() {
    return Dagaz.AI.g_pieceCount[pieceBishop  | Dagaz.AI.g_toMove] != 0 ||
           ...
           Dagaz.AI.g_pieceCount[pieceKnightP | Dagaz.AI.g_toMove] != 0 ||
...
Dagaz.AI.ResetGame = function() {
  ...
  var pieceDeltas = [[], g_pawnDeltas, g_knightDeltas, g_silverDeltas, g_goldDeltas, g_goldDeltas, g_goldDeltas, g_goldDeltas, g_bishopDeltas, g_rookDeltas, g_kingDeltas, g_kingDeltas, g_kingDeltas];
...
function GetSlot() {
    var ix = Dagaz.AI.g_toMove ? [22, 23, 18, 19, 14, 15, 10, 11, 6, 7, 2, 3] : [0, 1, 4, 5, 8, 9, 12, 13, 16, 17, 20, 21];
    for (var i = 0; i < RESERVE_SIZE; i++) {
   ...
   for (var slot = 0; slot < RESERVE_SIZE; slot++) {
       ...
       for (var to = 0; to < 256; to++) {
           ...
           if ((piece & Dagaz.AI.TYPE_MASK) == pieceKnight) {
               ...
               if (row <= 0x30 && Dagaz.AI.g_toMove) continue;
           }
