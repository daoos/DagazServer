...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a10", 614, 614, 68, 68);
    view.defPosition("b10", 546, 614, 68, 68);
    view.defPosition("c10", 478, 614, 68, 68);
    view.defPosition("d10", 410, 614, 68, 68);
    view.defPosition("e10", 342, 614, 68, 68);
    view.defPosition("f10", 274, 614, 68, 68);
    view.defPosition("g10", 206, 614, 68, 68);
    view.defPosition("h10", 138, 614, 68, 68);
    view.defPosition("i10", 70, 614, 68, 68);
    view.defPosition("j10", 2, 614, 68, 68);
    view.defPosition("a9", 614, 546, 68, 68);
    view.defPosition("b9", 546, 546, 68, 68);
    view.defPosition("c9", 478, 546, 68, 68);
    view.defPosition("d9", 410, 546, 68, 68);
    view.defPosition("e9", 342, 546, 68, 68);
    view.defPosition("f9", 274, 546, 68, 68);
    view.defPosition("g9", 206, 546, 68, 68);
    view.defPosition("h9", 138, 546, 68, 68);
    view.defPosition("i9", 70, 546, 68, 68);
    view.defPosition("j9", 2, 546, 68, 68);
    ...
    view.defPosition("i8", 70, 478, 68, 68);
    view.defPosition("j8", 2, 478, 68, 68);
    ...
    view.defPosition("i7", 70, 410, 68, 68);
    view.defPosition("j7", 2, 410, 68, 68);
    ...
    view.defPosition("i6", 70, 342, 68, 68);
    view.defPosition("j6", 2, 342, 68, 68);
    ...
    view.defPosition("i5", 70, 274, 68, 68);
    view.defPosition("j5", 2, 274, 68, 68);
    ...
    view.defPosition("i4", 70, 206, 68, 68);
    view.defPosition("j4", 2, 206, 68, 68);
    ...
    view.defPosition("i3", 70, 138, 68, 68);
    view.defPosition("j3", 2, 138, 68, 68);
    ...
    view.defPosition("i2", 70, 70, 68, 68);
    view.defPosition("j2", 2, 70, 68, 68);
    ...
    view.defPosition("i1", 70, 2, 68, 68);
    view.defPosition("j1", 2, 2, 68, 68);
}
