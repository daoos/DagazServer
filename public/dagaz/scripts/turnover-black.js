...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Gold", "Pawn", 135, 1);
    design.setup("Gold", "Pawn", 142, 1);
    design.setup("Gold", "Pawn", 151, 1);
    design.setup("Gold", "Pawn", 158, 1);
    design.setup("Gold", "Pawn", 167, 1);
    design.setup("Gold", "Pawn", 174, 1);
    design.setup("Gold", "Pawn", 183, 1);
    design.setup("Gold", "Pawn", 190, 1);
    design.setup("Gold", "Bishop", 71, 1);
    design.setup("Gold", "Bishop", 78, 1);
    design.setup("Gold", "Bishop", 87, 1);
    design.setup("Gold", "Bishop", 94, 1);
    design.setup("Gold", "Bishop", 103, 1);
    design.setup("Gold", "Bishop", 110, 1);
    design.setup("Gold", "Bishop", 119, 1);
    design.setup("Gold", "Bishop", 126, 1);
    design.setup("Gold", "Rook", 7, 1);
    design.setup("Gold", "Rook", 14, 1);
    design.setup("Gold", "Rook", 23, 1);
    design.setup("Gold", "Rook", 30, 1);
    design.setup("Gold", "Rook", 39, 1);
    design.setup("Gold", "Rook", 46, 1);
    design.setup("Gold", "Rook", 55, 1);
    design.setup("Gold", "Rook", 62, 1);
    design.setup("Silver", "Pawn", 128, 1);
    design.setup("Silver", "Pawn", 137, 1);
    design.setup("Silver", "Pawn", 144, 1);
    design.setup("Silver", "Pawn", 153, 1);
    design.setup("Silver", "Pawn", 160, 1);
    design.setup("Silver", "Pawn", 169, 1);
    design.setup("Silver", "Pawn", 176, 1);
    design.setup("Silver", "Pawn", 185, 1);
    design.setup("Silver", "Bishop", 64, 1);
    design.setup("Silver", "Bishop", 73, 1);
    design.setup("Silver", "Bishop", 80, 1);
    design.setup("Silver", "Bishop", 89, 1);
    design.setup("Silver", "Bishop", 96, 1);
    design.setup("Silver", "Bishop", 105, 1);
    design.setup("Silver", "Bishop", 112, 1);
    design.setup("Silver", "Bishop", 121, 1);
    design.setup("Silver", "Rook", 0, 1);
    design.setup("Silver", "Rook", 9, 1);
    design.setup("Silver", "Rook", 16, 1);
    design.setup("Silver", "Rook", 25, 1);
    design.setup("Silver", "Rook", 32, 1);
    design.setup("Silver", "Rook", 41, 1);
    design.setup("Silver", "Rook", 48, 1);
    design.setup("Silver", "Rook", 57, 1);

    design.setup("Gold", "Pawn", 135, 2);
    design.setup("Gold", "Pawn", 143, 2);
    design.setup("Gold", "Pawn", 151, 2);
    design.setup("Gold", "Pawn", 159, 2);
    design.setup("Gold", "Pawn", 167, 2);
    design.setup("Gold", "Pawn", 175, 2);
    design.setup("Gold", "Pawn", 183, 2);
    design.setup("Gold", "Pawn", 191, 2);
    design.setup("Gold", "Bishop", 71, 2);
    design.setup("Gold", "Bishop", 79, 2);
    design.setup("Gold", "Bishop", 87, 2);
    design.setup("Gold", "Bishop", 95, 2);
    design.setup("Gold", "Bishop", 103, 2);
    design.setup("Gold", "Bishop", 111, 2);
    design.setup("Gold", "Bishop", 119, 2);
    design.setup("Gold", "Bishop", 127, 2);
    design.setup("Gold", "Rook", 7, 2);
    design.setup("Gold", "Rook", 15, 2);
    design.setup("Gold", "Rook", 23, 2);
    design.setup("Gold", "Rook", 31, 2);
    design.setup("Gold", "Rook", 39, 2);
    design.setup("Gold", "Rook", 47, 2);
    design.setup("Gold", "Rook", 55, 2);
    design.setup("Gold", "Rook", 63, 2);
    design.setup("Silver", "Pawn", 128, 2);
    design.setup("Silver", "Pawn", 136, 2);
    design.setup("Silver", "Pawn", 144, 2);
    design.setup("Silver", "Pawn", 152, 2);
    design.setup("Silver", "Pawn", 160, 2);
    design.setup("Silver", "Pawn", 168, 2);
    design.setup("Silver", "Pawn", 176, 2);
    design.setup("Silver", "Pawn", 184, 2);
    design.setup("Silver", "Bishop", 64, 2);
    design.setup("Silver", "Bishop", 72, 2);
    design.setup("Silver", "Bishop", 80, 2);
    design.setup("Silver", "Bishop", 88, 2);
    design.setup("Silver", "Bishop", 96, 2);
    design.setup("Silver", "Bishop", 104, 2);
    design.setup("Silver", "Bishop", 112, 2);
    design.setup("Silver", "Bishop", 120, 2);
    design.setup("Silver", "Rook", 0, 2);
    design.setup("Silver", "Rook", 8, 2);
    design.setup("Silver", "Rook", 16, 2);
    design.setup("Silver", "Rook", 24, 2);
    design.setup("Silver", "Rook", 32, 2);
    design.setup("Silver", "Rook", 40, 2);
    design.setup("Silver", "Rook", 48, 2);
    design.setup("Silver", "Rook", 56, 2);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8t", 527, 529, 22, 22);
    view.defPosition("a7t", 527, 460, 22, 22);
    view.defPosition("a6t", 527, 391, 22, 22);
    view.defPosition("a5t", 527, 322, 22, 22);
    view.defPosition("a4t", 527, 253, 22, 22);
    view.defPosition("a3t", 527, 184, 22, 22);
    view.defPosition("a2t", 527, 115, 22, 22);
    view.defPosition("a1t", 527, 46, 22, 22);
    view.defPosition("b8t", 458, 529, 22, 22);
    view.defPosition("b7t", 458, 460, 22, 22);
    view.defPosition("b6t", 458, 391, 22, 22);
    view.defPosition("b5t", 458, 322, 22, 22);
    view.defPosition("b4t", 458, 253, 22, 22);
    view.defPosition("b3t", 458, 184, 22, 22);
    view.defPosition("b2t", 458, 115, 22, 22);
    view.defPosition("b1t", 458, 46, 22, 22);
    view.defPosition("c8t", 389, 529, 22, 22);
    view.defPosition("c7t", 389, 460, 22, 22);
    view.defPosition("c6t", 389, 391, 22, 22);
    view.defPosition("c5t", 389, 322, 22, 22);
    view.defPosition("c4t", 389, 253, 22, 22);
    view.defPosition("c3t", 389, 184, 22, 22);
    view.defPosition("c2t", 389, 115, 22, 22);
    view.defPosition("c1t", 389, 46, 22, 22);
    view.defPosition("d8t", 320, 529, 22, 22);
    view.defPosition("d7t", 320, 460, 22, 22);
    view.defPosition("d6t", 320, 391, 22, 22);
    view.defPosition("d5t", 320, 322, 22, 22);
    view.defPosition("d4t", 320, 253, 22, 22);
    view.defPosition("d3t", 320, 184, 22, 22);
    view.defPosition("d2t", 320, 115, 22, 22);
    view.defPosition("d1t", 320, 46, 22, 22);
    view.defPosition("e8t", 251, 529, 22, 22);
    view.defPosition("e7t", 251, 460, 22, 22);
    view.defPosition("e6t", 251, 391, 22, 22);
    view.defPosition("e5t", 251, 322, 22, 22);
    view.defPosition("e4t", 251, 253, 22, 22);
    view.defPosition("e3t", 251, 184, 22, 22);
    view.defPosition("e2t", 251, 115, 22, 22);
    view.defPosition("e1t", 251, 46, 22, 22);
    view.defPosition("f8t", 182, 529, 22, 22);
    view.defPosition("f7t", 182, 460, 22, 22);
    view.defPosition("f6t", 182, 391, 22, 22);
    view.defPosition("f5t", 182, 322, 22, 22);
    view.defPosition("f4t", 182, 253, 22, 22);
    view.defPosition("f3t", 182, 184, 22, 22);
    view.defPosition("f2t", 182, 115, 22, 22);
    view.defPosition("f1t", 182, 46, 22, 22);
    view.defPosition("g8t", 113, 529, 22, 22);
    view.defPosition("g7t", 113, 460, 22, 22);
    view.defPosition("g6t", 113, 391, 22, 22);
    view.defPosition("g5t", 113, 322, 22, 22);
    view.defPosition("g4t", 113, 253, 22, 22);
    view.defPosition("g3t", 113, 184, 22, 22);
    view.defPosition("g2t", 113, 115, 22, 22);
    view.defPosition("g1t", 113, 46, 22, 22);
    view.defPosition("h8t", 44, 529, 22, 22);
    view.defPosition("h7t", 44, 460, 22, 22);
    view.defPosition("h6t", 44, 391, 22, 22);
    view.defPosition("h5t", 44, 322, 22, 22);
    view.defPosition("h4t", 44, 253, 22, 22);
    view.defPosition("h3t", 44, 184, 22, 22);
    view.defPosition("h2t", 44, 115, 22, 22);
    view.defPosition("h1t", 44, 46, 22, 22);
    view.defPosition("a8s", 517, 519, 42, 42);
    view.defPosition("a7s", 517, 450, 42, 42);
    view.defPosition("a6s", 517, 381, 42, 42);
    view.defPosition("a5s", 517, 312, 42, 42);
    view.defPosition("a4s", 517, 243, 42, 42);
    view.defPosition("a3s", 517, 174, 42, 42);
    view.defPosition("a2s", 517, 105, 42, 42);
    view.defPosition("a1s", 517, 36, 42, 42);
    view.defPosition("b8s", 448, 519, 42, 42);
    view.defPosition("b7s", 448, 450, 42, 42);
    view.defPosition("b6s", 448, 381, 42, 42);
    view.defPosition("b5s", 448, 312, 42, 42);
    view.defPosition("b4s", 448, 243, 42, 42);
    view.defPosition("b3s", 448, 174, 42, 42);
    view.defPosition("b2s", 448, 105, 42, 42);
    view.defPosition("b1s", 448, 36, 42, 42);
    view.defPosition("c8s", 379, 519, 42, 42);
    view.defPosition("c7s", 379, 450, 42, 42);
    view.defPosition("c6s", 379, 381, 42, 42);
    view.defPosition("c5s", 379, 312, 42, 42);
    view.defPosition("c4s", 379, 243, 42, 42);
    view.defPosition("c3s", 379, 174, 42, 42);
    view.defPosition("c2s", 379, 105, 42, 42);
    view.defPosition("c1s", 379, 36, 42, 42);
    view.defPosition("d8s", 310, 519, 42, 42);
    view.defPosition("d7s", 310, 450, 42, 42);
    view.defPosition("d6s", 310, 381, 42, 42);
    view.defPosition("d5s", 310, 312, 42, 42);
    view.defPosition("d4s", 310, 243, 42, 42);
    view.defPosition("d3s", 310, 174, 42, 42);
    view.defPosition("d2s", 310, 105, 42, 42);
    view.defPosition("d1s", 310, 36, 42, 42);
    view.defPosition("e8s", 241, 519, 42, 42);
    view.defPosition("e7s", 241, 450, 42, 42);
    view.defPosition("e6s", 241, 381, 42, 42);
    view.defPosition("e5s", 241, 312, 42, 42);
    view.defPosition("e4s", 241, 243, 42, 42);
    view.defPosition("e3s", 241, 174, 42, 42);
    view.defPosition("e2s", 241, 105, 42, 42);
    view.defPosition("e1s", 241, 36, 42, 42);
    view.defPosition("f8s", 172, 519, 42, 42);
    view.defPosition("f7s", 172, 450, 42, 42);
    view.defPosition("f6s", 172, 381, 42, 42);
    view.defPosition("f5s", 172, 312, 42, 42);
    view.defPosition("f4s", 172, 243, 42, 42);
    view.defPosition("f3s", 172, 174, 42, 42);
    view.defPosition("f2s", 172, 105, 42, 42);
    view.defPosition("f1s", 172, 36, 42, 42);
    view.defPosition("g8s", 103, 519, 42, 42);
    view.defPosition("g7s", 103, 450, 42, 42);
    view.defPosition("g6s", 103, 381, 42, 42);
    view.defPosition("g5s", 103, 312, 42, 42);
    view.defPosition("g4s", 103, 243, 42, 42);
    view.defPosition("g3s", 103, 174, 42, 42);
    view.defPosition("g2s", 103, 105, 42, 42);
    view.defPosition("g1s", 103, 36, 42, 42);
    view.defPosition("h8s", 34, 519, 42, 42);
    view.defPosition("h7s", 34, 450, 42, 42);
    view.defPosition("h6s", 34, 381, 42, 42);
    view.defPosition("h5s", 34, 312, 42, 42);
    view.defPosition("h4s", 34, 243, 42, 42);
    view.defPosition("h3s", 34, 174, 42, 42);
    view.defPosition("h2s", 34, 105, 42, 42);
    view.defPosition("h1s", 34, 36, 42, 42);
    view.defPosition("a8b", 507, 509, 62, 62);
    view.defPosition("a7b", 507, 440, 62, 62);
    view.defPosition("a6b", 507, 371, 62, 62);
    view.defPosition("a5b", 507, 302, 62, 62);
    view.defPosition("a4b", 507, 233, 62, 62);
    view.defPosition("a3b", 507, 164, 62, 62);
    view.defPosition("a2b", 507, 95, 62, 62);
    view.defPosition("a1b", 507, 26, 62, 62);
    view.defPosition("b8b", 438, 509, 62, 62);
    view.defPosition("b7b", 438, 440, 62, 62);
    view.defPosition("b6b", 438, 371, 62, 62);
    view.defPosition("b5b", 438, 302, 62, 62);
    view.defPosition("b4b", 438, 233, 62, 62);
    view.defPosition("b3b", 438, 164, 62, 62);
    view.defPosition("b2b", 438, 95, 62, 62);
    view.defPosition("b1b", 438, 26, 62, 62);
    view.defPosition("c8b", 369, 509, 62, 62);
    view.defPosition("c7b", 369, 440, 62, 62);
    view.defPosition("c6b", 369, 371, 62, 62);
    view.defPosition("c5b", 369, 302, 62, 62);
    view.defPosition("c4b", 369, 233, 62, 62);
    view.defPosition("c3b", 369, 164, 62, 62);
    view.defPosition("c2b", 369, 95, 62, 62);
    view.defPosition("c1b", 369, 26, 62, 62);
    view.defPosition("d8b", 300, 509, 62, 62);
    view.defPosition("d7b", 300, 440, 62, 62);
    view.defPosition("d6b", 300, 371, 62, 62);
    view.defPosition("d5b", 300, 302, 62, 62);
    view.defPosition("d4b", 300, 233, 62, 62);
    view.defPosition("d3b", 300, 164, 62, 62);
    view.defPosition("d2b", 300, 95, 62, 62);
    view.defPosition("d1b", 300, 26, 62, 62);
    view.defPosition("e8b", 231, 509, 62, 62);
    view.defPosition("e7b", 231, 440, 62, 62);
    view.defPosition("e6b", 231, 371, 62, 62);
    view.defPosition("e5b", 231, 302, 62, 62);
    view.defPosition("e4b", 231, 233, 62, 62);
    view.defPosition("e3b", 231, 164, 62, 62);
    view.defPosition("e2b", 231, 95, 62, 62);
    view.defPosition("e1b", 231, 26, 62, 62);
    view.defPosition("f8b", 162, 509, 62, 62);
    view.defPosition("f7b", 162, 440, 62, 62);
    view.defPosition("f6b", 162, 371, 62, 62);
    view.defPosition("f5b", 162, 302, 62, 62);
    view.defPosition("f4b", 162, 233, 62, 62);
    view.defPosition("f3b", 162, 164, 62, 62);
    view.defPosition("f2b", 162, 95, 62, 62);
    view.defPosition("f1b", 162, 26, 62, 62);
    view.defPosition("g8b", 93, 509, 62, 62);
    view.defPosition("g7b", 93, 440, 62, 62);
    view.defPosition("g6b", 93, 371, 62, 62);
    view.defPosition("g5b", 93, 302, 62, 62);
    view.defPosition("g4b", 93, 233, 62, 62);
    view.defPosition("g3b", 93, 164, 62, 62);
    view.defPosition("g2b", 93, 95, 62, 62);
    view.defPosition("g1b", 93, 26, 62, 62);
    view.defPosition("h8b", 24, 509, 62, 62);
    view.defPosition("h7b", 24, 440, 62, 62);
    view.defPosition("h6b", 24, 371, 62, 62);
    view.defPosition("h5b", 24, 302, 62, 62);
    view.defPosition("h4b", 24, 233, 62, 62);
    view.defPosition("h3b", 24, 164, 62, 62);
    view.defPosition("h2b", 24, 95, 62, 62);
    view.defPosition("h1b", 24, 26, 62, 62);
}
