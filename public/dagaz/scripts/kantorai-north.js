...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("South", "Pawn", 42, 1);
    design.setup("South", "Pawn", 43, 1);
    design.setup("South", "Pawn", 44, 1);
    design.setup("South", "Pawn", 45, 1);
    design.setup("South", "Pawn", 46, 1);
    design.setup("South", "Pawn", 47, 1);
    design.setup("South", "Pawn", 48, 1);
    design.setup("South", "Squire", 58, 1);
    design.setup("South", "Squire", 61, 1);
    design.setup("South", "Priest", 57, 1);
    design.setup("South", "Priest", 60, 1);
    design.setup("South", "Raven", 56, 1);
    design.setup("South", "Raven", 62, 1);
    design.setup("South", "King", 59, 1);
    design.setup("North", "Pawn", 14, 1);
    design.setup("North", "Pawn", 15, 1);
    design.setup("North", "Pawn", 16, 1);
    design.setup("North", "Pawn", 17, 1);
    design.setup("North", "Pawn", 18, 1);
    design.setup("North", "Pawn", 19, 1);
    design.setup("North", "Pawn", 20, 1);
    design.setup("North", "Squire", 2, 1);
    design.setup("North", "Squire", 5, 1);
    design.setup("North", "Priest", 1, 1);
    design.setup("North", "Priest", 4, 1);
    design.setup("North", "Raven", 0, 1);
    design.setup("North", "Raven", 6, 1);
    design.setup("North", "King", 3, 1);

    design.setup("South", "Pawn", 49, 2);
    design.setup("South", "Pawn", 50, 2);
    design.setup("South", "Pawn", 51, 2);
    design.setup("South", "Pawn", 52, 2);
    design.setup("South", "Pawn", 53, 2);
    design.setup("South", "Pawn", 54, 2);
    design.setup("South", "Pawn", 55, 2);
    design.setup("South", "Squire", 58, 2);
    design.setup("South", "Squire", 61, 2);
    design.setup("South", "Priest", 57, 2);
    design.setup("South", "Priest", 60, 2);
    design.setup("South", "Raven", 56, 2);
    design.setup("South", "Raven", 62, 2);
    design.setup("South", "King", 59, 2);
    design.setup("North", "Pawn", 7, 2);
    design.setup("North", "Pawn", 8, 2);
    design.setup("North", "Pawn", 9, 2);
    design.setup("North", "Pawn", 10, 2);
    design.setup("North", "Pawn", 11, 2);
    design.setup("North", "Pawn", 12, 2);
    design.setup("North", "Pawn", 13, 2);
    design.setup("North", "Squire", 2, 2);
    design.setup("North", "Squire", 5, 2);
    design.setup("North", "Priest", 1, 2);
    design.setup("North", "Priest", 4, 2);
    design.setup("North", "Raven", 0, 2);
    design.setup("North", "Raven", 6, 2);
    design.setup("North", "King", 3, 2);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 255, 383, 41, 46);
    view.defPosition("b9", 214, 383, 41, 46);
    view.defPosition("c9", 173, 383, 41, 46);
    view.defPosition("d9", 132, 383, 41, 46);
    view.defPosition("e9", 91, 383, 41, 46);
    view.defPosition("f9", 50, 383, 41, 46);
    view.defPosition("g9", 9, 383, 41, 46);
    view.defPosition("a8", 255, 337, 41, 46);
    view.defPosition("b8", 214, 337, 41, 46);
    view.defPosition("c8", 173, 337, 41, 46);
    view.defPosition("d8", 132, 337, 41, 46);
    view.defPosition("e8", 91, 337, 41, 46);
    view.defPosition("f8", 50, 337, 41, 46);
    view.defPosition("g8", 9, 337, 41, 46);
    view.defPosition("a7", 255, 291, 41, 46);
    view.defPosition("b7", 214, 291, 41, 46);
    view.defPosition("c7", 173, 291, 41, 46);
    view.defPosition("d7", 132, 291, 41, 46);
    view.defPosition("e7", 91, 291, 41, 46);
    view.defPosition("f7", 50, 291, 41, 46);
    view.defPosition("g7", 9, 291, 41, 46);
    view.defPosition("a6", 255, 245, 41, 46);
    view.defPosition("b6", 214, 245, 41, 46);
    view.defPosition("c6", 173, 245, 41, 46);
    view.defPosition("d6", 132, 245, 41, 46);
    view.defPosition("e6", 91, 245, 41, 46);
    view.defPosition("f6", 50, 245, 41, 46);
    view.defPosition("g6", 9, 245, 41, 46);
    view.defPosition("a5", 255, 199, 41, 46);
    view.defPosition("b5", 214, 199, 41, 46);
    view.defPosition("c5", 173, 199, 41, 46);
    view.defPosition("d5", 132, 199, 41, 46);
    view.defPosition("e5", 91, 199, 41, 46);
    view.defPosition("f5", 50, 199, 41, 46);
    view.defPosition("g5", 9, 199, 41, 46);
    view.defPosition("a4", 255, 153, 41, 46);
    view.defPosition("b4", 214, 153, 41, 46);
    view.defPosition("c4", 173, 153, 41, 46);
    view.defPosition("d4", 132, 153, 41, 46);
    view.defPosition("e4", 91, 153, 41, 46);
    view.defPosition("f4", 50, 153, 41, 46);
    view.defPosition("g4", 9, 153, 41, 46);
    view.defPosition("a3", 255, 107, 41, 46);
    view.defPosition("b3", 214, 107, 41, 46);
    view.defPosition("c3", 173, 107, 41, 46);
    view.defPosition("d3", 132, 107, 41, 46);
    view.defPosition("e3", 91, 107, 41, 46);
    view.defPosition("f3", 50, 107, 41, 46);
    view.defPosition("g3", 9, 107, 41, 46);
    view.defPosition("a2", 255, 61, 41, 46);
    view.defPosition("b2", 214, 61, 41, 46);
    view.defPosition("c2", 173, 61, 41, 46);
    view.defPosition("d2", 132, 61, 41, 46);
    view.defPosition("e2", 91, 61, 41, 46);
    view.defPosition("f2", 50, 61, 41, 46);
    view.defPosition("g2", 9, 61, 41, 46);
    view.defPosition("a1", 255, 15, 41, 46);
    view.defPosition("b1", 214, 15, 41, 46);
    view.defPosition("c1", 173, 15, 41, 46);
    view.defPosition("d1", 132, 15, 41, 46);
    view.defPosition("e1", 91, 15, 41, 46);
    view.defPosition("f1", 50, 15, 41, 46);
    view.defPosition("g1", 9, 15, 41, 46);
}
