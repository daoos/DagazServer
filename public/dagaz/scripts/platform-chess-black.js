...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("ad", 410, 410, 136, 136);
    view.defPosition("bd", 274, 410, 136, 136);
    view.defPosition("cd", 138, 410, 136, 136);
    view.defPosition("dd", 2, 410, 136, 136);
    view.defPosition("ac", 410, 274, 136, 136);
    view.defPosition("bc", 274, 274, 136, 136);
    view.defPosition("cc", 138, 274, 136, 136);
    view.defPosition("dc", 2, 274, 136, 136);
    view.defPosition("ab", 410, 138, 136, 136);
    view.defPosition("bb", 274, 138, 136, 136);
    view.defPosition("cb", 138, 138, 136, 136);
    view.defPosition("db", 2, 138, 136, 136);
    view.defPosition("aa", 410, 2, 136, 136);
    view.defPosition("ba", 274, 2, 136, 136);
    view.defPosition("ca", 138, 2, 136, 136);
    view.defPosition("da", 2, 2, 136, 136);
    view.defPosition("a8", 488, 488, 48, 48);
    view.defPosition("b8", 420, 488, 48, 48);
    view.defPosition("c8", 352, 488, 48, 48);
    view.defPosition("d8", 284, 488, 48, 48);
    view.defPosition("e8", 216, 488, 48, 48);
    view.defPosition("f8", 148, 488, 48, 48);
    view.defPosition("g8", 80, 488, 48, 48);
    view.defPosition("h8", 12, 488, 48, 48);
    view.defPosition("a7", 488, 420, 48, 48);
    view.defPosition("b7", 420, 420, 48, 48);
    view.defPosition("c7", 352, 420, 48, 48);
    view.defPosition("d7", 284, 420, 48, 48);
    view.defPosition("e7", 216, 420, 48, 48);
    view.defPosition("f7", 148, 420, 48, 48);
    view.defPosition("g7", 80, 420, 48, 48);
    view.defPosition("h7", 12, 420, 48, 48);
    view.defPosition("a6", 488, 352, 48, 48);
    view.defPosition("b6", 420, 352, 48, 48);
    view.defPosition("c6", 352, 352, 48, 48);
    view.defPosition("d6", 284, 352, 48, 48);
    view.defPosition("e6", 216, 352, 48, 48);
    view.defPosition("f6", 148, 352, 48, 48);
    view.defPosition("g6", 80, 352, 48, 48);
    view.defPosition("h6", 12, 352, 48, 48);
    view.defPosition("a5", 488, 284, 48, 48);
    view.defPosition("b5", 420, 284, 48, 48);
    view.defPosition("c5", 352, 284, 48, 48);
    view.defPosition("d5", 284, 284, 48, 48);
    view.defPosition("e5", 216, 284, 48, 48);
    view.defPosition("f5", 148, 284, 48, 48);
    view.defPosition("g5", 80, 284, 48, 48);
    view.defPosition("h5", 12, 284, 48, 48);
    view.defPosition("a4", 488, 216, 48, 48);
    view.defPosition("b4", 420, 216, 48, 48);
    view.defPosition("c4", 352, 216, 48, 48);
    view.defPosition("d4", 284, 216, 48, 48);
    view.defPosition("e4", 216, 216, 48, 48);
    view.defPosition("f4", 148, 216, 48, 48);
    view.defPosition("g4", 80, 216, 48, 48);
    view.defPosition("h4", 12, 216, 48, 48);
    view.defPosition("a3", 488, 148, 48, 48);
    view.defPosition("b3", 420, 148, 48, 48);
    view.defPosition("c3", 352, 148, 48, 48);
    view.defPosition("d3", 284, 148, 48, 48);
    view.defPosition("e3", 216, 148, 48, 48);
    view.defPosition("f3", 148, 148, 48, 48);
    view.defPosition("g3", 80, 148, 48, 48);
    view.defPosition("h3", 12, 148, 48, 48);
    view.defPosition("a2", 488, 80, 48, 48);
    view.defPosition("b2", 420, 80, 48, 48);
    view.defPosition("c2", 352, 80, 48, 48);
    view.defPosition("d2", 284, 80, 48, 48);
    view.defPosition("e2", 216, 80, 48, 48);
    view.defPosition("f2", 148, 80, 48, 48);
    view.defPosition("g2", 80, 80, 48, 48);
    view.defPosition("h2", 12, 80, 48, 48);
    view.defPosition("a1", 488, 12, 48, 48);
    view.defPosition("b1", 420, 12, 48, 48);
    view.defPosition("c1", 352, 12, 48, 48);
    view.defPosition("d1", 284, 12, 48, 48);
    view.defPosition("e1", 216, 12, 48, 48);
    view.defPosition("f1", 148, 12, 48, 48);
    view.defPosition("g1", 80, 12, 48, 48);
    view.defPosition("h1", 12, 12, 48, 48);
