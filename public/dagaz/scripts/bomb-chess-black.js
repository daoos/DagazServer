...
Dagaz.Controller.addSound(20, "sounds/shoot.wav", true);
...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPlayer("Neutral", [0, 1, 2, 3, 4, 5, 6, 7]);
    ...
    design.addCommand(0, ZRF.LITERAL,	6);	// Bomb
    ...
    design.addCommand(1, ZRF.LITERAL,	6);	// Bomb
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("NeutralBomb", "Neutral Bomb");
