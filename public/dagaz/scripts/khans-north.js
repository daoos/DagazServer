...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 358, 532, 59, 59);
    view.defPosition("b7", 270, 532, 59, 59);
    view.defPosition("c7", 182, 532, 59, 59);
    view.defPosition("d7", 94, 532, 59, 59);
    view.defPosition("e7", 6, 532, 59, 59);
    view.defPosition("a6", 358, 444, 59, 59);
    view.defPosition("b6", 270, 444, 59, 59);
    view.defPosition("c6", 182, 444, 59, 59);
    view.defPosition("d6", 94, 444, 59, 59);
    view.defPosition("e6", 6, 444, 59, 59);
    view.defPosition("a5", 358, 356, 59, 59);
    view.defPosition("b5", 270, 356, 59, 59);
    view.defPosition("c5", 182, 356, 59, 59);
    view.defPosition("d5", 94, 356, 59, 59);
    view.defPosition("e5", 6, 356, 59, 59);
    view.defPosition("a4", 358, 268, 59, 59);
    view.defPosition("b4", 270, 268, 59, 59);
    view.defPosition("c4", 182, 268, 59, 59);
    view.defPosition("d4", 94, 268, 59, 59);
    view.defPosition("e4", 6, 268, 59, 59);
    view.defPosition("a3", 358, 180, 59, 59);
    view.defPosition("b3", 270, 180, 59, 59);
    view.defPosition("c3", 182, 180, 59, 59);
    view.defPosition("d3", 94, 180, 59, 59);
    view.defPosition("e3", 6, 180, 59, 59);
    view.defPosition("a2", 358, 92, 59, 59);
    view.defPosition("b2", 270, 92, 59, 59);
    view.defPosition("c2", 182, 92, 59, 59);
    view.defPosition("d2", 94, 92, 59, 59);
    view.defPosition("e2", 6, 92, 59, 59);
    view.defPosition("a1", 358, 4, 59, 59);
    view.defPosition("b1", 270, 4, 59, 59);
    view.defPosition("c1", 182, 4, 59, 59);
    view.defPosition("d1", 94, 4, 59, 59);
    view.defPosition("e1", 6, 4, 59, 59);
}
