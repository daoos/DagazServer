...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("b13", 381, 377, 39, 39);
    view.defPosition("d13", 276, 377, 39, 39);
    view.defPosition("f13", 171, 377, 39, 39);
    view.defPosition("b11", 381, 316, 39, 39);
    view.defPosition("d11", 276, 316, 39, 39);
    view.defPosition("f11", 171, 316, 39, 39);
    view.defPosition("b9", 381, 255, 39, 39);
    view.defPosition("d9", 276, 255, 39, 39);
    view.defPosition("f9", 171, 255, 39, 39);
    view.defPosition("b7", 381, 194, 39, 39);
    view.defPosition("d7", 276, 194, 39, 39);
    view.defPosition("f7", 171, 194, 39, 39);
    view.defPosition("b5", 381, 133, 39, 39);
    view.defPosition("d5", 276, 133, 39, 39);
    view.defPosition("f5", 171, 133, 39, 39);
    view.defPosition("b3", 381, 72, 39, 39);
    view.defPosition("d3", 276, 72, 39, 39);
    view.defPosition("f3", 171, 72, 39, 39);
    view.defPosition("b1", 381, 11, 39, 39);
    view.defPosition("d1", 276, 11, 39, 39);
    view.defPosition("f1", 171, 11, 39, 39);
    view.defPosition("a12", 434, 348, 39, 39);
    view.defPosition("c12", 329, 348, 39, 39);
    view.defPosition("e12", 224, 348, 39, 39);
    view.defPosition("g12", 119, 348, 39, 39);
    view.defPosition("a10", 434, 287, 39, 39);
    view.defPosition("c10", 329, 287, 39, 39);
    view.defPosition("e10", 224, 287, 39, 39);
    view.defPosition("g10", 119, 287, 39, 39);
    view.defPosition("a8", 434, 226, 39, 39);
    view.defPosition("c8", 329, 226, 39, 39);
    view.defPosition("e8", 224, 226, 39, 39);
    view.defPosition("g8", 119, 226, 39, 39);
    view.defPosition("a6", 434, 165, 39, 39);
    view.defPosition("c6", 329, 165, 39, 39);
    view.defPosition("e6", 224, 165, 39, 39);
    view.defPosition("g6", 119, 165, 39, 39);
    view.defPosition("a4", 434, 104, 39, 39);
    view.defPosition("c4", 329, 104, 39, 39);
    view.defPosition("e4", 224, 104, 39, 39);
    view.defPosition("g4", 119, 104, 39, 39);
    view.defPosition("a2", 434, 43, 39, 39);
    view.defPosition("c2", 329, 43, 39, 39);
    view.defPosition("e2", 224, 43, 39, 39);
    view.defPosition("g2", 119, 43, 39, 39);
    view.defPosition("X10", 543, 381, 39, 39);
    view.defPosition("Y10", 502, 381, 39, 39);
    view.defPosition("X9", 543, 340, 39, 39);
    view.defPosition("Y9", 502, 340, 39, 39);
    view.defPosition("X8", 543, 299, 39, 39);
    view.defPosition("Y8", 502, 299, 39, 39);
    view.defPosition("X7", 543, 258, 39, 39);
    view.defPosition("Y7", 502, 258, 39, 39);
    view.defPosition("X6", 543, 217, 39, 39);
    view.defPosition("Y6", 502, 217, 39, 39);
    view.defPosition("X5", 543, 176, 39, 39);
    view.defPosition("Y5", 502, 176, 39, 39);
    view.defPosition("X4", 543, 135, 39, 39);
    view.defPosition("Y4", 502, 135, 39, 39);
    view.defPosition("X3", 543, 94, 39, 39);
    view.defPosition("Y3", 502, 94, 39, 39);
    view.defPosition("X2", 543, 53, 39, 39);
    view.defPosition("Y2", 502, 53, 39, 39);
    view.defPosition("X1", 543, 12, 39, 39);
    view.defPosition("Y1", 502, 12, 39, 39);
    view.defPosition("Z10", 53, 381, 39, 39);
    view.defPosition("T10", 12, 381, 39, 39);
    view.defPosition("Z9", 53, 340, 39, 39);
    view.defPosition("T9", 12, 340, 39, 39);
    view.defPosition("Z8", 53, 299, 39, 39);
    view.defPosition("T8", 12, 299, 39, 39);
    view.defPosition("Z7", 53, 258, 39, 39);
    view.defPosition("T7", 12, 258, 39, 39);
    view.defPosition("Z6", 53, 217, 39, 39);
    view.defPosition("T6", 12, 217, 39, 39);
    view.defPosition("Z5", 53, 176, 39, 39);
    view.defPosition("T5", 12, 176, 39, 39);
    view.defPosition("Z4", 53, 135, 39, 39);
    view.defPosition("T4", 12, 135, 39, 39);
    view.defPosition("Z3", 53, 94, 39, 39);
    view.defPosition("T3", 12, 94, 39, 39);
    view.defPosition("Z2", 53, 53, 39, 39);
    view.defPosition("T2", 12, 53, 39, 39);
    view.defPosition("Z1", 53, 12, 39, 39);
    view.defPosition("T1", 12, 12, 39, 39);
}
