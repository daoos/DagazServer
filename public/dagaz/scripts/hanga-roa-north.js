...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("i9", 2, 402, 50, 50);
    ...
    view.defPosition("i8", 2, 352, 50, 50);
    ...
    view.defPosition("i7", 2, 302, 50, 50);
    ...
    view.defPosition("i6", 2, 252, 50, 50);
    ...
    view.defPosition("i5", 2, 202, 50, 50);
    ...
    view.defPosition("i4", 2, 152, 50, 50);
    ...
    view.defPosition("i3", 2, 102, 50, 50);
    ...
    view.defPosition("i2", 2, 52, 50, 50);
    ...
    view.defPosition("i1", 2, 2, 50, 50);
    view.defPosition("X9", 452, 402, 50, 50);
    view.defPosition("X8", 452, 352, 50, 50);
    view.defPosition("X7", 452, 302, 50, 50);
    view.defPosition("X6", 452, 252, 50, 50);
    view.defPosition("X5", 452, 202, 50, 50);
    view.defPosition("X4", 452, 152, 50, 50);
    view.defPosition("X3", 452, 102, 50, 50);
    view.defPosition("X2", 452, 52, 50, 50);
    view.defPosition("X1", 452, 2, 50, 50);
}
