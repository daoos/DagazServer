...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a2", 668, 108, 80, 80);
    view.defPosition("b2", 568, 108, 80, 80);
    view.defPosition("c2", 468, 108, 80, 80);
    view.defPosition("d2", 368, 108, 80, 80);
    view.defPosition("e2", 268, 108, 80, 80);
    view.defPosition("f2", 168, 108, 80, 80);
    view.defPosition("a1", 668, 8, 80, 80);
    view.defPosition("b1", 568, 8, 80, 80);
    view.defPosition("c1", 468, 8, 80, 80);
    view.defPosition("d1", 368, 8, 80, 80);
    view.defPosition("e1", 268, 8, 80, 80);
    view.defPosition("f1", 168, 8, 80, 80);
    view.defPosition("X2", 768, 8, 140, 180);
