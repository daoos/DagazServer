...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 103, 346, 32, 32);
    view.defPosition("b9", 53, 346, 32, 32);
    view.defPosition("c9", 3, 346, 32, 32);
    view.defPosition("d9", -47, 346, 32, 32);
    view.defPosition("e9", -97, 346, 32, 32);
    view.defPosition("a8", 128, 303, 32, 32);
    view.defPosition("b8", 78, 303, 32, 32);
    view.defPosition("c8", 28, 303, 32, 32);
    view.defPosition("d8", -22, 303, 32, 32);
    view.defPosition("e8", -72, 303, 32, 32);
    view.defPosition("a7", 153, 260, 32, 32);
    view.defPosition("b7", 103, 260, 32, 32);
    view.defPosition("c7", 53, 260, 32, 32);
    view.defPosition("d7", 3, 260, 32, 32);
    view.defPosition("e7", -47, 260, 32, 32);
    view.defPosition("a6", 178, 217, 32, 32);
    view.defPosition("b6", 128, 217, 32, 32);
    view.defPosition("c6", 78, 217, 32, 32);
    view.defPosition("d6", 28, 217, 32, 32);
    view.defPosition("e6", -22, 217, 32, 32);
    view.defPosition("a5", 203, 174, 32, 32);
    view.defPosition("b5", 153, 174, 32, 32);
    view.defPosition("c5", 103, 174, 32, 32);
    view.defPosition("d5", 53, 174, 32, 32);
    view.defPosition("e5", 3, 174, 32, 32);
    view.defPosition("a4", 228, 131, 32, 32);
    view.defPosition("b4", 178, 131, 32, 32);
    view.defPosition("c4", 128, 131, 32, 32);
    view.defPosition("d4", 78, 131, 32, 32);
    view.defPosition("e4", 28, 131, 32, 32);
    view.defPosition("a3", 253, 88, 32, 32);
    view.defPosition("b3", 203, 88, 32, 32);
    view.defPosition("c3", 153, 88, 32, 32);
    view.defPosition("d3", 103, 88, 32, 32);
    view.defPosition("e3", 53, 88, 32, 32);
    view.defPosition("a2", 278, 45, 32, 32);
    view.defPosition("b2", 228, 45, 32, 32);
    view.defPosition("c2", 178, 45, 32, 32);
    view.defPosition("d2", 128, 45, 32, 32);
    view.defPosition("e2", 78, 45, 32, 32);
    view.defPosition("a1", 303, 2, 32, 32);
    view.defPosition("b1", 253, 2, 32, 32);
    view.defPosition("c1", 203, 2, 32, 32);
    view.defPosition("d1", 153, 2, 32, 32);
    view.defPosition("e1", 103, 2, 32, 32);
}
