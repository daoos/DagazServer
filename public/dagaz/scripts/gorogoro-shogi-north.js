...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X6", 782, 478, 94, 94);
    view.defPosition("Y6", 688, 478, 94, 94);
    view.defPosition("a6", 594, 478, 94, 94);
    view.defPosition("b6", 500, 478, 94, 94);
    view.defPosition("c6", 406, 478, 94, 94);
    view.defPosition("d6", 312, 478, 94, 94);
    view.defPosition("e6", 218, 478, 94, 94);
    view.defPosition("Z6", 124, 478, 94, 94);
    view.defPosition("T6", 30, 478, 94, 94);
    view.defPosition("X5", 782, 384, 94, 94);
    view.defPosition("Y5", 688, 384, 94, 94);
    view.defPosition("a5", 594, 384, 94, 94);
    view.defPosition("b5", 500, 384, 94, 94);
    view.defPosition("c5", 406, 384, 94, 94);
    view.defPosition("d5", 312, 384, 94, 94);
    view.defPosition("e5", 218, 384, 94, 94);
    view.defPosition("Z5", 124, 384, 94, 94);
    view.defPosition("T5", 30, 384, 94, 94);
    view.defPosition("X4", 782, 290, 94, 94);
    view.defPosition("Y4", 688, 290, 94, 94);
    view.defPosition("a4", 594, 290, 94, 94);
    view.defPosition("b4", 500, 290, 94, 94);
    view.defPosition("c4", 406, 290, 94, 94);
    view.defPosition("d4", 312, 290, 94, 94);
    view.defPosition("e4", 218, 290, 94, 94);
    view.defPosition("Z4", 124, 290, 94, 94);
    view.defPosition("T4", 30, 290, 94, 94);
    view.defPosition("X3", 782, 196, 94, 94);
    view.defPosition("Y3", 688, 196, 94, 94);
    view.defPosition("a3", 594, 196, 94, 94);
    view.defPosition("b3", 500, 196, 94, 94);
    view.defPosition("c3", 406, 196, 94, 94);
    view.defPosition("d3", 312, 196, 94, 94);
    view.defPosition("e3", 218, 196, 94, 94);
    view.defPosition("Z3", 124, 196, 94, 94);
    view.defPosition("T3", 30, 196, 94, 94);
    view.defPosition("X2", 782, 102, 94, 94);
    view.defPosition("Y2", 688, 102, 94, 94);
    view.defPosition("a2", 594, 102, 94, 94);
    view.defPosition("b2", 500, 102, 94, 94);
    view.defPosition("c2", 406, 102, 94, 94);
    view.defPosition("d2", 312, 102, 94, 94);
    view.defPosition("e2", 218, 102, 94, 94);
    view.defPosition("Z2", 124, 102, 94, 94);
    view.defPosition("T2", 30, 102, 94, 94);
    view.defPosition("X1", 782, 8, 94, 94);
    view.defPosition("Y1", 688, 8, 94, 94);
    view.defPosition("a1", 594, 8, 94, 94);
    view.defPosition("b1", 500, 8, 94, 94);
    view.defPosition("c1", 406, 8, 94, 94);
    view.defPosition("d1", 312, 8, 94, 94);
    view.defPosition("e1", 218, 8, 94, 94);
    view.defPosition("Z1", 124, 8, 94, 94);
    view.defPosition("T1", 30, 8, 94, 94);
