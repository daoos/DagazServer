...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a5", 217, 217, 54, 54);
    view.defPosition("b5", 163, 217, 54, 54);
    view.defPosition("c5", 109, 217, 54, 54);
    view.defPosition("d5", 55, 217, 54, 54);
    view.defPosition("e5", 1, 217, 54, 54);
    view.defPosition("a4", 217, 163, 54, 54);
    view.defPosition("b4", 163, 163, 54, 54);
    view.defPosition("c4", 109, 163, 54, 54);
    view.defPosition("d4", 55, 163, 54, 54);
    view.defPosition("e4", 1, 163, 54, 54);
    view.defPosition("a3", 217, 109, 54, 54);
    view.defPosition("b3", 163, 109, 54, 54);
    view.defPosition("c3", 109, 109, 54, 54);
    view.defPosition("d3", 55, 109, 54, 54);
    view.defPosition("e3", 1, 109, 54, 54);
    view.defPosition("a2", 217, 55, 54, 54);
    view.defPosition("b2", 163, 55, 54, 54);
    view.defPosition("c2", 109, 55, 54, 54);
    view.defPosition("d2", 55, 55, 54, 54);
    view.defPosition("e2", 1, 55, 54, 54);
    view.defPosition("a1", 217, 1, 54, 54);
    view.defPosition("b1", 163, 1, 54, 54);
    view.defPosition("c1", 109, 1, 54, 54);
    view.defPosition("d1", 55, 1, 54, 54);
    view.defPosition("e1", 1, 1, 54, 54);
}
