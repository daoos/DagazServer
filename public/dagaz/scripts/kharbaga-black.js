...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 359, 359, 59, 59);
    view.defPosition("b9", 271, 359, 59, 59);
    view.defPosition("c9", 183, 359, 59, 59);
    view.defPosition("d9", 95, 359, 59, 59);
    view.defPosition("e9", 7, 359, 59, 59);
    view.defPosition("a7", 359, 271, 59, 59);
    view.defPosition("b7", 271, 271, 59, 59);
    view.defPosition("c7", 183, 271, 59, 59);
    view.defPosition("d7", 95, 271, 59, 59);
    view.defPosition("e7", 7, 271, 59, 59);
    view.defPosition("a5", 359, 183, 59, 59);
    view.defPosition("b5", 271, 183, 59, 59);
    view.defPosition("c5", 183, 183, 59, 59);
    view.defPosition("d5", 95, 183, 59, 59);
    view.defPosition("e5", 7, 183, 59, 59);
    view.defPosition("a3", 359, 95, 59, 59);
    view.defPosition("b3", 271, 95, 59, 59);
    view.defPosition("c3", 183, 95, 59, 59);
    view.defPosition("d3", 95, 95, 59, 59);
    view.defPosition("e3", 7, 95, 59, 59);
    view.defPosition("a1", 359, 7, 59, 59);
    view.defPosition("b1", 271, 7, 59, 59);
    view.defPosition("c1", 183, 7, 59, 59);
    view.defPosition("d1", 95, 7, 59, 59);
    view.defPosition("e1", 7, 7, 59, 59);
    view.defPosition("a8", 313, 313, 59, 59);
    view.defPosition("b8", 225, 313, 59, 59);
    view.defPosition("c8", 137, 313, 59, 59);
    view.defPosition("d8", 49, 313, 59, 59);
    view.defPosition("a6", 313, 225, 59, 59);
    view.defPosition("b6", 225, 225, 59, 59);
    view.defPosition("c6", 137, 225, 59, 59);
    view.defPosition("d6", 49, 225, 59, 59);
    view.defPosition("a4", 313, 137, 59, 59);
    view.defPosition("b4", 225, 137, 59, 59);
    view.defPosition("c4", 137, 137, 59, 59);
    view.defPosition("d4", 49, 137, 59, 59);
    view.defPosition("a2", 313, 49, 59, 59);
    view.defPosition("b2", 225, 49, 59, 59);
    view.defPosition("c2", 137, 49, 59, 59);
    view.defPosition("d2", 49, 49, 59, 59);
}
