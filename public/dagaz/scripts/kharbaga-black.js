...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 313, 313, 59, 59);
    view.defPosition("b9", 225, 313, 59, 59);
    view.defPosition("c9", 137, 313, 59, 59);
    view.defPosition("d9", 49, 313, 59, 59);
    view.defPosition("e9", 313, 225, 59, 59);
    view.defPosition("a7", 225, 225, 59, 59);
    view.defPosition("b7", 137, 225, 59, 59);
    view.defPosition("c7", 49, 225, 59, 59);
    view.defPosition("d7", 313, 137, 59, 59);
    view.defPosition("e7", 225, 137, 59, 59);
    view.defPosition("a5", 137, 137, 59, 59);
    view.defPosition("b5", 49, 137, 59, 59);
    view.defPosition("c5", 313, 49, 59, 59);
    view.defPosition("d5", 225, 49, 59, 59);
    view.defPosition("e5", 137, 49, 59, 59);
    view.defPosition("a3", 49, 49, 59, 59);
    view.defPosition("b3", 359, 359, 59, 59);
    view.defPosition("c3", 271, 359, 59, 59);
    view.defPosition("d3", 183, 359, 59, 59);
    view.defPosition("e3", 95, 359, 59, 59);
    view.defPosition("a1", 7, 359, 59, 59);
    view.defPosition("b1", 359, 271, 59, 59);
    view.defPosition("c1", 271, 271, 59, 59);
    view.defPosition("d1", 183, 271, 59, 59);
    view.defPosition("e1", 95, 271, 59, 59);
    view.defPosition("a8", 7, 271, 59, 59);
    view.defPosition("b8", 359, 183, 59, 59);
    view.defPosition("c8", 271, 183, 59, 59);
    view.defPosition("d8", 183, 183, 59, 59);
    view.defPosition("a6", 95, 183, 59, 59);
    view.defPosition("b6", 7, 183, 59, 59);
    view.defPosition("c6", 359, 95, 59, 59);
    view.defPosition("d6", 271, 95, 59, 59);
    view.defPosition("a4", 183, 95, 59, 59);
    view.defPosition("b4", 95, 95, 59, 59);
    view.defPosition("c4", 7, 95, 59, 59);
    view.defPosition("d4", 359, 7, 59, 59);
    view.defPosition("a2", 271, 7, 59, 59);
    view.defPosition("b2", 183, 7, 59, 59);
    view.defPosition("c2", 95, 7, 59, 59);
    view.defPosition("d2", 7, 7, 59, 59);
}
