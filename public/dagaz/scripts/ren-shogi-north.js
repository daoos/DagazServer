...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X7", 337, 291, 41, 46);
    view.defPosition("Y7", 296, 291, 41, 46);
    view.defPosition("I7", 255, 291, 41, 46);
    view.defPosition("a7", 214, 291, 41, 46);
    view.defPosition("b7", 173, 291, 41, 46);
    view.defPosition("c7", 132, 291, 41, 46);
    view.defPosition("J7", 91, 291, 41, 46);
    view.defPosition("Z7", 50, 291, 41, 46);
    view.defPosition("T7", 9, 291, 41, 46);
    view.defPosition("X6", 337, 245, 41, 46);
    view.defPosition("Y6", 296, 245, 41, 46);
    view.defPosition("I6", 255, 245, 41, 46);
    view.defPosition("a6", 214, 245, 41, 46);
    view.defPosition("b6", 173, 245, 41, 46);
    view.defPosition("c6", 132, 245, 41, 46);
    view.defPosition("J6", 91, 245, 41, 46);
    view.defPosition("Z6", 50, 245, 41, 46);
    view.defPosition("T6", 9, 245, 41, 46);
    view.defPosition("X5", 337, 199, 41, 46);
    view.defPosition("Y5", 296, 199, 41, 46);
    view.defPosition("I5", 255, 199, 41, 46);
    view.defPosition("a5", 214, 199, 41, 46);
    view.defPosition("b5", 173, 199, 41, 46);
    view.defPosition("c5", 132, 199, 41, 46);
    view.defPosition("J5", 91, 199, 41, 46);
    view.defPosition("Z5", 50, 199, 41, 46);
    view.defPosition("T5", 9, 199, 41, 46);
    view.defPosition("X4", 337, 153, 41, 46);
    view.defPosition("Y4", 296, 153, 41, 46);
    view.defPosition("I4", 255, 153, 41, 46);
    view.defPosition("a4", 214, 153, 41, 46);
    view.defPosition("b4", 173, 153, 41, 46);
    view.defPosition("c4", 132, 153, 41, 46);
    view.defPosition("J4", 91, 153, 41, 46);
    view.defPosition("Z4", 50, 153, 41, 46);
    view.defPosition("T4", 9, 153, 41, 46);
    view.defPosition("X3", 337, 107, 41, 46);
    view.defPosition("Y3", 296, 107, 41, 46);
    view.defPosition("I3", 255, 107, 41, 46);
    view.defPosition("a3", 214, 107, 41, 46);
    view.defPosition("b3", 173, 107, 41, 46);
    view.defPosition("c3", 132, 107, 41, 46);
    view.defPosition("J3", 91, 107, 41, 46);
    view.defPosition("Z3", 50, 107, 41, 46);
    view.defPosition("T3", 9, 107, 41, 46);
    view.defPosition("X2", 337, 61, 41, 46);
    view.defPosition("Y2", 296, 61, 41, 46);
    view.defPosition("I2", 255, 61, 41, 46);
    view.defPosition("a2", 214, 61, 41, 46);
    view.defPosition("b2", 173, 61, 41, 46);
    view.defPosition("c2", 132, 61, 41, 46);
    view.defPosition("J2", 91, 61, 41, 46);
    view.defPosition("Z2", 50, 61, 41, 46);
    view.defPosition("T2", 9, 61, 41, 46);
    view.defPosition("X1", 337, 15, 41, 46);
    view.defPosition("Y1", 296, 15, 41, 46);
    view.defPosition("I1", 255, 15, 41, 46);
    view.defPosition("a1", 214, 15, 41, 46);
    view.defPosition("b1", 173, 15, 41, 46);
    view.defPosition("c1", 132, 15, 41, 46);
