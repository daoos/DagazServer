...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 184, 275, 42, 42);
    view.defPosition("b7", 139, 275, 42, 42);
    view.defPosition("c7", 94, 275, 42, 42);
    view.defPosition("d7", 49, 275, 42, 42);
    view.defPosition("e7", 4, 275, 42, 42);
    view.defPosition("a6", 184, 230, 42, 42);
    view.defPosition("b6", 139, 230, 42, 42);
    view.defPosition("c6", 94, 230, 42, 42);
    view.defPosition("d6", 49, 230, 42, 42);
    view.defPosition("e6", 4, 230, 42, 42);
    view.defPosition("a5", 184, 185, 42, 42);
    view.defPosition("b5", 139, 185, 42, 42);
    view.defPosition("c5", 94, 185, 42, 42);
    view.defPosition("d5", 49, 185, 42, 42);
    view.defPosition("e5", 4, 185, 42, 42);
    view.defPosition("a4", 184, 140, 42, 42);
    view.defPosition("b4", 139, 140, 42, 42);
    view.defPosition("c4", 94, 140, 42, 42);
    view.defPosition("d4", 49, 140, 42, 42);
    view.defPosition("e4", 4, 140, 42, 42);
    view.defPosition("a3", 184, 95, 42, 42);
    view.defPosition("b3", 139, 95, 42, 42);
    view.defPosition("c3", 94, 95, 42, 42);
    view.defPosition("d3", 49, 95, 42, 42);
    view.defPosition("e3", 4, 95, 42, 42);
    view.defPosition("a2", 184, 50, 42, 42);
    view.defPosition("b2", 139, 50, 42, 42);
    view.defPosition("c2", 94, 50, 42, 42);
    view.defPosition("d2", 49, 50, 42, 42);
    view.defPosition("e2", 4, 50, 42, 42);
    view.defPosition("a1", 184, 5, 42, 42);
    view.defPosition("b1", 139, 5, 42, 42);
    view.defPosition("c1", 94, 5, 42, 42);
    view.defPosition("d1", 49, 5, 42, 42);
    view.defPosition("e1", 4, 5, 42, 42);
}
