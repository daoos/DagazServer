...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("dark-fairy-eater-view", "1");
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 2, 2, 68, 68);
    view.defPosition("b9", 70, 2, 68, 68);
    view.defPosition("c9", 138, 2, 68, 68);
    view.defPosition("d9", 206, 2, 68, 68);
    view.defPosition("e9", 274, 2, 68, 68);
    view.defPosition("f9", 342, 2, 68, 68);
    view.defPosition("g9", 410, 2, 68, 68);
    view.defPosition("h9", 478, 2, 68, 68);
    view.defPosition("i9", 546, 2, 68, 68);
    view.defPosition("a8", 2, 70, 68, 68);
    view.defPosition("b8", 70, 70, 68, 68);
    view.defPosition("c8", 138, 70, 68, 68);
    view.defPosition("d8", 206, 70, 68, 68);
    view.defPosition("e8", 274, 70, 68, 68);
    view.defPosition("f8", 342, 70, 68, 68);
    view.defPosition("g8", 410, 70, 68, 68);
    view.defPosition("h8", 478, 70, 68, 68);
    view.defPosition("i8", 546, 70, 68, 68);
    view.defPosition("a7", 2, 138, 68, 68);
    view.defPosition("b7", 70, 138, 68, 68);
    view.defPosition("c7", 138, 138, 68, 68);
    view.defPosition("d7", 206, 138, 68, 68);
    view.defPosition("e7", 274, 138, 68, 68);
    view.defPosition("f7", 342, 138, 68, 68);
    view.defPosition("g7", 410, 138, 68, 68);
    view.defPosition("h7", 478, 138, 68, 68);
    view.defPosition("i7", 546, 138, 68, 68);
    view.defPosition("a6", 2, 206, 68, 68);
    view.defPosition("b6", 70, 206, 68, 68);
    view.defPosition("c6", 138, 206, 68, 68);
    view.defPosition("d6", 206, 206, 68, 68);
    view.defPosition("e6", 274, 206, 68, 68);
    view.defPosition("f6", 342, 206, 68, 68);
    view.defPosition("g6", 410, 206, 68, 68);
    view.defPosition("h6", 478, 206, 68, 68);
    view.defPosition("i6", 546, 206, 68, 68);
    ...
    view.defPosition("i5", 546, 274, 68, 68);
    view.defPosition("a4", 2, 342, 68, 68);
    view.defPosition("b4", 70, 342, 68, 68);
    view.defPosition("c4", 138, 342, 68, 68);
    view.defPosition("d4", 206, 342, 68, 68);
    view.defPosition("e4", 274, 342, 68, 68);
    view.defPosition("f4", 342, 342, 68, 68);
    view.defPosition("g4", 410, 342, 68, 68);
    view.defPosition("h4", 478, 342, 68, 68);
    view.defPosition("i4", 546, 342, 68, 68);
    view.defPosition("a3", 2, 410, 68, 68);
    view.defPosition("b3", 70, 410, 68, 68);
    view.defPosition("c3", 138, 410, 68, 68);
    view.defPosition("d3", 206, 410, 68, 68);
    view.defPosition("e3", 274, 410, 68, 68);
    view.defPosition("f3", 342, 410, 68, 68);
    view.defPosition("g3", 410, 410, 68, 68);
    view.defPosition("h3", 478, 410, 68, 68);
    view.defPosition("i3", 546, 410, 68, 68);
    view.defPosition("a2", 2, 478, 68, 68);
    view.defPosition("b2", 70, 478, 68, 68);
    view.defPosition("c2", 138, 478, 68, 68);
    view.defPosition("d2", 206, 478, 68, 68);
    view.defPosition("e2", 274, 478, 68, 68);
    view.defPosition("f2", 342, 478, 68, 68);
    view.defPosition("g2", 410, 478, 68, 68);
    view.defPosition("h2", 478, 478, 68, 68);
    view.defPosition("i2", 546, 478, 68, 68);
    view.defPosition("a1", 2, 546, 68, 68);
    view.defPosition("b1", 70, 546, 68, 68);
    view.defPosition("c1", 138, 546, 68, 68);
    view.defPosition("d1", 206, 546, 68, 68);
    view.defPosition("e1", 274, 546, 68, 68);
    view.defPosition("f1", 342, 546, 68, 68);
    view.defPosition("g1", 410, 546, 68, 68);
    view.defPosition("h1", 478, 546, 68, 68);
    view.defPosition("i1", 546, 546, 68, 68);
