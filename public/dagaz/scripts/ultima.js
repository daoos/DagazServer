...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("Withdrawer", 1, 8);
    design.addMove(1, 1, [4, 4], 0, 11);
    design.addMove(1, 1, [2, 2], 0, 11);
    design.addMove(1, 1, [0, 0], 0, 11);
    design.addMove(1, 1, [1, 1], 0, 11);
    design.addMove(1, 1, [7, 7], 0, 11);
    design.addMove(1, 1, [6, 6], 0, 11);
    design.addMove(1, 1, [3, 3], 0, 11);
    design.addMove(1, 1, [5, 5], 0, 11);
    design.addMove(1, 2, [], 0, 11);

    design.addPiece("Chameleon", 2, 18);
    design.addMove(2, 3, [4, 4, 4], 0, 12);
    design.addMove(2, 3, [2, 2, 2], 0, 12);
    design.addMove(2, 3, [0, 0, 0], 0, 12);
    design.addMove(2, 3, [1, 1, 1], 0, 12);
    design.addMove(2, 3, [7, 7, 7], 0, 12);
    design.addMove(2, 3, [6, 6, 6], 0, 12);
    design.addMove(2, 3, [3, 3, 3], 0, 12);
    design.addMove(2, 3, [5, 5, 5], 0, 12);
    design.addMove(2, 0, [4], 0, 12);
    design.addMove(2, 0, [2], 0, 12);
    design.addMove(2, 0, [0], 0, 12);
    design.addMove(2, 0, [1], 0, 12);
    design.addMove(2, 0, [7], 0, 12);
    design.addMove(2, 0, [6], 0, 12);
    design.addMove(2, 0, [3], 0, 12);
    design.addMove(2, 0, [5], 0, 12);
    design.addMove(2, 2, [], 0, 12);

    design.addPiece("LongLeaper", 3, 14);
    design.addMove(3, 4, [4, 4], 0, 13);
    design.addMove(3, 4, [2, 2], 0, 13);
    design.addMove(3, 4, [0, 0], 0, 13);
    design.addMove(3, 4, [1, 1], 0, 13);
    design.addMove(3, 4, [7, 7], 0, 13);
    design.addMove(3, 4, [6, 6], 0, 13);
    design.addMove(3, 4, [3, 3], 0, 13);
    design.addMove(3, 4, [5, 5], 0, 13);
    design.addMove(3, 2, [], 0, 13);

    design.addPiece("Coordinator", 4, 10);
    design.addMove(4, 1, [4, 4], 0, 14);
    design.addMove(4, 1, [2, 2], 0, 14);
    design.addMove(4, 1, [0, 0], 0, 14);
    design.addMove(4, 1, [1, 1], 0, 14);
    design.addMove(4, 1, [7, 7], 0, 14);
    design.addMove(4, 1, [6, 6], 0, 14);
    design.addMove(4, 1, [3, 3], 0, 14);
    design.addMove(4, 1, [5, 5], 0, 14);
    design.addMove(4, 2, [], 0, 14);

    design.addPiece("Immobilizer", 5, 20);
    design.addMove(5, 1, [4, 4], 0, 14);
    design.addMove(5, 1, [2, 2], 0, 14);
    design.addMove(5, 1, [0, 0], 0, 14);
    design.addMove(5, 1, [1, 1], 0, 14);
    design.addMove(5, 1, [7, 7], 0, 14);
    design.addMove(5, 1, [6, 6], 0, 14);
    design.addMove(5, 1, [3, 3], 0, 14);
    design.addMove(5, 1, [5, 5], 0, 14);
    design.addMove(5, 2, [], 0, 14);

    design.addPiece("Pawn", 6, 2);
    design.addMove(6, 1, [4, 4], 0, 15);
    design.addMove(6, 1, [2, 2], 0, 15);
    design.addMove(6, 1, [0, 0], 0, 15);
    design.addMove(6, 1, [1, 1], 0, 15);
    design.addMove(6, 2, [], 0, 15);
