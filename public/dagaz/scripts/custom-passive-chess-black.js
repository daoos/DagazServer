...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("A8", 342, 343, 42, 42);
    view.defPosition("B8", 297, 343, 42, 42);
    view.defPosition("C8", 252, 343, 42, 42);
    view.defPosition("D8", 207, 343, 42, 42);
    view.defPosition("E8", 162, 343, 42, 42);
    view.defPosition("F8", 117, 343, 42, 42);
    view.defPosition("G8", 72, 343, 42, 42);
    view.defPosition("H8", 27, 343, 42, 42);
    view.defPosition("A7", 342, 298, 42, 42);
    view.defPosition("B7", 297, 298, 42, 42);
    view.defPosition("C7", 252, 298, 42, 42);
    view.defPosition("D7", 207, 298, 42, 42);
    view.defPosition("E7", 162, 298, 42, 42);
    view.defPosition("F7", 117, 298, 42, 42);
    view.defPosition("G7", 72, 298, 42, 42);
    view.defPosition("H7", 27, 298, 42, 42);
    view.defPosition("A6", 342, 253, 42, 42);
    view.defPosition("B6", 297, 253, 42, 42);
    view.defPosition("C6", 252, 253, 42, 42);
    view.defPosition("D6", 207, 253, 42, 42);
    view.defPosition("E6", 162, 253, 42, 42);
    view.defPosition("F6", 117, 253, 42, 42);
    view.defPosition("G6", 72, 253, 42, 42);
    view.defPosition("H6", 27, 253, 42, 42);
    view.defPosition("A5", 342, 208, 42, 42);
    view.defPosition("B5", 297, 208, 42, 42);
    view.defPosition("C5", 252, 208, 42, 42);
    view.defPosition("D5", 207, 208, 42, 42);
    view.defPosition("E5", 162, 208, 42, 42);
    view.defPosition("F5", 117, 208, 42, 42);
    view.defPosition("G5", 72, 208, 42, 42);
    view.defPosition("H5", 27, 208, 42, 42);
    view.defPosition("A4", 342, 163, 42, 42);
    view.defPosition("B4", 297, 163, 42, 42);
    view.defPosition("C4", 252, 163, 42, 42);
    view.defPosition("D4", 207, 163, 42, 42);
    view.defPosition("E4", 162, 163, 42, 42);
    view.defPosition("F4", 117, 163, 42, 42);
    view.defPosition("G4", 72, 163, 42, 42);
    view.defPosition("H4", 27, 163, 42, 42);
    view.defPosition("A3", 342, 118, 42, 42);
    view.defPosition("B3", 297, 118, 42, 42);
    view.defPosition("C3", 252, 118, 42, 42);
    view.defPosition("D3", 207, 118, 42, 42);
    view.defPosition("E3", 162, 118, 42, 42);
    view.defPosition("F3", 117, 118, 42, 42);
    view.defPosition("G3", 72, 118, 42, 42);
    view.defPosition("H3", 27, 118, 42, 42);
    view.defPosition("A2", 342, 73, 42, 42);
    view.defPosition("B2", 297, 73, 42, 42);
    view.defPosition("C2", 252, 73, 42, 42);
    view.defPosition("D2", 207, 73, 42, 42);
    view.defPosition("E2", 162, 73, 42, 42);
    view.defPosition("F2", 117, 73, 42, 42);
    view.defPosition("G2", 72, 73, 42, 42);
    view.defPosition("H2", 27, 73, 42, 42);
    view.defPosition("A1", 342, 28, 42, 42);
    view.defPosition("B1", 297, 28, 42, 42);
    view.defPosition("C1", 252, 28, 42, 42);
    view.defPosition("D1", 207, 28, 42, 42);
    view.defPosition("E1", 162, 28, 42, 42);
    view.defPosition("F1", 117, 28, 42, 42);
    view.defPosition("G1", 72, 28, 42, 42);
    view.defPosition("H1", 27, 28, 42, 42);

    view.defPosition("a8", 341, 342, 42, 42);
    view.defPosition("b8", 296, 342, 42, 42);
    view.defPosition("c8", 251, 342, 42, 42);
    view.defPosition("d8", 206, 342, 42, 42);
    view.defPosition("e8", 161, 342, 42, 42);
    view.defPosition("f8", 116, 342, 42, 42);
    view.defPosition("g8", 71, 342, 42, 42);
    view.defPosition("h8", 26, 342, 42, 42);
    view.defPosition("a7", 341, 297, 42, 42);
    view.defPosition("b7", 296, 297, 42, 42);
    view.defPosition("c7", 251, 297, 42, 42);
    view.defPosition("d7", 206, 297, 42, 42);
    view.defPosition("e7", 161, 297, 42, 42);
    view.defPosition("f7", 116, 297, 42, 42);
    view.defPosition("g7", 71, 297, 42, 42);
    view.defPosition("h7", 26, 297, 42, 42);
    view.defPosition("a6", 341, 252, 42, 42);
    view.defPosition("b6", 296, 252, 42, 42);
    view.defPosition("c6", 251, 252, 42, 42);
    view.defPosition("d6", 206, 252, 42, 42);
    view.defPosition("e6", 161, 252, 42, 42);
    view.defPosition("f6", 116, 252, 42, 42);
    view.defPosition("g6", 71, 252, 42, 42);
    view.defPosition("h6", 26, 252, 42, 42);
    view.defPosition("a5", 341, 207, 42, 42);
    view.defPosition("b5", 296, 207, 42, 42);
    view.defPosition("c5", 251, 207, 42, 42);
    view.defPosition("d5", 206, 207, 42, 42);
    view.defPosition("e5", 161, 207, 42, 42);
    view.defPosition("f5", 116, 207, 42, 42);
    view.defPosition("g5", 71, 207, 42, 42);
    view.defPosition("h5", 26, 207, 42, 42);
    view.defPosition("a4", 341, 162, 42, 42);
    view.defPosition("b4", 296, 162, 42, 42);
    view.defPosition("c4", 251, 162, 42, 42);
    view.defPosition("d4", 206, 162, 42, 42);
    view.defPosition("e4", 161, 162, 42, 42);
    view.defPosition("f4", 116, 162, 42, 42);
    view.defPosition("g4", 71, 162, 42, 42);
    view.defPosition("h4", 26, 162, 42, 42);
    view.defPosition("a3", 341, 117, 42, 42);
    view.defPosition("b3", 296, 117, 42, 42);
    view.defPosition("c3", 251, 117, 42, 42);
    view.defPosition("d3", 206, 117, 42, 42);
    view.defPosition("e3", 161, 117, 42, 42);
    view.defPosition("f3", 116, 117, 42, 42);
    view.defPosition("g3", 71, 117, 42, 42);
    view.defPosition("h3", 26, 117, 42, 42);
    view.defPosition("a2", 341, 72, 42, 42);
    view.defPosition("b2", 296, 72, 42, 42);
    view.defPosition("c2", 251, 72, 42, 42);
    view.defPosition("d2", 206, 72, 42, 42);
    view.defPosition("e2", 161, 72, 42, 42);
    view.defPosition("f2", 116, 72, 42, 42);
    view.defPosition("g2", 71, 72, 42, 42);
    view.defPosition("h2", 26, 72, 42, 42);
    view.defPosition("a1", 341, 27, 42, 42);
    view.defPosition("b1", 296, 27, 42, 42);
    view.defPosition("c1", 251, 27, 42, 42);
    view.defPosition("d1", 206, 27, 42, 42);
    view.defPosition("e1", 161, 27, 42, 42);
    view.defPosition("f1", 116, 27, 42, 42);
    view.defPosition("g1", 71, 27, 42, 42);
    view.defPosition("h1", 26, 27, 42, 42);
}
