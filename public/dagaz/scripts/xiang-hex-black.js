...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a11", 502, 578, 49, 49);
    view.defPosition("b11", 442, 613, 49, 49);
    view.defPosition("c11", 382, 648, 49, 49);
    view.defPosition("d11", 322, 683, 49, 49);
    view.defPosition("e11", 262, 718, 49, 49);
    view.defPosition("f11", 202, 753, 49, 49);
    view.defPosition("g11", 142, 788, 49, 49);
    view.defPosition("h11", 82, 823, 49, 49);
    view.defPosition("i11", 22, 858, 49, 49);
    view.defPosition("a10", 502, 508, 49, 49);
    view.defPosition("b10", 442, 543, 49, 49);
    view.defPosition("c10", 382, 578, 49, 49);
    view.defPosition("d10", 322, 613, 49, 49);
    view.defPosition("e10", 262, 648, 49, 49);
    view.defPosition("f10", 202, 683, 49, 49);
    view.defPosition("g10", 142, 718, 49, 49);
    view.defPosition("h10", 82, 753, 49, 49);
    view.defPosition("i10", 22, 788, 49, 49);
    view.defPosition("a9", 502, 438, 49, 49);
    view.defPosition("b9", 442, 473, 49, 49);
    view.defPosition("c9", 382, 508, 49, 49);
    view.defPosition("d9", 322, 543, 49, 49);
    view.defPosition("e9", 262, 578, 49, 49);
    view.defPosition("f9", 202, 613, 49, 49);
    view.defPosition("g9", 142, 648, 49, 49);
    view.defPosition("h9", 82, 683, 49, 49);
    view.defPosition("i9", 22, 718, 49, 49);
    view.defPosition("a8", 502, 368, 49, 49);
    view.defPosition("b8", 442, 403, 49, 49);
    view.defPosition("c8", 382, 438, 49, 49);
    view.defPosition("d8", 322, 473, 49, 49);
    view.defPosition("e8", 262, 508, 49, 49);
    view.defPosition("f8", 202, 543, 49, 49);
    view.defPosition("g8", 142, 578, 49, 49);
    view.defPosition("h8", 82, 613, 49, 49);
    view.defPosition("i8", 22, 648, 49, 49);
    view.defPosition("a7", 502, 298, 49, 49);
    view.defPosition("b7", 442, 333, 49, 49);
    view.defPosition("c7", 382, 368, 49, 49);
    view.defPosition("d7", 322, 403, 49, 49);
    view.defPosition("e7", 262, 438, 49, 49);
    view.defPosition("f7", 202, 473, 49, 49);
    view.defPosition("g7", 142, 508, 49, 49);
    view.defPosition("h7", 82, 543, 49, 49);
    view.defPosition("i7", 22, 578, 49, 49);
    view.defPosition("a6", 502, 228, 49, 49);
    view.defPosition("b6", 442, 263, 49, 49);
    view.defPosition("c6", 382, 298, 49, 49);
    view.defPosition("d6", 322, 333, 49, 49);
    view.defPosition("e6", 262, 368, 49, 49);
    view.defPosition("f6", 202, 403, 49, 49);
    view.defPosition("g6", 142, 438, 49, 49);
    view.defPosition("h6", 82, 473, 49, 49);
    view.defPosition("i6", 22, 508, 49, 49);
    view.defPosition("a5", 502, 158, 49, 49);
    view.defPosition("b5", 442, 193, 49, 49);
    view.defPosition("c5", 382, 228, 49, 49);
    view.defPosition("d5", 322, 263, 49, 49);
    view.defPosition("e5", 262, 298, 49, 49);
    view.defPosition("f5", 202, 333, 49, 49);
    view.defPosition("g5", 142, 368, 49, 49);
    view.defPosition("h5", 82, 403, 49, 49);
    view.defPosition("i5", 22, 438, 49, 49);
    view.defPosition("a4", 502, 88, 49, 49);
    view.defPosition("b4", 442, 123, 49, 49);
    view.defPosition("c4", 382, 158, 49, 49);
    view.defPosition("d4", 322, 193, 49, 49);
    view.defPosition("e4", 262, 228, 49, 49);
    view.defPosition("f4", 202, 263, 49, 49);
    view.defPosition("g4", 142, 298, 49, 49);
    view.defPosition("h4", 82, 333, 49, 49);
    view.defPosition("i4", 22, 368, 49, 49);
    view.defPosition("a3", 502, 18, 49, 49);
    view.defPosition("b3", 442, 53, 49, 49);
    view.defPosition("c3", 382, 88, 49, 49);
    view.defPosition("d3", 322, 123, 49, 49);
    view.defPosition("e3", 262, 158, 49, 49);
    view.defPosition("f3", 202, 193, 49, 49);
    view.defPosition("g3", 142, 228, 49, 49);
    view.defPosition("h3", 82, 263, 49, 49);
    view.defPosition("i3", 22, 298, 49, 49);
    view.defPosition("a2", 502, -52, 49, 49);
    view.defPosition("b2", 442, -17, 49, 49);
    view.defPosition("c2", 382, 18, 49, 49);
    view.defPosition("d2", 322, 53, 49, 49);
    view.defPosition("e2", 262, 88, 49, 49);
    view.defPosition("f2", 202, 123, 49, 49);
    view.defPosition("g2", 142, 158, 49, 49);
    view.defPosition("h2", 82, 193, 49, 49);
    view.defPosition("i2", 22, 228, 49, 49);
    view.defPosition("a1", 502, -122, 49, 49);
    view.defPosition("b1", 442, -87, 49, 49);
    view.defPosition("c1", 382, -52, 49, 49);
    view.defPosition("d1", 322, -17, 49, 49);
    view.defPosition("e1", 262, 18, 49, 49);
    view.defPosition("f1", 202, 53, 49, 49);
    view.defPosition("g1", 142, 88, 49, 49);
    view.defPosition("h1", 82, 123, 49, 49);
    view.defPosition("i1", 22, 158, 49, 49);
}
