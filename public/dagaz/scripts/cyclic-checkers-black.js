...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 412, 352, 50, 50);
    view.defPosition("b8", 362, 352, 50, 50);
    view.defPosition("c8", 312, 352, 50, 50);
    view.defPosition("d8", 262, 352, 50, 50);
    view.defPosition("e8", 212, 352, 50, 50);
    view.defPosition("f8", 162, 352, 50, 50);
    view.defPosition("g8", 112, 352, 50, 50);
    view.defPosition("h8", 62, 352, 50, 50);
    view.defPosition("a7", 412, 302, 50, 50);
    view.defPosition("b7", 362, 302, 50, 50);
    view.defPosition("c7", 312, 302, 50, 50);
    view.defPosition("d7", 262, 302, 50, 50);
    view.defPosition("e7", 212, 302, 50, 50);
    view.defPosition("f7", 162, 302, 50, 50);
    view.defPosition("g7", 112, 302, 50, 50);
    view.defPosition("h7", 62, 302, 50, 50);
    view.defPosition("a6", 412, 252, 50, 50);
    view.defPosition("b6", 362, 252, 50, 50);
    view.defPosition("c6", 312, 252, 50, 50);
    view.defPosition("d6", 262, 252, 50, 50);
    view.defPosition("e6", 212, 252, 50, 50);
    view.defPosition("f6", 162, 252, 50, 50);
    view.defPosition("g6", 112, 252, 50, 50);
    view.defPosition("h6", 62, 252, 50, 50);
    view.defPosition("a5", 412, 202, 50, 50);
    view.defPosition("b5", 362, 202, 50, 50);
    view.defPosition("c5", 312, 202, 50, 50);
    view.defPosition("d5", 262, 202, 50, 50);
    view.defPosition("e5", 212, 202, 50, 50);
    view.defPosition("f5", 162, 202, 50, 50);
    view.defPosition("g5", 112, 202, 50, 50);
    view.defPosition("h5", 62, 202, 50, 50);
    view.defPosition("a4", 412, 152, 50, 50);
    view.defPosition("b4", 362, 152, 50, 50);
    view.defPosition("c4", 312, 152, 50, 50);
    view.defPosition("d4", 262, 152, 50, 50);
    view.defPosition("e4", 212, 152, 50, 50);
    view.defPosition("f4", 162, 152, 50, 50);
    view.defPosition("g4", 112, 152, 50, 50);
    view.defPosition("h4", 62, 152, 50, 50);
    view.defPosition("a3", 412, 102, 50, 50);
    view.defPosition("b3", 362, 102, 50, 50);
    view.defPosition("c3", 312, 102, 50, 50);
    view.defPosition("d3", 262, 102, 50, 50);
    view.defPosition("e3", 212, 102, 50, 50);
    view.defPosition("f3", 162, 102, 50, 50);
    view.defPosition("g3", 112, 102, 50, 50);
    view.defPosition("h3", 62, 102, 50, 50);
    view.defPosition("a2", 412, 52, 50, 50);
    view.defPosition("b2", 362, 52, 50, 50);
    view.defPosition("c2", 312, 52, 50, 50);
    view.defPosition("d2", 262, 52, 50, 50);
    view.defPosition("e2", 212, 52, 50, 50);
    view.defPosition("f2", 162, 52, 50, 50);
    view.defPosition("g2", 112, 52, 50, 50);
    view.defPosition("h2", 62, 52, 50, 50);
    view.defPosition("a1", 412, 2, 50, 50);
    view.defPosition("b1", 362, 2, 50, 50);
    view.defPosition("c1", 312, 2, 50, 50);
    view.defPosition("d1", 262, 2, 50, 50);
    view.defPosition("e1", 212, 2, 50, 50);
    view.defPosition("f1", 162, 2, 50, 50);
    view.defPosition("g1", 112, 2, 50, 50);
    view.defPosition("h1", 62, 2, 50, 50);
    view.defPosition("X8", 472, 352, 50, 50);
    view.defPosition("Y8", 2, 352, 50, 50);
    view.defPosition("X7", 472, 302, 50, 50);
    view.defPosition("Y7", 2, 302, 50, 50);
    view.defPosition("X6", 472, 252, 50, 50);
    view.defPosition("Y6", 2, 252, 50, 50);
    view.defPosition("X5", 472, 202, 50, 50);
    view.defPosition("Y5", 2, 202, 50, 50);
    view.defPosition("X4", 472, 152, 50, 50);
    view.defPosition("Y4", 2, 152, 50, 50);
    view.defPosition("X3", 472, 102, 50, 50);
    view.defPosition("Y3", 2, 102, 50, 50);
    view.defPosition("X2", 472, 52, 50, 50);
    view.defPosition("Y2", 2, 52, 50, 50);
    view.defPosition("X1", 472, 2, 50, 50);
    view.defPosition("Y1", 2, 2, 50, 50);
}
