...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("A8", 490, 490, 70, 70);
    view.defPosition("B8", 420, 490, 70, 70);
    view.defPosition("C8", 350, 490, 70, 70);
    view.defPosition("D8", 280, 490, 70, 70);
    view.defPosition("E8", 210, 490, 70, 70);
    view.defPosition("F8", 140, 490, 70, 70);
    view.defPosition("G8", 70, 490, 70, 70);
    view.defPosition("H8", 0, 490, 70, 70);
    view.defPosition("A7", 490, 420, 70, 70);
    view.defPosition("B7", 420, 420, 70, 70);
    view.defPosition("C7", 350, 420, 70, 70);
    view.defPosition("D7", 280, 420, 70, 70);
    view.defPosition("E7", 210, 420, 70, 70);
    view.defPosition("F7", 140, 420, 70, 70);
    view.defPosition("G7", 70, 420, 70, 70);
    view.defPosition("H7", 0, 420, 70, 70);
    view.defPosition("A6", 490, 350, 70, 70);
    view.defPosition("B6", 420, 350, 70, 70);
    view.defPosition("C6", 350, 350, 70, 70);
    view.defPosition("D6", 280, 350, 70, 70);
    view.defPosition("E6", 210, 350, 70, 70);
    view.defPosition("F6", 140, 350, 70, 70);
    view.defPosition("G6", 70, 350, 70, 70);
    view.defPosition("H6", 0, 350, 70, 70);
    view.defPosition("A5", 490, 280, 70, 70);
    view.defPosition("B5", 420, 280, 70, 70);
    view.defPosition("C5", 350, 280, 70, 70);
    view.defPosition("D5", 280, 280, 70, 70);
    view.defPosition("E5", 210, 280, 70, 70);
    view.defPosition("F5", 140, 280, 70, 70);
    view.defPosition("G5", 70, 280, 70, 70);
    view.defPosition("H5", 0, 280, 70, 70);
    view.defPosition("A4", 490, 210, 70, 70);
    view.defPosition("B4", 420, 210, 70, 70);
    view.defPosition("C4", 350, 210, 70, 70);
    view.defPosition("D4", 280, 210, 70, 70);
    view.defPosition("E4", 210, 210, 70, 70);
    view.defPosition("F4", 140, 210, 70, 70);
    view.defPosition("G4", 70, 210, 70, 70);
    view.defPosition("H4", 0, 210, 70, 70);
    view.defPosition("A3", 490, 140, 70, 70);
    view.defPosition("B3", 420, 140, 70, 70);
    view.defPosition("C3", 350, 140, 70, 70);
    view.defPosition("D3", 280, 140, 70, 70);
    view.defPosition("E3", 210, 140, 70, 70);
    view.defPosition("F3", 140, 140, 70, 70);
    view.defPosition("G3", 70, 140, 70, 70);
    view.defPosition("H3", 0, 140, 70, 70);
    view.defPosition("A2", 490, 70, 70, 70);
    view.defPosition("B2", 420, 70, 70, 70);
    view.defPosition("C2", 350, 70, 70, 70);
    view.defPosition("D2", 280, 70, 70, 70);
    view.defPosition("E2", 210, 70, 70, 70);
    view.defPosition("F2", 140, 70, 70, 70);
    view.defPosition("G2", 70, 70, 70, 70);
    view.defPosition("H2", 0, 70, 70, 70);
    view.defPosition("A1", 490, 0, 70, 70);
    view.defPosition("B1", 420, 0, 70, 70);
    view.defPosition("C1", 350, 0, 70, 70);
    view.defPosition("D1", 280, 0, 70, 70);
    view.defPosition("E1", 210, 0, 70, 70);
    view.defPosition("F1", 140, 0, 70, 70);
    view.defPosition("G1", 70, 0, 70, 70);
    view.defPosition("H1", 0, 0, 70, 70);
    view.defPosition("a8", 490, 490, 70, 70);
    view.defPosition("b8", 420, 490, 70, 70);
    view.defPosition("c8", 350, 490, 70, 70);
    view.defPosition("d8", 280, 490, 70, 70);
