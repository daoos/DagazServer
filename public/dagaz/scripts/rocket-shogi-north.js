...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X7", 419, 291, 41, 46);
    view.defPosition("Y7", 378, 291, 41, 46);
    view.defPosition("I7", 337, 291, 41, 46);
    view.defPosition("a7", 296, 291, 41, 46);
    view.defPosition("b7", 255, 291, 41, 46);
    view.defPosition("c7", 214, 291, 41, 46);
    view.defPosition("d7", 173, 291, 41, 46);
    view.defPosition("e7", 132, 291, 41, 46);
    view.defPosition("J7", 91, 291, 41, 46);
    view.defPosition("Z7", 50, 291, 41, 46);
    view.defPosition("T7", 9, 291, 41, 46);
    view.defPosition("X6", 419, 245, 41, 46);
    view.defPosition("Y6", 378, 245, 41, 46);
    view.defPosition("I6", 337, 245, 41, 46);
    view.defPosition("a6", 296, 245, 41, 46);
    view.defPosition("b6", 255, 245, 41, 46);
    view.defPosition("c6", 214, 245, 41, 46);
    view.defPosition("d6", 173, 245, 41, 46);
    view.defPosition("e6", 132, 245, 41, 46);
