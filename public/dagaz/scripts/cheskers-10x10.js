...
//  design.addPriority(1);			// normal-type
    ...
    design.setup("Black", "Man", 70, 1);
    design.setup("Black", "Man", 72, 1);
    design.setup("Black", "Man", 74, 1);
    design.setup("Black", "Man", 76, 1);
    design.setup("Black", "Man", 78, 1);
    design.setup("Black", "Man", 61, 1);
    design.setup("Black", "Man", 63, 1);
    design.setup("Black", "Man", 65, 1);
    design.setup("Black", "Man", 67, 1);
    design.setup("Black", "Man", 69, 1);
    design.setup("Black", "Bishop", 90, 1);
    design.setup("Black", "King", 92, 1);
    design.setup("Black", "King", 96, 1);
    design.setup("Black", "Camel", 98, 1);
    design.setup("Black", "Queen", 94, 1);
    design.setup("Black", "Dragon", 81, 1);
    design.setup("Black", "Dragon", 83, 1);
    design.setup("Black", "Dragon", 85, 1);
    design.setup("Black", "Dragon", 87, 1);
    design.setup("Black", "Dragon", 89, 1);
    design.setup("White", "Man", 30, 1);
    design.setup("White", "Man", 32, 1);
    design.setup("White", "Man", 34, 1);
    design.setup("White", "Man", 36, 1);
    design.setup("White", "Man", 38, 1);
    design.setup("White", "Man", 21, 1);
    design.setup("White", "Man", 23, 1);
    design.setup("White", "Man", 25, 1);
    design.setup("White", "Man", 27, 1);
    design.setup("White", "Man", 29, 1);
    design.setup("White", "Bishop", 9, 1);
    design.setup("White", "King", 3, 1);
    design.setup("White", "King", 7, 1);
    design.setup("White", "Camel", 1, 1);
    design.setup("White", "Queen", 5, 1);
    design.setup("White", "Dragon", 10, 1);
    design.setup("White", "Dragon", 12, 1);
    design.setup("White", "Dragon", 14, 1);
    design.setup("White", "Dragon", 16, 1);
    design.setup("White", "Dragon", 18, 1);

    design.setup("Black", "Man", 70, 2);
    design.setup("Black", "Man", 72, 2);
    design.setup("Black", "Man", 74, 2);
    design.setup("Black", "Man", 76, 2);
    design.setup("Black", "Man", 78, 2);
    design.setup("Black", "Man", 61, 2);
    design.setup("Black", "Man", 63, 2);
    design.setup("Black", "Man", 65, 2);
    design.setup("Black", "Man", 67, 2);
    design.setup("Black", "Man", 69, 2);
    design.setup("Black", "Bishop", 92, 2);
    design.setup("Black", "Bishop", 96, 2);
    design.setup("Black", "King", 94, 2);
    design.setup("Black", "King", 85, 2);
    design.setup("Black", "Camel", 90, 2);
    design.setup("Black", "Camel", 98, 2);
    design.setup("Black", "Queen", 83, 2);
    design.setup("Black", "Queen", 87, 2);
    design.setup("Black", "Dragon", 81, 2);
    design.setup("Black", "Dragon", 89, 2);
    design.setup("White", "Man", 30, 2);
    design.setup("White", "Man", 32, 2);
    design.setup("White", "Man", 34, 2);
    design.setup("White", "Man", 36, 2);
    design.setup("White", "Man", 38, 2);
    design.setup("White", "Man", 21, 2);
    design.setup("White", "Man", 23, 2);
    design.setup("White", "Man", 25, 2);
    design.setup("White", "Man", 27, 2);
    design.setup("White", "Man", 29, 2);
    design.setup("White", "Bishop", 3, 2);
    design.setup("White", "Bishop", 7, 2);
    design.setup("White", "King", 14, 2);
    design.setup("White", "King", 5, 2);
    design.setup("White", "Camel", 1, 2);
    design.setup("White", "Camel", 9, 2);
    design.setup("White", "Queen", 12, 2);
    design.setup("White", "Queen", 16, 2);
    design.setup("White", "Dragon", 10, 2);
    design.setup("White", "Dragon", 18, 2);
}
