...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a4", 768, 308, 80, 80);
    view.defPosition("b4", 668, 308, 80, 80);
    view.defPosition("c4", 568, 308, 80, 80);
    view.defPosition("d4", 468, 308, 80, 80);
    view.defPosition("e4", 368, 308, 80, 80);
    view.defPosition("f4", 268, 308, 80, 80);
    view.defPosition("g4", 168, 308, 80, 80);
    view.defPosition("a3", 768, 208, 80, 80);
    view.defPosition("b3", 668, 208, 80, 80);
    view.defPosition("c3", 568, 208, 80, 80);
    view.defPosition("d3", 468, 208, 80, 80);
    view.defPosition("e3", 368, 208, 80, 80);
    view.defPosition("f3", 268, 208, 80, 80);
    view.defPosition("g3", 168, 208, 80, 80);
    view.defPosition("a2", 768, 108, 80, 80);
    view.defPosition("b2", 668, 108, 80, 80);
    view.defPosition("c2", 568, 108, 80, 80);
    view.defPosition("d2", 468, 108, 80, 80);
    view.defPosition("e2", 368, 108, 80, 80);
    view.defPosition("f2", 268, 108, 80, 80);
    view.defPosition("g2", 168, 108, 80, 80);
    view.defPosition("a1", 768, 8, 80, 80);
    view.defPosition("b1", 668, 8, 80, 80);
    view.defPosition("c1", 568, 8, 80, 80);
    view.defPosition("d1", 468, 8, 80, 80);
    view.defPosition("e1", 368, 8, 80, 80);
    view.defPosition("f1", 268, 8, 80, 80);
    view.defPosition("g1", 168, 8, 80, 80);
    view.defPosition("X1", 868, 8, 140, 380);
    view.defPosition("X2", 8, 8, 140, 380);
}
