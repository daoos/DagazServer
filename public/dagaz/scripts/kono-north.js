...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a4", 185, 185, 61, 61);
    view.defPosition("b4", 124, 185, 61, 61);
    view.defPosition("c4", 63, 185, 61, 61);
    view.defPosition("d4", 2, 185, 61, 61);
    view.defPosition("a3", 185, 124, 61, 61);
    view.defPosition("b3", 124, 124, 61, 61);
    view.defPosition("c3", 63, 124, 61, 61);
    view.defPosition("d3", 2, 124, 61, 61);
    view.defPosition("a2", 185, 63, 61, 61);
    view.defPosition("b2", 124, 63, 61, 61);
    view.defPosition("c2", 63, 63, 61, 61);
    view.defPosition("d2", 2, 63, 61, 61);
    view.defPosition("a1", 185, 2, 61, 61);
    view.defPosition("b1", 124, 2, 61, 61);
    view.defPosition("c1", 63, 2, 61, 61);
    view.defPosition("d1", 2, 2, 61, 61);
}
