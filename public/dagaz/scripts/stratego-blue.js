...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.reserve("Blue", "Scout", 8);
    design.reserve("Blue", "Disarmer", 5);
    design.reserve("Blue", "Sergeant", 4);
    design.reserve("Blue", "Lieutenant", 4);
    design.reserve("Blue", "Captain", 4);
    design.reserve("Blue", "Major", 3);
    design.reserve("Blue", "Brigadier", 2);
    design.reserve("Blue", "General", 1);
    design.reserve("Blue", "Commandant", 1);
    design.reserve("Blue", "Bomb", 6);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a9", 361, 361, 40, 40);
    view.defPosition("b9", 321, 361, 40, 40);
    view.defPosition("c9", 281, 361, 40, 40);
    view.defPosition("d9", 241, 361, 40, 40);
    view.defPosition("e9", 201, 361, 40, 40);
    view.defPosition("f9", 161, 361, 40, 40);
    view.defPosition("g9", 121, 361, 40, 40);
    view.defPosition("h9", 81, 361, 40, 40);
    view.defPosition("i9", 41, 361, 40, 40);
    view.defPosition("j9", 1, 361, 40, 40);
    view.defPosition("a8", 361, 321, 40, 40);
    view.defPosition("b8", 321, 321, 40, 40);
    view.defPosition("c8", 281, 321, 40, 40);
    view.defPosition("d8", 241, 321, 40, 40);
    view.defPosition("e8", 201, 321, 40, 40);
    view.defPosition("f8", 161, 321, 40, 40);
    view.defPosition("g8", 121, 321, 40, 40);
    view.defPosition("h8", 81, 321, 40, 40);
    view.defPosition("i8", 41, 321, 40, 40);
    view.defPosition("j8", 1, 321, 40, 40);
    view.defPosition("a7", 361, 281, 40, 40);
    view.defPosition("b7", 321, 281, 40, 40);
    view.defPosition("c7", 281, 281, 40, 40);
    view.defPosition("d7", 241, 281, 40, 40);
    view.defPosition("e7", 201, 281, 40, 40);
    view.defPosition("f7", 161, 281, 40, 40);
    view.defPosition("g7", 121, 281, 40, 40);
    view.defPosition("h7", 81, 281, 40, 40);
    view.defPosition("i7", 41, 281, 40, 40);
    view.defPosition("j7", 1, 281, 40, 40);
    view.defPosition("a6", 361, 241, 40, 40);
    view.defPosition("b6", 321, 241, 40, 40);
    view.defPosition("c6", 281, 241, 40, 40);
    view.defPosition("d6", 241, 241, 40, 40);
    view.defPosition("e6", 201, 241, 40, 40);
    view.defPosition("f6", 161, 241, 40, 40);
    view.defPosition("g6", 121, 241, 40, 40);
    view.defPosition("h6", 81, 241, 40, 40);
    view.defPosition("i6", 41, 241, 40, 40);
    view.defPosition("j6", 1, 241, 40, 40);
    view.defPosition("a5", 361, 201, 40, 40);
    view.defPosition("b5", 321, 201, 40, 40);
    view.defPosition("c5", 281, 201, 40, 40);
    view.defPosition("d5", 241, 201, 40, 40);
    view.defPosition("e5", 201, 201, 40, 40);
    view.defPosition("f5", 161, 201, 40, 40);
    view.defPosition("g5", 121, 201, 40, 40);
    view.defPosition("h5", 81, 201, 40, 40);
    view.defPosition("i5", 41, 201, 40, 40);
    view.defPosition("j5", 1, 201, 40, 40);
    view.defPosition("a4", 361, 161, 40, 40);
    view.defPosition("b4", 321, 161, 40, 40);
    view.defPosition("c4", 281, 161, 40, 40);
    view.defPosition("d4", 241, 161, 40, 40);
    view.defPosition("e4", 201, 161, 40, 40);
    view.defPosition("f4", 161, 161, 40, 40);
    view.defPosition("g4", 121, 161, 40, 40);
    view.defPosition("h4", 81, 161, 40, 40);
    view.defPosition("i4", 41, 161, 40, 40);
    view.defPosition("j4", 1, 161, 40, 40);
    view.defPosition("a3", 361, 121, 40, 40);
    view.defPosition("b3", 321, 121, 40, 40);
    view.defPosition("c3", 281, 121, 40, 40);
    view.defPosition("d3", 241, 121, 40, 40);
    view.defPosition("e3", 201, 121, 40, 40);
    view.defPosition("f3", 161, 121, 40, 40);
    view.defPosition("g3", 121, 121, 40, 40);
    view.defPosition("h3", 81, 121, 40, 40);
    view.defPosition("i3", 41, 121, 40, 40);
    view.defPosition("j3", 1, 121, 40, 40);
    view.defPosition("a2", 361, 81, 40, 40);
    view.defPosition("b2", 321, 81, 40, 40);
    view.defPosition("c2", 281, 81, 40, 40);
    view.defPosition("d2", 241, 81, 40, 40);
    view.defPosition("e2", 201, 81, 40, 40);
    view.defPosition("f2", 161, 81, 40, 40);
    view.defPosition("g2", 121, 81, 40, 40);
    view.defPosition("h2", 81, 81, 40, 40);
    view.defPosition("i2", 41, 81, 40, 40);
    view.defPosition("j2", 1, 81, 40, 40);
    view.defPosition("a1", 361, 41, 40, 40);
    view.defPosition("b1", 321, 41, 40, 40);
    view.defPosition("c1", 281, 41, 40, 40);
    view.defPosition("d1", 241, 41, 40, 40);
    view.defPosition("e1", 201, 41, 40, 40);
    view.defPosition("f1", 161, 41, 40, 40);
    view.defPosition("g1", 121, 41, 40, 40);
    view.defPosition("h1", 81, 41, 40, 40);
    view.defPosition("i1", 41, 41, 40, 40);
    view.defPosition("j1", 1, 41, 40, 40);
    view.defPosition("a0", 361, 1, 40, 40);
    view.defPosition("b0", 321, 1, 40, 40);
    view.defPosition("c0", 281, 1, 40, 40);
    view.defPosition("d0", 241, 1, 40, 40);
    view.defPosition("e0", 201, 1, 40, 40);
    view.defPosition("f0", 161, 1, 40, 40);
    view.defPosition("g0", 121, 1, 40, 40);
    view.defPosition("h0", 81, 1, 40, 40);
    view.defPosition("i0", 41, 1, 40, 40);
    view.defPosition("j0", 1, 1, 40, 40);
}
