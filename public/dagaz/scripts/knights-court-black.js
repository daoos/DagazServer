...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("x3", 272, 136, 68, 68);
    view.defPosition("a3", 204, 136, 68, 68);
    view.defPosition("b3", 136, 136, 68, 68);
    view.defPosition("c3", 68, 136, 68, 68);
    view.defPosition("y3", 0, 136, 68, 68);
    view.defPosition("x2", 272, 68, 68, 68);
    view.defPosition("a2", 204, 68, 68, 68);
    view.defPosition("b2", 136, 68, 68, 68);
    view.defPosition("c2", 68, 68, 68, 68);
    view.defPosition("y2", 0, 68, 68, 68);
    view.defPosition("x1", 272, 0, 68, 68);
    view.defPosition("a1", 204, 0, 68, 68);
    view.defPosition("b1", 136, 0, 68, 68);
    view.defPosition("c1", 68, 0, 68, 68);
