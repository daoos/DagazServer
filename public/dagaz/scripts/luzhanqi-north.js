...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPriority(1);			// landminetype
    design.addPriority(2);			// bombtype
    design.addPriority(3);			// droptype
    design.addPriority(4);			// normaltype

    design.addPiece("FieldMarshal", 0, 350);
    design.addDrop(0, 0, [], 3);
    design.addMove(0, 1, [4], 4);
    design.addMove(0, 1, [5], 4);
    design.addMove(0, 1, [7], 4);
    design.addMove(0, 1, [6], 4);
    design.addMove(0, 1, [8], 4);
    design.addMove(0, 1, [11], 4);
    design.addMove(0, 1, [10], 4);
    design.addMove(0, 1, [9], 4);
    design.addMove(0, 2, [0, 0], 4);
    design.addMove(0, 2, [1, 1], 4);
    design.addMove(0, 2, [3, 3], 4);
    design.addMove(0, 2, [2, 2], 4);

    design.addPiece("General", 1, 260);
    design.addDrop(1, 0, [], 3);
    design.addMove(1, 1, [4], 4);
    design.addMove(1, 1, [5], 4);
    design.addMove(1, 1, [7], 4);
    design.addMove(1, 1, [6], 4);
    design.addMove(1, 1, [8], 4);
    design.addMove(1, 1, [11], 4);
    design.addMove(1, 1, [10], 4);
    design.addMove(1, 1, [9], 4);
    design.addMove(1, 2, [0, 0], 4);
    design.addMove(1, 2, [1, 1], 4);
    design.addMove(1, 2, [3, 3], 4);
    design.addMove(1, 2, [2, 2], 4);

    design.addPiece("MajorGeneral", 2, 170);
    design.addDrop(2, 0, [], 3);
    design.addMove(2, 1, [4], 4);
    design.addMove(2, 1, [5], 4);
    design.addMove(2, 1, [7], 4);
    design.addMove(2, 1, [6], 4);
    design.addMove(2, 1, [8], 4);
    design.addMove(2, 1, [11], 4);
    design.addMove(2, 1, [10], 4);
    design.addMove(2, 1, [9], 4);
    design.addMove(2, 2, [0, 0], 4);
    design.addMove(2, 2, [1, 1], 4);
    design.addMove(2, 2, [3, 3], 4);
    design.addMove(2, 2, [2, 2], 4);

    design.addPiece("BrigadierGeneral", 3, 120);
    design.addDrop(3, 0, [], 3);
    design.addMove(3, 1, [4], 4);
    design.addMove(3, 1, [5], 4);
    design.addMove(3, 1, [7], 4);
    design.addMove(3, 1, [6], 4);
    design.addMove(3, 1, [8], 4);
    design.addMove(3, 1, [11], 4);
    design.addMove(3, 1, [10], 4);
    design.addMove(3, 1, [9], 4);
    design.addMove(3, 2, [0, 0], 4);
    design.addMove(3, 2, [1, 1], 4);
    design.addMove(3, 2, [3, 3], 4);
    design.addMove(3, 2, [2, 2], 4);

    design.addPiece("Colonel", 4, 90);
    design.addDrop(4, 0, [], 3);
    design.addMove(4, 1, [4], 4);
    design.addMove(4, 1, [5], 4);
    design.addMove(4, 1, [7], 4);
    design.addMove(4, 1, [6], 4);
    design.addMove(4, 1, [8], 4);
    design.addMove(4, 1, [11], 4);
    design.addMove(4, 1, [10], 4);
    design.addMove(4, 1, [9], 4);
    design.addMove(4, 2, [0, 0], 4);
    design.addMove(4, 2, [1, 1], 4);
    design.addMove(4, 2, [3, 3], 4);
    design.addMove(4, 2, [2, 2], 4);

    design.addPiece("Major", 5, 70);
    design.addDrop(5, 0, [], 3);
    design.addMove(5, 1, [4], 4);
    design.addMove(5, 1, [5], 4);
    design.addMove(5, 1, [7], 4);
    design.addMove(5, 1, [6], 4);
    design.addMove(5, 1, [8], 4);
    design.addMove(5, 1, [11], 4);
    design.addMove(5, 1, [10], 4);
    design.addMove(5, 1, [9], 4);
    design.addMove(5, 2, [0, 0], 4);
    design.addMove(5, 2, [1, 1], 4);
    design.addMove(5, 2, [3, 3], 4);
    design.addMove(5, 2, [2, 2], 4);

    design.addPiece("Captain", 6, 40);
    design.addDrop(6, 0, [], 3);
    design.addMove(6, 1, [4], 4);
    design.addMove(6, 1, [5], 4);
    design.addMove(6, 1, [7], 4);
    design.addMove(6, 1, [6], 4);
    design.addMove(6, 1, [8], 4);
    design.addMove(6, 1, [11], 4);
    design.addMove(6, 1, [10], 4);
    design.addMove(6, 1, [9], 4);
    design.addMove(6, 2, [0, 0], 4);
    design.addMove(6, 2, [1, 1], 4);
    design.addMove(6, 2, [3, 3], 4);
    design.addMove(6, 2, [2, 2], 4);

    design.addPiece("Lieutenant", 7, 20);
    design.addDrop(7, 0, [], 3);
    design.addMove(7, 1, [4], 4);
    design.addMove(7, 1, [5], 4);
    design.addMove(7, 1, [7], 4);
    design.addMove(7, 1, [6], 4);
    design.addMove(7, 1, [8], 4);
    design.addMove(7, 1, [11], 4);
    design.addMove(7, 1, [10], 4);
    design.addMove(7, 1, [9], 4);
    design.addMove(7, 2, [0, 0], 4);
    design.addMove(7, 2, [1, 1], 4);
    design.addMove(7, 2, [3, 3], 4);
    design.addMove(7, 2, [2, 2], 4);

    design.addPiece("Engineer", 8, 60);
    design.addDrop(8, 0, [], 3);
    design.addMove(8, 1, [4], 4);
    design.addMove(8, 1, [5], 4);
    design.addMove(8, 1, [7], 4);
    design.addMove(8, 1, [6], 4);
    design.addMove(8, 1, [8], 4);
    design.addMove(8, 1, [11], 4);
    design.addMove(8, 1, [10], 4);
    design.addMove(8, 1, [9], 4);
    design.addMove(8, 2, [0, 0], 4);
    design.addMove(8, 2, [1, 1], 4);
    design.addMove(8, 2, [3, 3], 4);
    design.addMove(8, 2, [2, 2], 4);
/*  design.addMove(8, 3, [0, 0], 4);
    design.addMove(8, 3, [1, 1], 4);
    design.addMove(8, 4, [3, 3], 4);
    design.addMove(8, 4, [2, 2], 4);
    design.addMove(8, 5, [3, 3], 5);
    design.addMove(8, 5, [2, 2], 5);
    design.addMove(8, 6, [0, 0], 6);
    design.addMove(8, 6, [1, 1], 6);
    design.addMove(8, 7, [3, 3], 7);
    design.addMove(8, 7, [2, 2], 7);
    design.addMove(8, 8, [0, 0], 8);
    design.addMove(8, 8, [1, 1], 8);
    design.addMove(8, 2, [3, 3], 9);
    design.addMove(8, 2, [2, 2], 9);
    design.addMove(8, 2, [0, 0], 10);
    design.addMove(8, 2, [1, 1], 10);*/

    design.addPiece("Bomb", 9, 130);
    design.addDrop(9, 9, [], 2);
    design.addMove(9, 1, [4], 4);
    design.addMove(9, 1, [5], 4);
    design.addMove(9, 1, [7], 4);
    design.addMove(9, 1, [6], 4);
    design.addMove(9, 1, [8], 4);
    design.addMove(9, 1, [11], 4);
    design.addMove(9, 1, [10], 4);
    design.addMove(9, 1, [9], 4);
    design.addMove(9, 2, [0, 0], 4);
    design.addMove(9, 2, [1, 1], 4);
    design.addMove(9, 2, [3, 3], 4);
    design.addMove(9, 2, [2, 2], 4);
    ...
    design.reserve("North", "FieldMarshal", 1);
    design.reserve("North", "General", 1);
    design.reserve("North", "MajorGeneral", 2);
    design.reserve("North", "BrigadierGeneral", 2);
    design.reserve("North", "Colonel", 2);
    design.reserve("North", "Major", 2);
    design.reserve("North", "Captain", 3);
    design.reserve("North", "Lieutenant", 3);
    design.reserve("North", "Engineer", 3);
    design.reserve("North", "Bomb", 2);
    design.reserve("North", "Landmine", 3);
    design.reserve("North", "Flag", 1);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a13", 359, 556, 91, 43);
    view.defPosition("a12", 359, 514, 91, 43);
    view.defPosition("a11", 359, 474, 91, 43);
    view.defPosition("a10", 359, 431, 91, 43);
    view.defPosition("a9", 359, 388, 91, 43);
    view.defPosition("a8", 359, 347, 91, 43);
    view.defPosition("b13", 273, 556, 91, 43);
    view.defPosition("b12", 273, 514, 91, 43);
    view.defPosition("b11", 273, 474, 91, 43);
    view.defPosition("b10", 273, 431, 91, 43);
    view.defPosition("b9", 273, 388, 91, 43);
    view.defPosition("b8", 273, 347, 91, 43);
    view.defPosition("c13", 180, 556, 91, 43);
    view.defPosition("c12", 180, 514, 91, 43);
    view.defPosition("c11", 180, 474, 91, 43);
    view.defPosition("c10", 180, 431, 91, 43);
    view.defPosition("c9", 180, 388, 91, 43);
    view.defPosition("c8", 180, 347, 91, 43);
    view.defPosition("d13", 84, 556, 91, 43);
    view.defPosition("d12", 84, 514, 91, 43);
    view.defPosition("d11", 84, 474, 91, 43);
    view.defPosition("d10", 84, 431, 91, 43);
    view.defPosition("d9", 84, 388, 91, 43);
    view.defPosition("d8", 84, 347, 91, 43);
    view.defPosition("e13", 0, 556, 91, 43);
    view.defPosition("e12", 0, 514, 91, 43);
    view.defPosition("e11", 0, 474, 91, 43);
    view.defPosition("e10", 0, 431, 91, 43);
    view.defPosition("e9", 0, 388, 91, 43);
    view.defPosition("e8", 0, 347, 91, 43);
    view.defPosition("a7", 359, 282, 91, 43);
    view.defPosition("c7", 180, 282, 91, 43);
    view.defPosition("e7", 0, 282, 91, 43);
    view.defPosition("a6", 359, 219, 91, 43);
    view.defPosition("a5", 359, 178, 91, 36);
    view.defPosition("a4", 359, 133, 91, 43);
    view.defPosition("a3", 359, 90, 91, 43);
    view.defPosition("a2", 359, 50, 91, 43);
    view.defPosition("a1", 359, 10, 91, 43);
    view.defPosition("b6", 273, 219, 91, 43);
    view.defPosition("b5", 273, 176, 91, 43);
    view.defPosition("b4", 273, 133, 91, 43);
    view.defPosition("b3", 273, 90, 91, 43);
    view.defPosition("b2", 273, 50, 91, 43);
    view.defPosition("b1", 273, 10, 91, 43);
    view.defPosition("c6", 180, 219, 91, 43);
    view.defPosition("c5", 180, 176, 91, 43);
    view.defPosition("c4", 180, 133, 91, 43);
    view.defPosition("c3", 180, 90, 91, 43);
    view.defPosition("c2", 180, 50, 91, 43);
    view.defPosition("c1", 180, 10, 91, 43);
    view.defPosition("d6", 84, 219, 91, 43);
    view.defPosition("d5", 84, 176, 91, 43);
    view.defPosition("d4", 84, 133, 91, 43);
    view.defPosition("d3", 84, 90, 91, 43);
    view.defPosition("d2", 84, 50, 91, 43);
    view.defPosition("d1", 84, 10, 91, 43);
    view.defPosition("e6", 0, 219, 91, 43);
    view.defPosition("e5", 0, 176, 91, 43);
    view.defPosition("e4", 0, 133, 91, 43);
    view.defPosition("e3", 0, 90, 91, 43);
    view.defPosition("e2", 0, 50, 91, 43);
    view.defPosition("e1", 0, 10, 91, 43);
}
