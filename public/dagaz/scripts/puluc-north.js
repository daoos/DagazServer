...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a11", 0, 510, 50, 50);
    view.defPosition("b11", 38, 510, 50, 50);
    view.defPosition("c11", 76, 510, 50, 50);
    view.defPosition("d11", 114, 510, 50, 50);
    view.defPosition("e11", 152, 510, 50, 50);
    view.defPosition("a1", 0, 0, 50, 50);
    view.defPosition("b1", 38, 0, 50, 50);
    view.defPosition("c1", 76, 0, 50, 50);
    view.defPosition("d1", 114, 0, 50, 50);
    view.defPosition("e1", 152, 0, 50, 50);
    view.defPosition("a10", 13, 454, 24, 51);
    view.defPosition("a9", 13, 404, 24, 51);
    view.defPosition("a8", 13, 354, 24, 51);
    view.defPosition("a7", 13, 304, 24, 51);
    view.defPosition("a6", 13, 254, 24, 51);
    view.defPosition("a5", 13, 204, 24, 51);
    view.defPosition("a4", 13, 154, 24, 51);
    view.defPosition("a3", 13, 104, 24, 51);
    view.defPosition("a2", 13, 54, 24, 51);
    view.defPosition("b10", 28, 454, 24, 51);
    view.defPosition("b9", 28, 404, 24, 51);
    view.defPosition("b8", 28, 354, 24, 51);
    view.defPosition("b7", 28, 304, 24, 51);
    view.defPosition("b6", 28, 254, 24, 51);
    view.defPosition("b5", 28, 204, 24, 51);
    view.defPosition("b4", 28, 154, 24, 51);
    view.defPosition("b3", 28, 104, 24, 51);
    view.defPosition("b2", 28, 54, 24, 51);
    view.defPosition("c10", 43, 454, 24, 51);
    view.defPosition("c9", 43, 404, 24, 51);
    view.defPosition("c8", 43, 354, 24, 51);
    view.defPosition("c7", 43, 304, 24, 51);
    view.defPosition("c6", 43, 254, 24, 51);
    view.defPosition("c5", 43, 204, 24, 51);
    view.defPosition("c4", 43, 154, 24, 51);
    view.defPosition("c3", 43, 104, 24, 51);
    view.defPosition("c2", 43, 54, 24, 51);
    view.defPosition("d10", 58, 454, 24, 51);
    view.defPosition("d9", 58, 404, 24, 51);
    view.defPosition("d8", 58, 354, 24, 51);
    view.defPosition("d7", 58, 304, 24, 51);
    view.defPosition("d6", 58, 254, 24, 51);
    view.defPosition("d5", 58, 204, 24, 51);
    view.defPosition("d4", 58, 154, 24, 51);
    view.defPosition("d3", 58, 104, 24, 51);
    view.defPosition("d2", 58, 54, 24, 51);
    view.defPosition("e10", 73, 454, 24, 51);
    view.defPosition("e9", 73, 404, 24, 51);
    view.defPosition("e8", 73, 354, 24, 51);
    view.defPosition("e7", 73, 304, 24, 51);
    view.defPosition("e6", 73, 254, 24, 51);
    view.defPosition("e5", 73, 204, 24, 51);
    view.defPosition("e4", 73, 154, 24, 51);
    view.defPosition("e3", 73, 104, 24, 51);
    view.defPosition("e2", 73, 54, 24, 51);
    view.defPosition("f10", 88, 454, 24, 51);
    view.defPosition("f9", 88, 404, 24, 51);
    view.defPosition("f8", 88, 354, 24, 51);
    view.defPosition("f7", 88, 304, 24, 51);
    view.defPosition("f6", 88, 254, 24, 51);
    view.defPosition("f5", 88, 204, 24, 51);
    view.defPosition("f4", 88, 154, 24, 51);
    view.defPosition("f3", 88, 104, 24, 51);
    view.defPosition("f2", 88, 54, 24, 51);
    view.defPosition("g10", 103, 454, 24, 51);
    view.defPosition("g9", 103, 404, 24, 51);
    view.defPosition("g8", 103, 354, 24, 51);
    view.defPosition("g7", 103, 304, 24, 51);
    view.defPosition("g6", 103, 254, 24, 51);
    view.defPosition("g5", 103, 204, 24, 51);
    view.defPosition("g4", 103, 154, 24, 51);
    view.defPosition("g3", 103, 104, 24, 51);
    view.defPosition("g2", 103, 54, 24, 51);
    view.defPosition("h10", 118, 454, 24, 51);
    view.defPosition("h9", 118, 404, 24, 51);
    view.defPosition("h8", 118, 354, 24, 51);
    view.defPosition("h7", 118, 304, 24, 51);
    view.defPosition("h6", 118, 254, 24, 51);
    view.defPosition("h5", 118, 204, 24, 51);
    view.defPosition("h4", 118, 154, 24, 51);
    view.defPosition("h3", 118, 104, 24, 51);
    view.defPosition("h2", 118, 54, 24, 51);
    view.defPosition("i10", 133, 454, 24, 51);
    view.defPosition("i9", 133, 404, 24, 51);
    view.defPosition("i8", 133, 354, 24, 51);
    view.defPosition("i7", 133, 304, 24, 51);
    view.defPosition("i6", 133, 254, 24, 51);
    view.defPosition("i5", 133, 204, 24, 51);
    view.defPosition("i4", 133, 154, 24, 51);
    view.defPosition("i3", 133, 104, 24, 51);
    view.defPosition("i2", 133, 54, 24, 51);
    view.defPosition("j10", 148, 454, 24, 51);
    view.defPosition("j9", 148, 404, 24, 51);
    view.defPosition("j8", 148, 354, 24, 51);
    view.defPosition("j7", 148, 304, 24, 51);
    view.defPosition("j6", 148, 254, 24, 51);
    view.defPosition("j5", 148, 204, 24, 51);
    view.defPosition("j4", 148, 154, 24, 51);
    view.defPosition("j3", 148, 104, 24, 51);
    view.defPosition("j2", 148, 54, 24, 51);
}
