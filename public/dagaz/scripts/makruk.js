...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(1, 0, [7], 0, 11);
    design.addMove(1, 0, [6], 0, 11);
    design.addMove(1, 0, [3], 0, 11);
    design.addMove(1, 0, [5], 0, 11);

    design.addPiece("Ruea", 2, 50);
    design.addMove(2, 1, [4, 4], 0, 12);
    design.addMove(2, 1, [2, 2], 0, 12);
    design.addMove(2, 1, [0, 0], 0, 12);
    design.addMove(2, 1, [1, 1], 0, 12);

    design.addPiece("Khon", 3, 5);
    design.addMove(3, 0, [7], 0, 13);
    design.addMove(3, 0, [6], 0, 13);
    design.addMove(3, 0, [3], 0, 13);
    design.addMove(3, 0, [5], 0, 13);
    design.addMove(3, 0, [4], 0, 13);

    design.addPiece("Ma", 4, 10);
    design.addMove(4, 2, [4, 7], 0, 14);
    design.addMove(4, 2, [4, 3], 0, 14);
    design.addMove(4, 2, [2, 6], 0, 14);
    design.addMove(4, 2, [2, 5], 0, 14);
    design.addMove(4, 2, [0, 7], 0, 14);
    design.addMove(4, 2, [0, 6], 0, 14);
    design.addMove(4, 2, [1, 3], 0, 14);
    design.addMove(4, 2, [1, 5], 0, 14);

    design.addPiece("Bia", 5, 2);
    design.addMove(5, 3, [4], 0, 15);
