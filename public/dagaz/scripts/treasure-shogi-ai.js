...
var materialTable = [0, 200, 300, 400, 400, 400, 450, 900, 600000];

var g_seeValues = [0, 2, 3, 4, 4, 4, 4, 6, 900, 0, 0, 0, 0, 0, 0, 0,
                   0, 2, 3, 4, 4, 4, 4, 6, 900, 0, 0, 0, 0, 0, 0, 0];
...
Dagaz.AI.ResetGame = function() {
  ...
  var pieceDeltas = [[], g_knightDeltas, g_silverDeltas, g_goldDeltas, g_goldDeltas, g_goldDeltas, g_goldDeltas, g_pawnDeltas, g_kingDeltas];
...
Dagaz.AI.See = function(move) {
    ...
    for (var pieceType = pieceKnight; pieceType <= pieceLance; pieceType++) {
