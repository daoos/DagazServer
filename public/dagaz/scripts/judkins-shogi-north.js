...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("X6", 460, 245, 41, 46);
    view.defPosition("Y6", 419, 245, 41, 46);
    view.defPosition("I6", 378, 245, 41, 46);
    view.defPosition("a6", 337, 245, 41, 46);
    view.defPosition("b6", 296, 245, 41, 46);
    view.defPosition("c6", 255, 245, 41, 46);
    view.defPosition("d6", 214, 245, 41, 46);
    view.defPosition("e6", 173, 245, 41, 46);
    view.defPosition("f6", 132, 245, 41, 46);
    view.defPosition("J6", 91, 245, 41, 46);
    view.defPosition("Z6", 50, 245, 41, 46);
    view.defPosition("T6", 9, 245, 41, 46);
    view.defPosition("X5", 460, 199, 41, 46);
    view.defPosition("Y5", 419, 199, 41, 46);
    view.defPosition("I5", 378, 199, 41, 46);
    view.defPosition("a5", 337, 199, 41, 46);
    view.defPosition("b5", 296, 199, 41, 46);
    view.defPosition("c5", 255, 199, 41, 46);
    view.defPosition("d5", 214, 199, 41, 46);
    view.defPosition("e5", 173, 199, 41, 46);
    view.defPosition("f5", 132, 199, 41, 46);
    view.defPosition("J5", 91, 199, 41, 46);
    view.defPosition("Z5", 50, 199, 41, 46);
    view.defPosition("T5", 9, 199, 41, 46);
    view.defPosition("X4", 460, 153, 41, 46);
    view.defPosition("Y4", 419, 153, 41, 46);
    view.defPosition("I4", 378, 153, 41, 46);
    view.defPosition("a4", 337, 153, 41, 46);
    view.defPosition("b4", 296, 153, 41, 46);
    view.defPosition("c4", 255, 153, 41, 46);
    view.defPosition("d4", 214, 153, 41, 46);
    view.defPosition("e4", 173, 153, 41, 46);
    view.defPosition("f4", 132, 153, 41, 46);
    view.defPosition("J4", 91, 153, 41, 46);
    view.defPosition("Z4", 50, 153, 41, 46);
    view.defPosition("T4", 9, 153, 41, 46);
    view.defPosition("X3", 460, 107, 41, 46);
    view.defPosition("Y3", 419, 107, 41, 46);
    view.defPosition("I3", 378, 107, 41, 46);
    view.defPosition("a3", 337, 107, 41, 46);
    view.defPosition("b3", 296, 107, 41, 46);
    view.defPosition("c3", 255, 107, 41, 46);
    view.defPosition("d3", 214, 107, 41, 46);
    view.defPosition("e3", 173, 107, 41, 46);
    view.defPosition("f3", 132, 107, 41, 46);
    view.defPosition("J3", 91, 107, 41, 46);
    view.defPosition("Z3", 50, 107, 41, 46);
    view.defPosition("T3", 9, 107, 41, 46);
    view.defPosition("X2", 460, 61, 41, 46);
    view.defPosition("Y2", 419, 61, 41, 46);
    view.defPosition("I2", 378, 61, 41, 46);
    view.defPosition("a2", 337, 61, 41, 46);
    view.defPosition("b2", 296, 61, 41, 46);
    view.defPosition("c2", 255, 61, 41, 46);
    view.defPosition("d2", 214, 61, 41, 46);
    view.defPosition("e2", 173, 61, 41, 46);
    view.defPosition("f2", 132, 61, 41, 46);
    view.defPosition("J2", 91, 61, 41, 46);
    view.defPosition("Z2", 50, 61, 41, 46);
    view.defPosition("T2", 9, 61, 41, 46);
    view.defPosition("X1", 460, 15, 41, 46);
    view.defPosition("Y1", 419, 15, 41, 46);
    view.defPosition("I1", 378, 15, 41, 46);
    view.defPosition("a1", 337, 15, 41, 46);
    view.defPosition("b1", 296, 15, 41, 46);
    view.defPosition("c1", 255, 15, 41, 46);
    view.defPosition("d1", 214, 15, 41, 46);
    view.defPosition("e1", 173, 15, 41, 46);
    view.defPosition("f1", 132, 15, 41, 46);
