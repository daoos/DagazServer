...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 1, 1, 40, 40);
    view.defPosition("b8", 41, 1, 40, 40);
    view.defPosition("c8", 81, 1, 40, 40);
    view.defPosition("d8", 121, 1, 40, 40);
    view.defPosition("e8", 161, 1, 40, 40);
    view.defPosition("f8", 201, 1, 40, 40);
    view.defPosition("g8", 241, 1, 40, 40);
    view.defPosition("h8", 281, 1, 40, 40);
    view.defPosition("a7", 1, 41, 40, 40);
    view.defPosition("b7", 41, 41, 40, 40);
    view.defPosition("c7", 81, 41, 40, 40);
    view.defPosition("d7", 121, 41, 40, 40);
    view.defPosition("e7", 161, 41, 40, 40);
    view.defPosition("f7", 201, 41, 40, 40);
    view.defPosition("g7", 241, 41, 40, 40);
    view.defPosition("h7", 281, 41, 40, 40);
    view.defPosition("a6", 1, 81, 40, 40);
    view.defPosition("b6", 41, 81, 40, 40);
    view.defPosition("c6", 81, 81, 40, 40);
    view.defPosition("d6", 121, 81, 40, 40);
    view.defPosition("e6", 161, 81, 40, 40);
    view.defPosition("f6", 201, 81, 40, 40);
    view.defPosition("g6", 241, 81, 40, 40);
    view.defPosition("h6", 281, 81, 40, 40);
    view.defPosition("a5", 1, 121, 40, 40);
    view.defPosition("b5", 41, 121, 40, 40);
    view.defPosition("c5", 81, 121, 40, 40);
    view.defPosition("d5", 121, 121, 40, 40);
    view.defPosition("e5", 161, 121, 40, 40);
    view.defPosition("f5", 201, 121, 40, 40);
    view.defPosition("g5", 241, 121, 40, 40);
    view.defPosition("h5", 281, 121, 40, 40);
    view.defPosition("a4", 1, 161, 40, 40);
    view.defPosition("b4", 41, 161, 40, 40);
    view.defPosition("c4", 81, 161, 40, 40);
    view.defPosition("d4", 121, 161, 40, 40);
    view.defPosition("e4", 161, 161, 40, 40);
    view.defPosition("f4", 201, 161, 40, 40);
    view.defPosition("g4", 241, 161, 40, 40);
    view.defPosition("h4", 281, 161, 40, 40);
    view.defPosition("a3", 1, 201, 40, 40);
    view.defPosition("b3", 41, 201, 40, 40);
    view.defPosition("c3", 81, 201, 40, 40);
    view.defPosition("d3", 121, 201, 40, 40);
    view.defPosition("e3", 161, 201, 40, 40);
    view.defPosition("f3", 201, 201, 40, 40);
    view.defPosition("g3", 241, 201, 40, 40);
    view.defPosition("h3", 281, 201, 40, 40);
    view.defPosition("a2", 1, 241, 40, 40);
    view.defPosition("b2", 41, 241, 40, 40);
    view.defPosition("c2", 81, 241, 40, 40);
    view.defPosition("d2", 121, 241, 40, 40);
    view.defPosition("e2", 161, 241, 40, 40);
    view.defPosition("f2", 201, 241, 40, 40);
    view.defPosition("g2", 241, 241, 40, 40);
    view.defPosition("h2", 281, 241, 40, 40);
    view.defPosition("a1", 1, 281, 40, 40);
    view.defPosition("b1", 41, 281, 40, 40);
    view.defPosition("c1", 81, 281, 40, 40);
    view.defPosition("d1", 121, 281, 40, 40);
    view.defPosition("e1", 161, 281, 40, 40);
    view.defPosition("f1", 201, 281, 40, 40);
    view.defPosition("g1", 241, 281, 40, 40);
    view.defPosition("h1", 281, 281, 40, 40);
}
