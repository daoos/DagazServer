...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a6", 108, 508, 80, 80);
    view.defPosition("b6", 8, 508, 80, 80);
    view.defPosition("a5", 108, 408, 80, 80);
    view.defPosition("b5", 8, 408, 80, 80);
    view.defPosition("a4", 108, 308, 80, 80);
    view.defPosition("b4", 8, 308, 80, 80);
    view.defPosition("a3", 108, 208, 80, 80);
    view.defPosition("b3", 8, 208, 80, 80);
    view.defPosition("a2", 108, 108, 80, 80);
    view.defPosition("b2", 8, 108, 80, 80);
    view.defPosition("a1", 108, 8, 80, 80);
    view.defPosition("b1", 8, 8, 80, 80);
}
