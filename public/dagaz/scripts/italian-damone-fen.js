...
var createPiece = function(design, c) {
  ...
  if (c == 'S') return Dagaz.Model.createPiece(design.getPieceType("PromotedMan"), 1);
  if (c == 's') return Dagaz.Model.createPiece(design.getPieceType("PromotedMan"), 2);
  if (c == 'K') return Dagaz.Model.createPiece(design.getPieceType("Dama"), 1);
  if (c == 'k') return Dagaz.Model.createPiece(design.getPieceType("Dama"), 2);
  if (c == 'I') return Dagaz.Model.createPiece(design.getPieceType("PromotedDama"), 1);
  if (c == 'i') return Dagaz.Model.createPiece(design.getPieceType("PromotedDama"), 2);
  if (c == 'D') return Dagaz.Model.createPiece(design.getPieceType("Damone"), 1);
  if (c == 'd') return Dagaz.Model.createPiece(design.getPieceType("Damone"), 2);
  return null;
}
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("PromotedMan")) r = 'S';
  if (piece.type == design.getPieceType("Dama")) r = 'K';
  if (piece.type == design.getPieceType("PromotedDama")) r = 'I';
  if (piece.type == design.getPieceType("Damone")) r = 'D';
  if (piece.player > 1) {
