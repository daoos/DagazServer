...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a7", 274, 275, 42, 42);
    view.defPosition("b7", 229, 275, 42, 42);
    view.defPosition("c7", 184, 275, 42, 42);
    view.defPosition("d7", 139, 275, 42, 42);
    view.defPosition("e7", 94, 275, 42, 42);
    view.defPosition("f7", 49, 275, 42, 42);
    view.defPosition("g7", 4, 275, 42, 42);
    view.defPosition("a6", 274, 230, 42, 42);
    view.defPosition("b6", 229, 230, 42, 42);
    view.defPosition("c6", 184, 230, 42, 42);
    view.defPosition("d6", 139, 230, 42, 42);
    view.defPosition("e6", 94, 230, 42, 42);
    view.defPosition("f6", 49, 230, 42, 42);
    view.defPosition("g6", 4, 230, 42, 42);
    view.defPosition("a5", 274, 185, 42, 42);
    view.defPosition("b5", 229, 185, 42, 42);
    view.defPosition("c5", 184, 185, 42, 42);
    view.defPosition("d5", 139, 185, 42, 42);
    view.defPosition("e5", 94, 185, 42, 42);
    view.defPosition("f5", 49, 185, 42, 42);
    view.defPosition("g5", 4, 185, 42, 42);
    view.defPosition("a4", 274, 140, 42, 42);
    view.defPosition("b4", 229, 140, 42, 42);
    view.defPosition("c4", 184, 140, 42, 42);
    view.defPosition("d4", 139, 140, 42, 42);
    view.defPosition("e4", 94, 140, 42, 42);
    view.defPosition("f4", 49, 140, 42, 42);
    view.defPosition("g4", 4, 140, 42, 42);
    view.defPosition("a3", 274, 95, 42, 42);
    view.defPosition("b3", 229, 95, 42, 42);
    view.defPosition("c3", 184, 95, 42, 42);
    view.defPosition("d3", 139, 95, 42, 42);
    view.defPosition("e3", 94, 95, 42, 42);
    view.defPosition("f3", 49, 95, 42, 42);
    view.defPosition("g3", 4, 95, 42, 42);
    view.defPosition("a2", 274, 50, 42, 42);
    view.defPosition("b2", 229, 50, 42, 42);
    view.defPosition("c2", 184, 50, 42, 42);
    view.defPosition("d2", 139, 50, 42, 42);
    view.defPosition("e2", 94, 50, 42, 42);
    view.defPosition("f2", 49, 50, 42, 42);
    view.defPosition("g2", 4, 50, 42, 42);
    view.defPosition("a1", 274, 5, 42, 42);
    view.defPosition("b1", 229, 5, 42, 42);
    view.defPosition("c1", 184, 5, 42, 42);
    view.defPosition("d1", 139, 5, 42, 42);
    view.defPosition("e1", 94, 5, 42, 42);
