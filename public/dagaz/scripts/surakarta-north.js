...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a6", 274, 274, 35, 35);
    view.defPosition("a5", 274, 238, 35, 35);
    view.defPosition("a4", 274, 202, 35, 35);
    view.defPosition("a3", 274, 166, 35, 35);
    view.defPosition("a2", 274, 130, 35, 35);
    view.defPosition("a1", 274, 94, 35, 35);
    view.defPosition("b6", 238, 274, 35, 35);
    view.defPosition("b5", 238, 238, 35, 35);
    view.defPosition("b4", 238, 202, 35, 35);
    view.defPosition("b3", 238, 166, 35, 35);
    view.defPosition("b2", 238, 130, 35, 35);
    view.defPosition("b1", 238, 94, 35, 35);
    view.defPosition("c6", 202, 274, 35, 35);
    view.defPosition("c5", 202, 238, 35, 35);
    view.defPosition("c4", 202, 202, 35, 35);
    view.defPosition("c3", 202, 166, 35, 35);
    view.defPosition("c2", 202, 130, 35, 35);
    view.defPosition("c1", 202, 94, 35, 35);
    view.defPosition("d6", 166, 274, 35, 35);
    view.defPosition("d5", 166, 238, 35, 35);
    view.defPosition("d4", 166, 202, 35, 35);
    view.defPosition("d3", 166, 166, 35, 35);
    view.defPosition("d2", 166, 130, 35, 35);
    view.defPosition("d1", 166, 94, 35, 35);
    view.defPosition("e6", 130, 274, 35, 35);
    view.defPosition("e5", 130, 238, 35, 35);
    view.defPosition("e4", 130, 202, 35, 35);
    view.defPosition("e3", 130, 166, 35, 35);
    view.defPosition("e2", 130, 130, 35, 35);
    view.defPosition("e1", 130, 94, 35, 35);
    view.defPosition("f6", 94, 274, 35, 35);
    view.defPosition("f5", 94, 238, 35, 35);
    view.defPosition("f4", 94, 202, 35, 35);
    view.defPosition("f3", 94, 166, 35, 35);
    view.defPosition("f2", 94, 130, 35, 35);
    view.defPosition("f1", 94, 94, 35, 35);
    view.defPosition("C1", 321, 219, 30, 30);
    view.defPosition("C2", 345, 272, 30, 30);
    view.defPosition("C3", 325, 324, 30, 30);
    view.defPosition("C4", 273, 346, 30, 30);
    view.defPosition("C5", 219, 316, 30, 30);
    view.defPosition("C6", 321, 152, 30, 30);
    view.defPosition("C7", 345, 99, 30, 30);
    view.defPosition("C8", 325, 47, 30, 30);
    view.defPosition("C9", 273, 27, 30, 30);
    view.defPosition("C10", 219, 55, 30, 30);
    view.defPosition("B1", 310, 256, 30, 30);
    view.defPosition("B2", 300, 299, 30, 30);
    view.defPosition("B3", 256, 309, 33, 30);
    view.defPosition("B4", 310, 115, 30, 30);
    view.defPosition("B5", 300, 73, 30, 30);
    view.defPosition("B6", 256, 62, 30, 30);
    view.defPosition("D1", 50, 219, 30, 30);
    view.defPosition("D2", 26, 272, 30, 30);
    view.defPosition("D3", 46, 324, 30, 30);
    view.defPosition("D4", 98, 346, 30, 30);
    view.defPosition("D5", 152, 316, 33, 30);
    view.defPosition("D6", 50, 152, 30, 30);
    view.defPosition("D7", 26, 99, 30, 30);
    view.defPosition("D8", 46, 47, 30, 30);
    view.defPosition("D9", 98, 27, 30, 30);
    view.defPosition("D10", 152, 55, 33, 30);
    view.defPosition("E1", 61, 256, 30, 30);
    view.defPosition("E2", 72, 299, 30, 30);
    view.defPosition("E3", 115, 309, 30, 30);
    view.defPosition("E4", 61, 115, 30, 30);
    view.defPosition("E5", 72, 73, 30, 30);
    view.defPosition("E6", 115, 62, 30, 30);
}
