...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Red", "King", 67, 1);
    design.setup("Red", "D13", 64, 1);
    design.setup("Red", "D13", 70, 1);
    design.setup("Red", "D23", 65, 1);
    design.setup("Red", "D23", 69, 1);
    design.setup("Red", "D53", 63, 1);
    design.setup("Red", "D53", 71, 1);
    design.setup("Red", "D63", 66, 1);
    design.setup("Red", "D63", 68, 1);
    design.setup("White", "King", 4, 1);
    design.setup("White", "D14", 1, 1);
    design.setup("White", "D14", 7, 1);
    design.setup("White", "D24", 2, 1);
    design.setup("White", "D24", 6, 1);
    design.setup("White", "D54", 0, 1);
    design.setup("White", "D54", 8, 1);
    design.setup("White", "D64", 3, 1);
    design.setup("White", "D64", 5, 1);

    design.setup("Red", "King", 67, 2);
    design.setup("White", "King", 4, 2);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 310, 273, 38, 38);
    view.defPosition("b8", 272, 273, 38, 38);
    view.defPosition("c8", 234, 273, 38, 38);
    view.defPosition("d8", 196, 273, 38, 38);
    view.defPosition("e8", 158, 273, 38, 38);
    view.defPosition("f8", 120, 273, 38, 38);
    view.defPosition("g8", 82, 273, 38, 38);
    view.defPosition("h8", 44, 273, 38, 38);
    view.defPosition("i8", 6, 273, 38, 38);
    view.defPosition("a7", 310, 235, 38, 38);
    view.defPosition("b7", 272, 235, 38, 38);
    view.defPosition("c7", 234, 235, 38, 38);
    view.defPosition("d7", 196, 235, 38, 38);
    view.defPosition("e7", 158, 235, 38, 38);
    view.defPosition("f7", 120, 235, 38, 38);
    view.defPosition("g7", 82, 235, 38, 38);
    view.defPosition("h7", 44, 235, 38, 38);
    view.defPosition("i7", 6, 235, 38, 38);
    view.defPosition("a6", 310, 197, 38, 38);
    view.defPosition("b6", 272, 197, 38, 38);
    view.defPosition("c6", 234, 197, 38, 38);
    view.defPosition("d6", 196, 197, 38, 38);
    view.defPosition("e6", 158, 197, 38, 38);
    view.defPosition("f6", 120, 197, 38, 38);
    view.defPosition("g6", 82, 197, 38, 38);
    view.defPosition("h6", 44, 197, 38, 38);
    view.defPosition("i6", 6, 197, 38, 38);
    view.defPosition("a5", 310, 159, 38, 38);
    view.defPosition("b5", 272, 159, 38, 38);
    view.defPosition("c5", 234, 159, 38, 38);
    view.defPosition("d5", 196, 159, 38, 38);
    view.defPosition("e5", 158, 159, 38, 38);
    view.defPosition("f5", 120, 159, 38, 38);
    view.defPosition("g5", 82, 159, 38, 38);
    view.defPosition("h5", 44, 159, 38, 38);
    view.defPosition("i5", 6, 159, 38, 38);
    view.defPosition("a4", 310, 121, 38, 38);
    view.defPosition("b4", 272, 121, 38, 38);
    view.defPosition("c4", 234, 121, 38, 38);
    view.defPosition("d4", 196, 121, 38, 38);
    view.defPosition("e4", 158, 121, 38, 38);
    view.defPosition("f4", 120, 121, 38, 38);
    view.defPosition("g4", 82, 121, 38, 38);
    view.defPosition("h4", 44, 121, 38, 38);
    view.defPosition("i4", 6, 121, 38, 38);
    view.defPosition("a3", 310, 83, 38, 38);
    view.defPosition("b3", 272, 83, 38, 38);
    view.defPosition("c3", 234, 83, 38, 38);
    view.defPosition("d3", 196, 83, 38, 38);
    view.defPosition("e3", 158, 83, 38, 38);
    view.defPosition("f3", 120, 83, 38, 38);
    view.defPosition("g3", 82, 83, 38, 38);
    view.defPosition("h3", 44, 83, 38, 38);
    view.defPosition("i3", 6, 83, 38, 38);
    view.defPosition("a2", 310, 45, 38, 38);
    view.defPosition("b2", 272, 45, 38, 38);
    view.defPosition("c2", 234, 45, 38, 38);
    view.defPosition("d2", 196, 45, 38, 38);
    view.defPosition("e2", 158, 45, 38, 38);
    view.defPosition("f2", 120, 45, 38, 38);
    view.defPosition("g2", 82, 45, 38, 38);
    view.defPosition("h2", 44, 45, 38, 38);
    view.defPosition("i2", 6, 45, 38, 38);
    view.defPosition("a1", 310, 7, 38, 38);
    view.defPosition("b1", 272, 7, 38, 38);
    view.defPosition("c1", 234, 7, 38, 38);
    view.defPosition("d1", 196, 7, 38, 38);
    view.defPosition("e1", 158, 7, 38, 38);
    view.defPosition("f1", 120, 7, 38, 38);
    view.defPosition("g1", 82, 7, 38, 38);
    view.defPosition("h1", 44, 7, 38, 38);
    view.defPosition("i1", 6, 7, 38, 38);
