...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 561, 561, 80, 80);
    view.defPosition("b8", 481, 561, 80, 80);
    view.defPosition("c8", 401, 561, 80, 80);
    view.defPosition("d8", 321, 561, 80, 80);
    view.defPosition("e8", 241, 561, 80, 80);
    view.defPosition("f8", 161, 561, 80, 80);
    view.defPosition("g8", 81, 561, 80, 80);
    view.defPosition("h8", 1, 561, 80, 80);
    view.defPosition("a7", 561, 481, 80, 80);
    view.defPosition("b7", 481, 481, 80, 80);
    view.defPosition("c7", 401, 481, 80, 80);
    view.defPosition("d7", 321, 481, 80, 80);
    view.defPosition("e7", 241, 481, 80, 80);
    view.defPosition("f7", 161, 481, 80, 80);
    view.defPosition("g7", 81, 481, 80, 80);
    view.defPosition("h7", 1, 481, 80, 80);
    view.defPosition("a6", 561, 401, 80, 80);
    view.defPosition("b6", 481, 401, 80, 80);
    view.defPosition("c6", 401, 401, 80, 80);
    view.defPosition("d6", 321, 401, 80, 80);
    view.defPosition("e6", 241, 401, 80, 80);
    view.defPosition("f6", 161, 401, 80, 80);
    view.defPosition("g6", 81, 401, 80, 80);
    view.defPosition("h6", 1, 401, 80, 80);
    view.defPosition("a5", 561, 321, 80, 80);
    view.defPosition("b5", 481, 321, 80, 80);
    view.defPosition("c5", 401, 321, 80, 80);
    view.defPosition("d5", 321, 321, 80, 80);
    view.defPosition("e5", 241, 321, 80, 80);
    view.defPosition("f5", 161, 321, 80, 80);
    view.defPosition("g5", 81, 321, 80, 80);
    view.defPosition("h5", 1, 321, 80, 80);
    view.defPosition("a4", 561, 241, 80, 80);
    view.defPosition("b4", 481, 241, 80, 80);
    view.defPosition("c4", 401, 241, 80, 80);
    view.defPosition("d4", 321, 241, 80, 80);
    view.defPosition("e4", 241, 241, 80, 80);
    view.defPosition("f4", 161, 241, 80, 80);
    view.defPosition("g4", 81, 241, 80, 80);
    view.defPosition("h4", 1, 241, 80, 80);
    view.defPosition("a3", 561, 161, 80, 80);
    view.defPosition("b3", 481, 161, 80, 80);
    view.defPosition("c3", 401, 161, 80, 80);
    view.defPosition("d3", 321, 161, 80, 80);
    view.defPosition("e3", 241, 161, 80, 80);
    view.defPosition("f3", 161, 161, 80, 80);
    view.defPosition("g3", 81, 161, 80, 80);
    view.defPosition("h3", 1, 161, 80, 80);
    view.defPosition("a2", 561, 81, 80, 80);
    view.defPosition("b2", 481, 81, 80, 80);
    view.defPosition("c2", 401, 81, 80, 80);
    view.defPosition("d2", 321, 81, 80, 80);
    view.defPosition("e2", 241, 81, 80, 80);
    view.defPosition("f2", 161, 81, 80, 80);
    view.defPosition("g2", 81, 81, 80, 80);
    view.defPosition("h2", 1, 81, 80, 80);
    view.defPosition("a1", 561, 1, 80, 80);
    view.defPosition("b1", 481, 1, 80, 80);
    view.defPosition("c1", 401, 1, 80, 80);
    view.defPosition("d1", 321, 1, 80, 80);
    view.defPosition("e1", 241, 1, 80, 80);
    view.defPosition("f1", 161, 1, 80, 80);
    view.defPosition("g1", 81, 1, 80, 80);
    view.defPosition("h1", 1, 1, 80, 80);
}
