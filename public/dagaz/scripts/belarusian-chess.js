...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Man", 40, 2);
    design.setup("White", "Man", 41, 2);
    design.setup("White", "Man", 42, 2);
    design.setup("White", "Man", 43, 2);
    design.setup("White", "Man", 44, 2);
    design.setup("White", "Man", 45, 2);
    design.setup("White", "Man", 46, 2);
    design.setup("White", "Man", 47, 2);
    design.setup("White", "Rook", 56, 2);
    design.setup("White", "Rook", 63, 2);
    design.setup("White", "Knight", 57, 2);
    design.setup("White", "Knight", 62, 2);
    design.setup("White", "Bishop", 58, 2);
    design.setup("White", "Bishop", 61, 2);
    design.setup("White", "Queen", 59, 2);
    ...
    design.setup("Black", "Man", 21, 2);
    design.setup("Black", "Man", 22, 2);
    design.setup("Black", "Man", 23, 2);
