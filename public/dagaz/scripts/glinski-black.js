...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(0, 2, [10], 0);
    design.addMove(0, 2, [9], 0);
    design.addMove(0, 3, [0, 11, 11], 0);
    design.addMove(0, 3, [2, 11, 11], 0);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a11", 648, 542, 49, 49);
    view.defPosition("b11", 588, 577, 49, 49);
    view.defPosition("c11", 528, 612, 49, 49);
    view.defPosition("d11", 468, 647, 49, 49);
    view.defPosition("e11", 408, 682, 49, 49);
    view.defPosition("f11", 348, 717, 49, 49);
    view.defPosition("g11", 288, 752, 49, 49);
    view.defPosition("h11", 228, 787, 49, 49);
    view.defPosition("i11", 168, 822, 49, 49);
    view.defPosition("k11", 108, 857, 49, 49);
    view.defPosition("l11", 48, 892, 49, 49);
    view.defPosition("a10", 648, 472, 49, 49);
    view.defPosition("b10", 588, 507, 49, 49);
    view.defPosition("c10", 528, 542, 49, 49);
    view.defPosition("d10", 468, 577, 49, 49);
    view.defPosition("e10", 408, 612, 49, 49);
    view.defPosition("f10", 348, 647, 49, 49);
    view.defPosition("g10", 288, 682, 49, 49);
    view.defPosition("h10", 228, 717, 49, 49);
    view.defPosition("i10", 168, 752, 49, 49);
    view.defPosition("k10", 108, 787, 49, 49);
    view.defPosition("l10", 48, 822, 49, 49);
    view.defPosition("a9", 648, 402, 49, 49);
    view.defPosition("b9", 588, 437, 49, 49);
    view.defPosition("c9", 528, 472, 49, 49);
    view.defPosition("d9", 468, 507, 49, 49);
    view.defPosition("e9", 408, 542, 49, 49);
    view.defPosition("f9", 348, 577, 49, 49);
    view.defPosition("g9", 288, 612, 49, 49);
    view.defPosition("h9", 228, 647, 49, 49);
    view.defPosition("i9", 168, 682, 49, 49);
    view.defPosition("k9", 108, 717, 49, 49);
    view.defPosition("l9", 48, 752, 49, 49);
    view.defPosition("a8", 648, 332, 49, 49);
    view.defPosition("b8", 588, 367, 49, 49);
    view.defPosition("c8", 528, 402, 49, 49);
    view.defPosition("d8", 468, 437, 49, 49);
    view.defPosition("e8", 408, 472, 49, 49);
    view.defPosition("f8", 348, 507, 49, 49);
    view.defPosition("g8", 288, 542, 49, 49);
    view.defPosition("h8", 228, 577, 49, 49);
    view.defPosition("i8", 168, 612, 49, 49);
    view.defPosition("k8", 108, 647, 49, 49);
    view.defPosition("l8", 48, 682, 49, 49);
    view.defPosition("a7", 648, 262, 49, 49);
    view.defPosition("b7", 588, 297, 49, 49);
    view.defPosition("c7", 528, 332, 49, 49);
    view.defPosition("d7", 468, 367, 49, 49);
    view.defPosition("e7", 408, 402, 49, 49);
    view.defPosition("f7", 348, 437, 49, 49);
    view.defPosition("g7", 288, 472, 49, 49);
    view.defPosition("h7", 228, 507, 49, 49);
    view.defPosition("i7", 168, 542, 49, 49);
    view.defPosition("k7", 108, 577, 49, 49);
    view.defPosition("l7", 48, 612, 49, 49);
    view.defPosition("a6", 648, 192, 49, 49);
    view.defPosition("b6", 588, 227, 49, 49);
    view.defPosition("c6", 528, 262, 49, 49);
    view.defPosition("d6", 468, 297, 49, 49);
    view.defPosition("e6", 408, 332, 49, 49);
    view.defPosition("f6", 348, 367, 49, 49);
    view.defPosition("g6", 288, 402, 49, 49);
    view.defPosition("h6", 228, 437, 49, 49);
    view.defPosition("i6", 168, 472, 49, 49);
    view.defPosition("k6", 108, 507, 49, 49);
    view.defPosition("l6", 48, 542, 49, 49);
    view.defPosition("a5", 648, 122, 49, 49);
    view.defPosition("b5", 588, 157, 49, 49);
    view.defPosition("c5", 528, 192, 49, 49);
    view.defPosition("d5", 468, 227, 49, 49);
    view.defPosition("e5", 408, 262, 49, 49);
    view.defPosition("f5", 348, 297, 49, 49);
    view.defPosition("g5", 288, 332, 49, 49);
    view.defPosition("h5", 228, 367, 49, 49);
    view.defPosition("i5", 168, 402, 49, 49);
    view.defPosition("k5", 108, 437, 49, 49);
    view.defPosition("l5", 48, 472, 49, 49);
    view.defPosition("a4", 648, 52, 49, 49);
    view.defPosition("b4", 588, 87, 49, 49);
    view.defPosition("c4", 528, 122, 49, 49);
    view.defPosition("d4", 468, 157, 49, 49);
    view.defPosition("e4", 408, 192, 49, 49);
    view.defPosition("f4", 348, 227, 49, 49);
    view.defPosition("g4", 288, 262, 49, 49);
    view.defPosition("h4", 228, 297, 49, 49);
    view.defPosition("i4", 168, 332, 49, 49);
    view.defPosition("k4", 108, 367, 49, 49);
    view.defPosition("l4", 48, 402, 49, 49);
    view.defPosition("a3", 648, -18, 49, 49);
    view.defPosition("b3", 588, 17, 49, 49);
    view.defPosition("c3", 528, 52, 49, 49);
    view.defPosition("d3", 468, 87, 49, 49);
    view.defPosition("e3", 408, 122, 49, 49);
    view.defPosition("f3", 348, 157, 49, 49);
    view.defPosition("g3", 288, 192, 49, 49);
    view.defPosition("h3", 228, 227, 49, 49);
    view.defPosition("i3", 168, 262, 49, 49);
    view.defPosition("k3", 108, 297, 49, 49);
    view.defPosition("l3", 48, 332, 49, 49);
    view.defPosition("a2", 648, -88, 49, 49);
    view.defPosition("b2", 588, -53, 49, 49);
    view.defPosition("c2", 528, -18, 49, 49);
    view.defPosition("d2", 468, 17, 49, 49);
    view.defPosition("e2", 408, 52, 49, 49);
    view.defPosition("f2", 348, 87, 49, 49);
    view.defPosition("g2", 288, 122, 49, 49);
    view.defPosition("h2", 228, 157, 49, 49);
    view.defPosition("i2", 168, 192, 49, 49);
    view.defPosition("k2", 108, 227, 49, 49);
    view.defPosition("l2", 48, 262, 49, 49);
    view.defPosition("a1", 648, -158, 49, 49);
    view.defPosition("b1", 588, -123, 49, 49);
    view.defPosition("c1", 528, -88, 49, 49);
    view.defPosition("d1", 468, -53, 49, 49);
    view.defPosition("e1", 408, -18, 49, 49);
    view.defPosition("f1", 348, 17, 49, 49);
    view.defPosition("g1", 288, 52, 49, 49);
    view.defPosition("h1", 228, 87, 49, 49);
    view.defPosition("i1", 168, 122, 49, 49);
    view.defPosition("k1", 108, 157, 49, 49);
    view.defPosition("l1", 48, 192, 49, 49);
