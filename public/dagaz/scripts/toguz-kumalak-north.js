...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a2", 572, 543, 70, 270);
    view.defPosition("b2", 501, 543, 70, 270);
    view.defPosition("c2", 430, 543, 70, 270);
    view.defPosition("d2", 359, 543, 70, 270);
    view.defPosition("e2", 288, 543, 70, 270);
    view.defPosition("f2", 217, 543, 70, 270);
    view.defPosition("g2", 146, 543, 70, 270);
    view.defPosition("h2", 75, 543, 70, 270);
    view.defPosition("i2", 4, 543, 70, 270);
    view.defPosition("a1", 572, 9, 70, 270);
    view.defPosition("b1", 501, 9, 70, 270);
    view.defPosition("c1", 430, 9, 70, 270);
    view.defPosition("d1", 359, 9, 70, 270);
    view.defPosition("e1", 288, 9, 70, 270);
    view.defPosition("f1", 217, 9, 70, 270);
    view.defPosition("g1", 146, 9, 70, 270);
    view.defPosition("h1", 75, 9, 70, 270);
    view.defPosition("i1", 4, 9, 70, 270);
    view.defPosition("X2", 4, 416, 634, 120);
    view.defPosition("X1", 4, 288, 634, 120);
}
