...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a5", 357, 357, 59, 59);
    view.defPosition("b5", 269, 357, 59, 59);
    view.defPosition("c5", 181, 357, 59, 59);
    view.defPosition("d5", 93, 357, 59, 59);
    view.defPosition("e5", 5, 357, 59, 59);
    view.defPosition("a4", 357, 269, 59, 59);
    view.defPosition("b4", 269, 269, 59, 59);
    view.defPosition("c4", 181, 269, 59, 59);
    view.defPosition("d4", 93, 269, 59, 59);
    view.defPosition("e4", 5, 269, 59, 59);
    view.defPosition("a3", 357, 181, 59, 59);
    view.defPosition("b3", 269, 181, 59, 59);
    view.defPosition("c3", 181, 181, 59, 59);
    view.defPosition("d3", 93, 181, 59, 59);
    view.defPosition("e3", 5, 181, 59, 59);
    view.defPosition("a2", 357, 93, 59, 59);
    view.defPosition("b2", 269, 93, 59, 59);
    view.defPosition("c2", 181, 93, 59, 59);
    view.defPosition("d2", 93, 93, 59, 59);
    view.defPosition("e2", 5, 93, 59, 59);
    view.defPosition("a1", 357, 5, 59, 59);
    view.defPosition("b1", 269, 5, 59, 59);
    view.defPosition("c1", 181, 5, 59, 59);
    view.defPosition("d1", 93, 5, 59, 59);
    view.defPosition("e1", 5, 5, 59, 59);
}
