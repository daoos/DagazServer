...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(1, 5, [6], 0, 11);
    design.addMove(1, 5, [2], 0, 11);
    design.addMove(1, 5, [5], 0, 11);
    design.addMove(1, 5, [0], 0, 11);

    design.addPiece("Knight", 2, 3350);
    design.addMove(2, 6, [7, 6], 0, 12);
    design.addMove(2, 6, [7, 5], 0, 12);
    design.addMove(2, 6, [1, 2], 0, 12);
    design.addMove(2, 6, [1, 0], 0, 12);
    design.addMove(2, 6, [4, 6], 0, 12);
    design.addMove(2, 6, [4, 2], 0, 12);
    design.addMove(2, 6, [3, 5], 0, 12);
    design.addMove(2, 6, [3, 0], 0, 12);
    design.addMove(2, 5, [7], 0, 12);
    design.addMove(2, 5, [1], 0, 12);
    design.addMove(2, 5, [4], 0, 12);
    design.addMove(2, 5, [3], 0, 12);
    design.addMove(2, 5, [6], 0, 12);
    design.addMove(2, 5, [2], 0, 12);
    design.addMove(2, 5, [5], 0, 12);
    design.addMove(2, 5, [0], 0, 12);
    ...
    design.addMove(3, 5, [7], 0, 13);
    design.addMove(3, 5, [1], 0, 13);
    design.addMove(3, 5, [4], 0, 13);
    design.addMove(3, 5, [3], 0, 13);
    ...
    design.addMove(5, 5, [7], 0, 15);
    design.addMove(5, 5, [1], 0, 15);
    design.addMove(5, 5, [4], 0, 15);
    design.addMove(5, 5, [3], 0, 15);
    design.addMove(5, 5, [6], 0, 15);
    design.addMove(5, 5, [2], 0, 15);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("WP", 4, 4, 16, 16);
    view.defPosition("BP", 528, 528, 16, 16);
