...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(1, 5, [6], 0);
    design.addMove(1, 5, [2], 0);
    design.addMove(1, 5, [5], 0);
    design.addMove(1, 5, [0], 0);
    ...
    design.addMove(2, 5, [4], 0);
    design.addMove(2, 5, [3], 0);
    design.addMove(2, 5, [6], 0);
    design.addMove(2, 5, [2], 0);
    design.addMove(2, 5, [5], 0);
    design.addMove(2, 5, [0], 0);
    ...
    design.addMove(3, 5, [7], 0);
    design.addMove(3, 5, [1], 0);
    design.addMove(3, 5, [4], 0);
    design.addMove(3, 5, [3], 0);
