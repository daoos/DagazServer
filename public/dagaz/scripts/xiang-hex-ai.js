...
[  10,   15,   20,   -5,  -50,    0,    0,    0,    0, // piecePawn
   25,   20,   25,   15,   10,   -5,    0,    0,    0, 
   20,   35,   40,   50,   40,   15,   20,    0,    0, 
   10,   25,   30,   45,   35,   50,   25,   15,    0, 
    0,    0,   25,   35,   30,   45,   40,   20,   10, 
    0,    0,    0,    0,   25,   35,   30,   35,   25, 
...
function Mobility(color) {
    ...
    while (from != 0) {
        ...
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; mob += mobUnit[Dagaz.AI.g_board[to]];
        ...
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; mob += mobUnit[Dagaz.AI.g_board[to]];
            to = pos - 18; mob += mobUnit[Dagaz.AI.g_board[to]];
        }
        pos = from + 17;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos + 33; mob += mobUnit[Dagaz.AI.g_board[to]];
    ...
    while (from != 0) {
        ...
        to = from - 17;  while (Dagaz.AI.g_board[to] == 0) { to -= 16; mob++;}  
        if (Dagaz.AI.g_board[to] & Dagaz.AI.PLAYERS_MASK) {
            to -= 17; while (Dagaz.AI.g_board[to] == 0) { to -= 16; }
            if (Dagaz.AI.g_board[to] & enemy) mob++;
        }
        to = from + 17;  while (Dagaz.AI.g_board[to] == 0) { to += 16; mob++;}  
        if (Dagaz.AI.g_board[to] & Dagaz.AI.PLAYERS_MASK) {
...
function IsSquareAttackableFrom(target, from) {
    ...
    if (pieceType == piecePawn) {
        ...
        if (adj != 0) {
            if (from + inc * 17 == target) return true;
    ...
    if (pieceType == pieceAdvisor) {
        to = from - 18; adj = pieceSquareAdj[pieceAdvisor][me == 0 ? flipTable[to] : to];
        if (adj != 0) {
        ...
        to = from - 33; adj = pieceSquareAdj[pieceAdvisor][me == 0 ? flipTable[to] : to];
        if (adj != 0) {
            if (to == target) return true;
        }
        to = from + 33; adj = pieceSquareAdj[pieceAdvisor][me == 0 ? flipTable[to] : to];
    ...
    if (pieceType == pieceBishop) {
        ...
        if (Dagaz.AI.g_board[to] == 0) {
            to += 18; adj = pieceSquareAdj[pieceBishop][me == 0 ? flipTable[to] : to];
            if (adj != 0) {
                if (to == target) return true;
            }
        }
        ...
        to = from + 33;
        if (Dagaz.AI.g_board[to] == 0) {
            to += 33; adj = pieceSquareAdj[pieceBishop][me == 0 ? flipTable[to] : to];
            if (adj != 0) {
                if (to == target) return true;
            }
        }
    ...
    if (pieceType == pieceKnight) {
        pos = from - 16;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (to == target) return true;
        ...
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (to == target) return true;
            to = pos - 18; if (to == target) return true;
        }
        pos = from + 17;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos + 33; if (to == target) return true;
    ...
    if (pieceType == pieceKing) {
       ...
       to = from + inc * 16; while (Dagaz.AI.g_board[to] == 0) { to += inc * 16; }
...
Dagaz.AI.GenerateAllMoves = function(moveStack) {
    ...
    from = Dagaz.AI.g_pieceList[pieceIdx++];
    while (from != 0) {
        to = from + inc * 16; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
        adj = pieceSquareAdj[piecePawn][me == 0 ? flipTable[from] : from];
        if (adj != 0) {
            to = from + inc * 17; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
    ...
    while (from != 0) {
        ...
        pos = from - 18; 
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 18; adj = pieceSquareAdj[pieceBishop][me == 0 ? flipTable[to] : to];
            if (adj != 0) {
                if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
            }
        }
        ...
        pos = from - 33; 
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; adj = pieceSquareAdj[pieceBishop][me == 0 ? flipTable[to] : to];
            if (adj != 0) {
                if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
            }
        }
    ...
    while (from != 0) {
        pos = from - 16;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
        ...
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
            to = pos - 18; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
        }
        pos = from + 17;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos + 33; if (Dagaz.AI.g_board[to] == 0) {moveStack[moveStack.length] = GenerateMove(from, to);}
...
Dagaz.AI.GenerateCaptureMoves = function(moveStack) {
    ...
    from = Dagaz.AI.g_pieceList[pieceIdx++];
    while (from != 0) {
        to = from + inc * 16; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
        adj = pieceSquareAdj[piecePawn][me == 0 ? flipTable[from] : from];
        if (adj != 0) {
            to = from + inc * 17; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
    ...
    while (from != 0) {
        pos = from - 16;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
        ...
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos - 33; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
            to = pos - 18; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
        }
        pos = from + 17;
        if (Dagaz.AI.g_board[pos] == 0) {
            to = pos + 33; if (Dagaz.AI.g_board[to] & enemy) {moveStack[moveStack.length] = GenerateMove(from, to);}
