...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("dark-wojiaoqi-view", "2");
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a11", 454, 455, 42, 42);
    view.defPosition("b11", 409, 455, 42, 42);
    view.defPosition("c11", 364, 455, 42, 42);
    view.defPosition("d11", 319, 455, 42, 42);
    view.defPosition("e11", 274, 455, 42, 42);
    view.defPosition("f11", 229, 455, 42, 42);
    view.defPosition("g11", 184, 455, 42, 42);
    view.defPosition("h11", 139, 455, 42, 42);
    view.defPosition("i11", 94, 455, 42, 42);
    view.defPosition("j11", 49, 455, 42, 42);
    view.defPosition("k11", 4, 455, 42, 42);
    view.defPosition("a10", 454, 410, 42, 42);
    view.defPosition("b10", 409, 410, 42, 42);
    view.defPosition("c10", 364, 410, 42, 42);
    view.defPosition("d10", 319, 410, 42, 42);
    view.defPosition("e10", 274, 410, 42, 42);
    view.defPosition("f10", 229, 410, 42, 42);
    view.defPosition("g10", 184, 410, 42, 42);
    view.defPosition("h10", 139, 410, 42, 42);
    view.defPosition("i10", 94, 410, 42, 42);
    view.defPosition("j10", 49, 410, 42, 42);
    view.defPosition("k10", 4, 410, 42, 42);
    view.defPosition("a9", 454, 365, 42, 42);
    view.defPosition("b9", 409, 365, 42, 42);
    view.defPosition("c9", 364, 365, 42, 42);
    view.defPosition("d9", 319, 365, 42, 42);
    view.defPosition("e9", 274, 365, 42, 42);
    view.defPosition("f9", 229, 365, 42, 42);
    view.defPosition("g9", 184, 365, 42, 42);
    view.defPosition("h9", 139, 365, 42, 42);
    view.defPosition("i9", 94, 365, 42, 42);
    view.defPosition("j9", 49, 365, 42, 42);
    view.defPosition("k9", 4, 365, 42, 42);
    view.defPosition("a8", 454, 320, 42, 42);
    view.defPosition("b8", 409, 320, 42, 42);
    view.defPosition("c8", 364, 320, 42, 42);
    view.defPosition("d8", 319, 320, 42, 42);
    view.defPosition("e8", 274, 320, 42, 42);
    view.defPosition("f8", 229, 320, 42, 42);
    view.defPosition("g8", 184, 320, 42, 42);
    view.defPosition("h8", 139, 320, 42, 42);
    view.defPosition("i8", 94, 320, 42, 42);
    view.defPosition("j8", 49, 320, 42, 42);
    view.defPosition("k8", 4, 320, 42, 42);
    view.defPosition("a7", 454, 275, 42, 42);
    view.defPosition("b7", 409, 275, 42, 42);
    view.defPosition("c7", 364, 275, 42, 42);
    view.defPosition("d7", 319, 275, 42, 42);
    view.defPosition("e7", 274, 275, 42, 42);
    view.defPosition("f7", 229, 275, 42, 42);
    view.defPosition("g7", 184, 275, 42, 42);
    view.defPosition("h7", 139, 275, 42, 42);
    view.defPosition("i7", 94, 275, 42, 42);
    view.defPosition("j7", 49, 275, 42, 42);
    view.defPosition("k7", 4, 275, 42, 42);
    view.defPosition("a6", 454, 230, 42, 42);
    view.defPosition("b6", 409, 230, 42, 42);
    view.defPosition("c6", 364, 230, 42, 42);
    view.defPosition("d6", 319, 230, 42, 42);
    view.defPosition("e6", 274, 230, 42, 42);
    view.defPosition("f6", 229, 230, 42, 42);
    view.defPosition("g6", 184, 230, 42, 42);
    view.defPosition("h6", 139, 230, 42, 42);
    view.defPosition("i6", 94, 230, 42, 42);
    view.defPosition("j6", 49, 230, 42, 42);
    view.defPosition("k6", 4, 230, 42, 42);
    view.defPosition("a5", 454, 185, 42, 42);
    view.defPosition("b5", 409, 185, 42, 42);
    view.defPosition("c5", 364, 185, 42, 42);
    view.defPosition("d5", 319, 185, 42, 42);
    view.defPosition("e5", 274, 185, 42, 42);
    view.defPosition("f5", 229, 185, 42, 42);
    view.defPosition("g5", 184, 185, 42, 42);
    view.defPosition("h5", 139, 185, 42, 42);
    view.defPosition("i5", 94, 185, 42, 42);
    view.defPosition("j5", 49, 185, 42, 42);
    view.defPosition("k5", 4, 185, 42, 42);
    view.defPosition("a4", 454, 140, 42, 42);
    view.defPosition("b4", 409, 140, 42, 42);
    view.defPosition("c4", 364, 140, 42, 42);
    view.defPosition("d4", 319, 140, 42, 42);
    view.defPosition("e4", 274, 140, 42, 42);
    view.defPosition("f4", 229, 140, 42, 42);
    view.defPosition("g4", 184, 140, 42, 42);
    view.defPosition("h4", 139, 140, 42, 42);
    view.defPosition("i4", 94, 140, 42, 42);
    view.defPosition("j4", 49, 140, 42, 42);
    view.defPosition("k4", 4, 140, 42, 42);
    view.defPosition("a3", 454, 95, 42, 42);
    view.defPosition("b3", 409, 95, 42, 42);
    view.defPosition("c3", 364, 95, 42, 42);
    view.defPosition("d3", 319, 95, 42, 42);
    view.defPosition("e3", 274, 95, 42, 42);
    view.defPosition("f3", 229, 95, 42, 42);
    view.defPosition("g3", 184, 95, 42, 42);
    view.defPosition("h3", 139, 95, 42, 42);
    view.defPosition("i3", 94, 95, 42, 42);
    view.defPosition("j3", 49, 95, 42, 42);
    view.defPosition("k3", 4, 95, 42, 42);
    view.defPosition("a2", 454, 50, 42, 42);
    view.defPosition("b2", 409, 50, 42, 42);
    view.defPosition("c2", 364, 50, 42, 42);
    view.defPosition("d2", 319, 50, 42, 42);
    view.defPosition("e2", 274, 50, 42, 42);
    view.defPosition("f2", 229, 50, 42, 42);
    view.defPosition("g2", 184, 50, 42, 42);
    view.defPosition("h2", 139, 50, 42, 42);
    view.defPosition("i2", 94, 50, 42, 42);
    view.defPosition("j2", 49, 50, 42, 42);
    view.defPosition("k2", 4, 50, 42, 42);
    view.defPosition("a1", 454, 5, 42, 42);
    view.defPosition("b1", 409, 5, 42, 42);
    view.defPosition("c1", 364, 5, 42, 42);
    view.defPosition("d1", 319, 5, 42, 42);
    view.defPosition("e1", 274, 5, 42, 42);
    view.defPosition("f1", 229, 5, 42, 42);
    view.defPosition("g1", 184, 5, 42, 42);
    view.defPosition("h1", 139, 5, 42, 42);
    view.defPosition("i1", 94, 5, 42, 42);
    view.defPosition("j1", 49, 5, 42, 42);
    view.defPosition("k1", 4, 5, 42, 42);
}
