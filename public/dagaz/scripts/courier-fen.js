...
var createPiece = function(design, c) {
  ...
  if (c == 'C') return Dagaz.Model.createPiece(design.getPieceType("Courier"), 1);
  if (c == 'c') return Dagaz.Model.createPiece(design.getPieceType("Courier"), 2);
  ...
  if (c == 'F') return Dagaz.Model.createPiece(design.getPieceType("Fool"), 1);
  if (c == 'f') return Dagaz.Model.createPiece(design.getPieceType("Fool"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Courier")) r = 'C';
  if (piece.type == design.getPieceType("Queen"))   r = 'Q';
  if (piece.type == design.getPieceType("Fool"))    r = 'F';
