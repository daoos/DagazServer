...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("nul", [452, 451, 443, 0, 0, 0, 392, 1]);
    ...
    design.addPosition("B9", [0, 0, 1, -255, -238, 0, 0, 0]);
    design.addPosition("B8", [0, -1, 1, -256, -239, 0, 0, 0]);
    design.addPosition("B7", [0, -1, 1, -257, -240, 0, 0, 0]);
    design.addPosition("B6", [0, -1, 1, -258, -241, 0, 0, 0]);
    design.addPosition("B5", [0, -1, 1, -259, -242, 0, 0, 0]);
    design.addPosition("B4", [0, -1, 1, -260, -243, 0, 0, 0]);
    design.addPosition("B3", [0, -1, 1, -261, -244, 0, 0, 0]);
    design.addPosition("B2", [0, -1, 1, -262, -245, 0, 0, 0]);
    design.addPosition("B1", [0, -1, 0, -263, -246, 0, 0, 0]);
    ...
    design.addZone("dice-zone", 1, [454, 455]);
    design.addZone("dice-zone", 2, [452, 453]);
    design.addZone("bar-zone", 1, [451, 450, 449, 448, 447, 446, 445, 444, 443]);
    design.addZone("bar-zone", 2, [451, 450, 449, 448, 447, 446, 445, 444, 443]);
    ...
    design.addZone("init-zone", 1, [455]);
    design.addZone("init-zone", 2, [452]);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("B9", 260, 40, 30, 30);
    view.defPosition("B8", 260, 70, 30, 30);
    view.defPosition("B7", 260, 100, 30, 30);
    view.defPosition("B6", 260, 130, 30, 30);
    view.defPosition("B5", 260, 160, 30, 30);
    view.defPosition("B4", 260, 190, 30, 30);
    view.defPosition("B3", 260, 220, 30, 30);
    view.defPosition("B2", 260, 250, 30, 30);
    view.defPosition("B1", 260, 280, 30, 30);
