...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addTurn(1, [1, 2, 3, 4, 5, 6, 7]); // 1
    design.addRandom(2, [0]); // 2
    design.addTurn(2, [1, 2, 3, 4, 5, 6, 7]); // 3
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("d16", 751, 152, 50, 50);
    view.defPosition("b16", 751, 102, 50, 50);
    view.defPosition("c16", 751, 52, 50, 50);
    view.defPosition("a16", 751, 2, 50, 50);
    view.defPosition("d15", 701, 152, 50, 50);
    view.defPosition("b15", 701, 102, 50, 50);
    view.defPosition("c15", 701, 52, 50, 50);
    view.defPosition("a15", 701, 2, 50, 50);
    view.defPosition("d14", 651, 152, 50, 50);
    view.defPosition("b14", 651, 102, 50, 50);
    view.defPosition("c14", 651, 52, 50, 50);
    view.defPosition("a14", 651, 2, 50, 50);
    view.defPosition("d13", 601, 152, 50, 50);
    view.defPosition("b13", 601, 102, 50, 50);
    view.defPosition("c13", 601, 52, 50, 50);
    view.defPosition("a13", 601, 2, 50, 50);
    view.defPosition("d12", 551, 152, 50, 50);
    view.defPosition("b12", 551, 102, 50, 50);
    view.defPosition("c12", 551, 52, 50, 50);
    view.defPosition("a12", 551, 2, 50, 50);
    view.defPosition("d11", 501, 152, 50, 50);
    view.defPosition("b11", 501, 102, 50, 50);
    view.defPosition("c11", 501, 52, 50, 50);
    view.defPosition("a11", 501, 2, 50, 50);
    view.defPosition("d10", 451, 152, 50, 50);
    view.defPosition("b10", 451, 102, 50, 50);
    view.defPosition("c10", 451, 52, 50, 50);
    view.defPosition("a10", 451, 2, 50, 50);
    view.defPosition("d9", 401, 152, 50, 50);
    view.defPosition("b9", 401, 102, 50, 50);
    view.defPosition("c9", 401, 52, 50, 50);
    view.defPosition("a9", 401, 2, 50, 50);
    view.defPosition("d8", 351, 152, 50, 50);
    view.defPosition("b8", 351, 102, 50, 50);
    view.defPosition("c8", 351, 52, 50, 50);
    view.defPosition("a8", 351, 2, 50, 50);
    view.defPosition("d7", 301, 152, 50, 50);
    view.defPosition("b7", 301, 102, 50, 50);
    view.defPosition("c7", 301, 52, 50, 50);
    view.defPosition("a7", 301, 2, 50, 50);
    view.defPosition("d6", 251, 152, 50, 50);
    view.defPosition("b6", 251, 102, 50, 50);
    view.defPosition("c6", 251, 52, 50, 50);
    view.defPosition("a6", 251, 2, 50, 50);
    view.defPosition("d5", 201, 152, 50, 50);
    view.defPosition("b5", 201, 102, 50, 50);
    view.defPosition("c5", 201, 52, 50, 50);
    view.defPosition("a5", 201, 2, 50, 50);
    view.defPosition("d4", 151, 152, 50, 50);
    view.defPosition("b4", 151, 102, 50, 50);
    view.defPosition("c4", 151, 52, 50, 50);
    view.defPosition("a4", 151, 2, 50, 50);
    view.defPosition("d3", 101, 152, 50, 50);
    view.defPosition("b3", 101, 102, 50, 50);
    view.defPosition("c3", 101, 52, 50, 50);
    view.defPosition("a3", 101, 2, 50, 50);
    view.defPosition("d2", 51, 152, 50, 50);
    view.defPosition("b2", 51, 102, 50, 50);
    view.defPosition("c2", 51, 52, 50, 50);
    view.defPosition("a2", 51, 2, 50, 50);
    view.defPosition("d1", 1, 152, 50, 50);
    view.defPosition("b1", 1, 102, 50, 50);
    view.defPosition("c1", 1, 52, 50, 50);
    view.defPosition("a1", 1, 2, 50, 50);
