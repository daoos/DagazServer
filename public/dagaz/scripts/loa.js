...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Man", 61, 1);
    design.setup("White", "Man", 62, 1);
    design.setup("White", "Man", 1, 1);
    design.setup("White", "Man", 2, 1);
    design.setup("White", "Man", 3, 1);
    design.setup("White", "Man", 4, 1);
    design.setup("White", "Man", 5, 1);
    design.setup("White", "Man", 6, 1);
    design.setup("Black", "Man", 48, 1);
    design.setup("Black", "Man", 40, 1);
    design.setup("Black", "Man", 32, 1);
    design.setup("Black", "Man", 24, 1);
    design.setup("Black", "Man", 16, 1);
    design.setup("Black", "Man", 8, 1);
    design.setup("Black", "Man", 55, 1);
    design.setup("Black", "Man", 47, 1);
    design.setup("Black", "Man", 39, 1);
