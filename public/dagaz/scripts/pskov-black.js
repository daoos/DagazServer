...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a13", 735, 346, 42, 42);
    view.defPosition("b13", 639, 346, 42, 42);
    view.defPosition("c13", 543, 346, 42, 42);
    view.defPosition("d13", 447, 346, 42, 42);
    view.defPosition("e13", 351, 346, 42, 42);
    view.defPosition("f13", 255, 346, 42, 42);
    view.defPosition("g13", 159, 346, 42, 42);
    view.defPosition("a12", 687, 318, 42, 42);
    view.defPosition("b12", 591, 318, 42, 42);
    view.defPosition("c12", 495, 318, 42, 42);
    view.defPosition("d12", 399, 318, 42, 42);
    view.defPosition("e12", 303, 318, 42, 42);
    view.defPosition("f12", 207, 318, 42, 42);
    view.defPosition("g12", 111, 318, 42, 42);
    view.defPosition("a11", 639, 290, 42, 42);
    view.defPosition("b11", 543, 290, 42, 42);
    view.defPosition("c11", 447, 290, 42, 42);
    view.defPosition("d11", 351, 290, 42, 42);
    view.defPosition("e11", 255, 290, 42, 42);
    view.defPosition("f11", 159, 290, 42, 42);
    view.defPosition("g11", 63, 290, 42, 42);
    view.defPosition("a10", 591, 262, 42, 42);
    view.defPosition("b10", 495, 262, 42, 42);
    view.defPosition("c10", 399, 262, 42, 42);
    view.defPosition("d10", 303, 262, 42, 42);
    view.defPosition("e10", 207, 262, 42, 42);
    view.defPosition("f10", 111, 262, 42, 42);
    view.defPosition("g10", 15, 262, 42, 42);
    view.defPosition("a9", 543, 234, 42, 42);
    view.defPosition("b9", 447, 234, 42, 42);
    view.defPosition("c9", 351, 234, 42, 42);
    view.defPosition("d9", 255, 234, 42, 42);
    view.defPosition("e9", 159, 234, 42, 42);
    view.defPosition("f9", 63, 234, 42, 42);
    view.defPosition("g9", -33, 234, 42, 42);
    view.defPosition("a8", 495, 206, 42, 42);
    view.defPosition("b8", 399, 206, 42, 42);
    view.defPosition("c8", 303, 206, 42, 42);
    view.defPosition("d8", 207, 206, 42, 42);
    view.defPosition("e8", 111, 206, 42, 42);
    view.defPosition("f8", 15, 206, 42, 42);
    view.defPosition("g8", -81, 206, 42, 42);
    view.defPosition("a7", 447, 178, 42, 42);
    view.defPosition("b7", 351, 178, 42, 42);
    view.defPosition("c7", 255, 178, 42, 42);
    view.defPosition("d7", 159, 178, 42, 42);
    view.defPosition("e7", 63, 178, 42, 42);
    view.defPosition("f7", -33, 178, 42, 42);
    view.defPosition("g7", -129, 178, 42, 42);
    view.defPosition("a6", 399, 150, 42, 42);
    view.defPosition("b6", 303, 150, 42, 42);
    view.defPosition("c6", 207, 150, 42, 42);
    view.defPosition("d6", 111, 150, 42, 42);
    view.defPosition("e6", 15, 150, 42, 42);
    view.defPosition("f6", -81, 150, 42, 42);
    view.defPosition("g6", -177, 150, 42, 42);
    view.defPosition("a5", 351, 122, 42, 42);
    view.defPosition("b5", 255, 122, 42, 42);
    view.defPosition("c5", 159, 122, 42, 42);
    view.defPosition("d5", 63, 122, 42, 42);
    view.defPosition("e5", -33, 122, 42, 42);
    view.defPosition("f5", -129, 122, 42, 42);
    view.defPosition("g5", -225, 122, 42, 42);
    view.defPosition("a4", 303, 94, 42, 42);
    view.defPosition("b4", 207, 94, 42, 42);
    view.defPosition("c4", 111, 94, 42, 42);
    view.defPosition("d4", 15, 94, 42, 42);
    view.defPosition("e4", -81, 94, 42, 42);
    view.defPosition("f4", -177, 94, 42, 42);
    view.defPosition("g4", -273, 94, 42, 42);
    view.defPosition("a3", 255, 66, 42, 42);
    view.defPosition("b3", 159, 66, 42, 42);
    view.defPosition("c3", 63, 66, 42, 42);
    view.defPosition("d3", -33, 66, 42, 42);
    view.defPosition("e3", -129, 66, 42, 42);
    view.defPosition("f3", -225, 66, 42, 42);
    view.defPosition("g3", -321, 66, 42, 42);
    view.defPosition("a2", 207, 38, 42, 42);
    view.defPosition("b2", 111, 38, 42, 42);
    view.defPosition("c2", 15, 38, 42, 42);
    view.defPosition("d2", -81, 38, 42, 42);
    view.defPosition("e2", -177, 38, 42, 42);
    view.defPosition("f2", -273, 38, 42, 42);
    view.defPosition("g2", -369, 38, 42, 42);
    view.defPosition("a1", 159, 10, 42, 42);
    view.defPosition("b1", 63, 10, 42, 42);
    view.defPosition("c1", -33, 10, 42, 42);
    view.defPosition("d1", -129, 10, 42, 42);
    view.defPosition("e1", -225, 10, 42, 42);
    view.defPosition("f1", -321, 10, 42, 42);
    view.defPosition("g1", -417, 10, 42, 42);
}
