...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("r4", 384, 12, 103, 93);
    view.defPosition("a4", 291, 294, 103, 93);
    view.defPosition("b4", 198, 294, 103, 93);
    view.defPosition("c4", 105, 294, 103, 93);
    view.defPosition("g4", 12, 12, 103, 93);
    view.defPosition("r3", 384, 106, 103, 93);
    view.defPosition("a3", 291, 200, 103, 93);
    view.defPosition("b3", 198, 200, 103, 93);
    view.defPosition("c3", 105, 200, 103, 93);
    view.defPosition("g3", 12, 106, 103, 93);
    view.defPosition("r2", 384, 200, 103, 93);
    view.defPosition("a2", 291, 106, 103, 93);
    view.defPosition("b2", 198, 106, 103, 93);
    view.defPosition("c2", 105, 106, 103, 93);
    view.defPosition("g2", 12, 200, 103, 93);
    view.defPosition("r1", 384, 294, 103, 93);
    view.defPosition("a1", 291, 12, 103, 93);
    view.defPosition("b1", 198, 12, 103, 93);
    view.defPosition("c1", 105, 12, 103, 93);
    view.defPosition("g1", 12, 294, 103, 93);
}
